...
class cetak_pajak extends CI_Controller {
    ...
    function pajak1($lcskpd='',$nbulan='',$ctk='',$ttd1='',$tgl_ctk='',$ttd2='', $jns=''){
		...
		$querypaj="SELECT 
					...
					FROM(
					SELECT b.kd_rek6,a.no_bukti AS bku,a.tgl_bukti AS tgl,(ket+'  no sp2d:'+no_sp2d) AS ket,SUM(b.nilai) AS terima,'0' AS keluar,'1' as jns,a.kd_skpd FROM trhtrmpot a
					INNER JOIN trdtrmpot b on a.no_bukti=b.no_bukti AND a.kd_skpd=b.kd_skpd
					GROUP BY a.no_bukti, a.tgl_bukti, a.ket, a.no_sp2d, a.kd_skpd,b.kd_rek6
					UNION ALL
					SELECT b.kd_rek6, a.no_bukti AS bku,a.tgl_bukti AS tgl,(ket+'  terima:'+no_terima) AS ket,'0' AS terima,SUM(b.nilai) AS keluar,'2' as jns,a.kd_skpd FROM trhstrpot a
					INNER JOIN trdstrpot b on a.no_bukti=b.no_bukti AND a.kd_skpd=b.kd_skpd
					GROUP BY a.no_bukti, a.tgl_bukti, a.ket, a.no_terima, a.kd_skpd,b.kd_rek6) a WHERE MONTH(tgl)<'$nbulan' AND kd_skpd='$lcskpd' 
					and left(kd_rek6,4) in ('2103','2101')";
            ...
            $ceksx = substr($lcskpd,18,4);
			if($ceksx=='0000'){
			 $ax ='Pengguna Anggaran';
			}else{
			 $ax ='Kuasa Pengguna Anggaran';
			}
			...
			$cRet .='<TABLE width="100%" style="font-size:14px">
					 ...
					 <TR>
						...
						<TD align="left">: '.$this->support->getBulan($nbulan).'</TD>
					 </TR>
					 </TABLE>';
			...
			$cRet .='<TABLE style="border-collapse:collapse;font-size:14px" border="1" cellspacing="0" cellpadding="'.$spasi.'" width="100%" >
				...
				$query = $this->db->query("SELECT * FROM(
					...
					SELECT b.kd_rek6,a.no_bukti AS bku,a.tgl_bukti AS tgl,(ket+'  terima:'+no_terima) AS ket,'0' AS terima,SUM(b.nilai) AS keluar,'2' as jns,a.kd_skpd FROM trhstrpot a
					INNER JOIN trdstrpot b on a.no_bukti=b.no_bukti AND a.kd_skpd=b.kd_skpd
					GROUP BY a.no_bukti, a.tgl_bukti, a.ket, a.no_terima, a.kd_skpd,b.kd_rek6 ) a 
				    WHERE MONTH(tgl)='$nbulan' AND kd_skpd='$lcskpd'
					and left(kd_rek6,4) in ('2103','2101')
	...
	function pajak2($lcskpd='',$nbulan='',$ctk='',$ttd1='',$tgl_ctk='',$ttd2='', $jns='', $rinci=''){
        ...
        if($jns_bp=="bpp"){
			...
			$cRet ='<TABLE width="100%">
					...
					<tr></tr>
                    <TR>
						<TD align="center" ><b>BUKU PAJAK PPh (SP2D LS (Gaji))</TD>
					</TR>
					</TABLE><br/>';
			} else{
			$cRet ='<TABLE width="100%">
			...
			$cRet .=' <TR><TD align="left">Bulan </TD>
						<TD align="left">: '.$this->support->getBulan($nbulan).'</TD>
					 </TR>
					 </TABLE>';
			...
			$cRet .='<TABLE style="border-collapse:collapse; font-size:12px" width="100%" border="1" cellspacing="0" cellpadding="'.$spasi.'" align=center>
					 ...
					 <TR>
                        ...
                        <TD rowspan="2" width="10" align="center" >Tanggal</TD>
						<TD rowspan="2" width="20" align="center" >Uraian</TD>						
						<TD colspan="1" width="20" align="center" >Potongan Gaji</TD>
						<TD rowspan="2" width="15" align="center" >Pemotongan (Rp)</TD>
						<TD rowspan="2" width="15" align="center" >Penyetoran (Rp)</TD>
						<TD rowspan="2" width="15" align="center" >Saldo</TD>
					 </TR>
				...
				$query = $this->db->query("
								SELECT a.bulan, ISNULL(SUM(pph21),0) as pph21,ISNULL(SUM(pot),0) as pot, ISNULL(SUM(setor),0) as setor,
								ISNULL(SUM(pot)-SUM(setor),0) as saldo
								FROM
								(SELECT 1 as bulan UNION ALL
								SELECT 2 as bulan UNION ALL
								...
								(SELECT MONTH(tgl_bukti) as bulan, 
								SUM(CASE WHEN a.kd_rek6='210105010001' THEN a.nilai ELSE 0 END) AS pph21,
                                SUM(CASE WHEN a.kd_rek6='210105010001' THEN a.nilai ELSE 0 END) as pot,
								0 as setor
								FROM trdtrmpot a INNER JOIN trhtrmpot b on a.no_bukti=b.no_bukti 
								AND a.kd_skpd=b.kd_skpd
								WHERE jns_spp in('4')  AND a.kd_skpd='$lcskpd'
								GROUP BY month(tgl_bukti)
								UNION ALL
								SELECT MONTH(tgl_bukti) as bulan, 
								0 AS pph21,								
								0 as pot,
								SUM(CASE WHEN a.kd_rek6='210105010001' THEN a.nilai ELSE 0 END) as setor
								FROM trdstrpot a INNER JOIN trhstrpot b on a.no_bukti=b.no_bukti 
								AND a.kd_skpd=b.kd_skpd
								WHERE jns_spp in('4') AND a.kd_skpd='$lcskpd'
								GROUP BY month(tgl_bukti)
			...
			if(($jns=='5') and ($rinci=='1')){
			$querypaj="SELECT  SUM(pph21) as pph21, SUM(pot) as pot, SUM(setor) as setor,
					SUM(pot)-SUM(setor) as saldo FROM 
					(SELECT a.no_bukti,tgl_bukti, ket,
					SUM(CASE WHEN a.kd_rek6='210105010001' THEN a.nilai ELSE 0 END) AS pph21,
                    SUM(CASE WHEN a.kd_rek6='210105010001' THEN a.nilai ELSE 0 END) as pot,
					...
					FROM trdtrmpot a INNER JOIN trhtrmpot b on a.no_bukti=b.no_bukti 
					AND a.kd_skpd=b.kd_skpd
					WHERE jns_spp in('4')  AND a.kd_skpd='$lcskpd' AND MONTH(tgl_bukti)<'$nbulan'
					GROUP BY a.no_bukti,tgl_bukti,ket
					UNION ALL
					SELECT a.no_bukti, tgl_bukti, ket, 
					SUM(CASE WHEN a.kd_rek6='210105010001' THEN a.nilai*-1 ELSE 0 END) AS pph21,
			...
			$cRet .='<TABLE style="border-collapse:collapse; font-size:12px" width="100%" border="1" cellspacing="0" cellpadding="'.$spasi.'" align=center>
				...
				$query = $this->db->query("
								...
								SUM(CASE WHEN a.kd_rek6='210105030001' THEN a.nilai ELSE 0 END) AS pph23,
								SUM(CASE WHEN a.kd_rek6='210106010001' THEN a.nilai ELSE 0 END) AS pphn,
								SUM(CASE WHEN a.kd_rek6='210108010001' THEN a.nilai ELSE 0 END) AS iwp,
								...
								SUM(CASE WHEN a.kd_rek6 NOT IN ('210105010001','210105020001','210105030001','210106010001','210108010001','210107010001','2110801') THEN a.nilai ELSE 0 END) AS lain,
								SUM(a.nilai) as pot,
								0 as setor
								FROM trdtrmpot a INNER JOIN trhtrmpot b on a.no_bukti=b.no_bukti 
								AND a.kd_skpd=b.kd_skpd
								WHERE jns_spp in('4','6')  AND a.kd_skpd='$lcskpd'
								GROUP BY month(tgl_bukti)
								UNION ALL
								SELECT MONTH(tgl_bukti) as bulan, 
								0 AS pph21,
			...
			$querypaj="SELECT  SUM(pph21) as pph21, SUM(pph22) as pph22, SUM(pph23) as pph23,
					...
					SUM(CASE WHEN a.kd_rek6='210107010001' THEN a.nilai ELSE 0 END) AS taperum,
					SUM(CASE WHEN a.kd_rek6='2110801' THEN a.nilai ELSE 0 END) AS hkpg,
					SUM(CASE WHEN a.kd_rek6 NOT IN ('210105010001','210105020001','210105030001','210106010001','210108010001','210107010001','2110801','2110901') THEN a.nilai ELSE 0 END) AS lain,
					SUM(a.nilai) as pot,
					0 as setor,
					1 as urut
					FROM trdtrmpot a INNER JOIN trhtrmpot b on a.no_bukti=b.no_bukti 
					AND a.kd_skpd=b.kd_skpd
					WHERE jns_spp in('4','6')  AND a.kd_skpd='$lcskpd' AND MONTH(tgl_bukti)<'$nbulan'
					GROUP BY a.no_bukti,tgl_bukti,ket
					UNION ALL
					SELECT a.no_bukti, tgl_bukti, ket, 
					SUM(CASE WHEN a.kd_rek6='210105010001' THEN a.nilai*-1 ELSE 0 END) AS pph21,
					...
					SUM(CASE WHEN a.kd_rek6='210108010001' THEN a.nilai*-1 ELSE 0 END) AS iwp,
					...
					SUM(CASE WHEN a.kd_rek6 NOT IN ('210105010001','210105020001','210105030001','210106010001','210108010001','210107010001','2110801','2110901') THEN a.nilai*-1 ELSE 0 END) AS lain,
					0 as pot,
					SUM(a.nilai) as setor,
					2 as urut
					FROM trdstrpot a INNER JOIN trhstrpot b on a.no_bukti=b.no_bukti 
			...
			$cRet .='<TABLE style="border-collapse:collapse; font-size:12px" width="100%" border="1" cellspacing="0" cellpadding="'.$spasi.'" align=center>
				...
				$query = $this->db->query(" SELECT * FROM(
								SELECT a.no_bukti bku,tgl_bukti, ket,
								SUM(CASE WHEN a.kd_rek6='2130101' THEN a.nilai ELSE 0 END) AS pph21,
								SUM(CASE WHEN a.kd_rek6='2130201' THEN a.nilai ELSE 0 END) AS pph22,
								SUM(CASE WHEN a.kd_rek6='2130401' THEN a.nilai ELSE 0 END) AS pph23,
								SUM(CASE WHEN a.kd_rek6='2130301' THEN a.nilai ELSE 0 END) AS pphn,
								SUM(CASE WHEN a.kd_rek6='2110901' THEN a.nilai ELSE 0 END) AS ppnpn,
								SUM(CASE WHEN a.kd_rek6='2110701' THEN a.nilai ELSE 0 END) AS iwp,
								SUM(CASE WHEN a.kd_rek6='2110501' THEN a.nilai ELSE 0 END) AS taperum,
								SUM(CASE WHEN a.kd_rek6='2110801' THEN a.nilai ELSE 0 END) AS hkpg,
								SUM(CASE WHEN a.kd_rek6 NOT IN ('2130101','2130201','2130401','2130301','2110701','2110501','2110801','2110901') THEN a.nilai ELSE 0 END) AS lain,
								SUM(a.nilai) as pot,
								0 as setor,
								1 as urut
								FROM trdtrmpot a INNER JOIN trhtrmpot b on a.no_bukti=b.no_bukti 
	...
	switch ($ctk)
	 ...
	 function pajak3($lcskpd='',$nbulan='',$ctk='',$ttd1='',$tgl_ctk='',$ttd2='', $jns=''){
		$spasi = $this->uri->segment(11);
		$jns_bp = $this->uri->segment(12);
        $ttd1 = str_replace('123456789',' ',$ttd1);
		$ttd2 = str_replace('123456789',' ',$ttd2);
	...
	function pajak4($lcskpd='',$nbulan='',$ctk='',$ttd1='',$tgl_ctk='',$ttd2='', $jns=''){
		$spasi = $this->uri->segment(11);
		$jns_bp = $this->uri->segment(12);
        $ttd1 = str_replace('123456789',' ',$ttd1);
		$ttd2 = str_replace('123456789',' ',$ttd2);
	...
	switch ($ctk)
	 ...
	 function pajak5($lcskpd='',$nbulan='',$ctk='',$ttd1='',$tgl_ctk='',$ttd2='', $jns='', $rinci='', $pasal=''){
		...
		$querypaj="SELECT SUM(terima) as terima, SUM(keluar) as keluar  FROM
			...
			$cRet .='<TR>
						...
						<TD align="left">: '.$pasal.' / '.$this->tukd_model->get_nama($pasal,'nm_rek5','ms_pot','map_pot').' </TD>
					 </TR>
					 <TR>
						<TD align="left">Bulan </TD>
						<TD align="left">: '.$this->support->getBulan($nbulan).'</TD>
    ...
    function pajak_global1($lcskpd='',$nbulan='',$ctk='',$ttd1='',$tgl_ctk='',$ttd2='', $jns=''){
		$spasi = $this->uri->segment(10);
		$jns_bp = $this->uri->segment(11);
        $ttd1 = str_replace('123456789',' ',$ttd1);
		$ttd2 = str_replace('123456789',' ',$ttd2);
		...
		$querypaj="SELECT 
					...
					SELECT b.kd_rek6, a.no_bukti AS bku,a.tgl_bukti AS tgl,(ket+'  terima:'+no_terima) AS ket,'0' AS terima,SUM(b.nilai) AS keluar,'2' as jns,a.kd_skpd FROM trhstrpot a
					INNER JOIN trdstrpot b on a.no_bukti=b.no_bukti AND a.kd_skpd=b.kd_skpd
					GROUP BY a.no_bukti, a.tgl_bukti, a.ket, a.no_terima, a.kd_skpd,b.kd_rek6) a WHERE MONTH(tgl)<'$nbulan' AND left(kd_skpd,17)=left('$lcskpd',17) 
					and left(kd_rek6,4) in ('2103','2101')";
				$querypjk=$this->db->query($querypaj);
				foreach ($querypjk->result() as $rowpjk)
				{
			...
			$cRet ='<TABLE width="100%" style="font-size:16px">
					...
					<tr></tr>
                    <TR>
						<TD align="center" ><b>BUKU PAJAK GLOBAL</TD>
					</TR>
					</TABLE><br/>';
			...
			$cRet .='<TABLE style="border-collapse:collapse;font-size:14px" border="1" cellspacing="0" cellpadding="'.$spasi.'" width="100%" >
				...
				$query = $this->db->query("SELECT * FROM(
					...
					INNER JOIN trdstrpot b on a.no_bukti=b.no_bukti AND a.kd_skpd=b.kd_skpd
					GROUP BY a.no_bukti, a.tgl_bukti, a.ket, a.no_terima, a.kd_skpd,b.kd_rek6 ) a 
				    WHERE MONTH(tgl)='$nbulan' AND left(kd_skpd,17)=left('$lcskpd',17)
					and left(kd_rek6,4) in ('2103','2101')
					ORDER BY tgl,Cast(bku as decimal) ");  
    ...
    function pajak_global2($lcskpd='',$nbulan='',$ctk='',$ttd1='',$tgl_ctk='',$ttd2='', $jns='', $rinci=''){
		$spasi = $this->uri->segment(11);
		$jns_bp = $this->uri->segment(12);
        $ttd1 = str_replace('123456789',' ',$ttd1);
		$ttd2 = str_replace('123456789',' ',$ttd2);
        ...
        if($jns_bp=="bpp"){
			...
			$cRet ='<TABLE width="100%">
					...
					<tr></tr>
                    <TR>
						<TD align="center" ><b>BUKU PAJAK GLOBAL PPN/PPh (SPJ UP/GU/TU)</TD>
					</TR>
					</TABLE><br/>';
			}else if($jns=='5'){
			$cRet ='<TABLE width="100%">
			...
			$cRet .='<TABLE style="border-collapse:collapse; font-size:12px" width="100%" border="1" cellspacing="0" cellpadding="'.$spasi.'" align=center>
				...
				$query = $this->db->query("
								...
								FROM trdtrmpot a INNER JOIN trhtrmpot b on a.no_bukti=b.no_bukti 
								AND a.kd_skpd=b.kd_skpd
								WHERE jns_spp in('1','2','3')  AND left(a.kd_skpd,17)=left('$lcskpd',17)
								GROUP BY month(tgl_bukti)
								UNION ALL
								SELECT MONTH(tgl_bukti) as bulan, 
								0 AS pph21,
			...
			$querypaj="SELECT  SUM(pph21) as pph21, SUM(pph22) as pph22, SUM(pph23) as pph23,
					...
					FROM trdtrmpot a INNER JOIN trhtrmpot b on a.no_bukti=b.no_bukti 
					AND a.kd_skpd=b.kd_skpd
					WHERE jns_spp in('1','2','3')  AND left(a.kd_skpd,17)=left('$lcskpd',17) AND MONTH(tgl_bukti)<'$nbulan'
					GROUP BY a.no_bukti,tgl_bukti,ket
					UNION ALL
					SELECT a.no_bukti, tgl_bukti, ket, 
					SUM(CASE WHEN a.kd_rek6='210105010001' THEN a.nilai*-1 ELSE 0 END) AS pph21,
			...
			$cRet .='<TABLE style="border-collapse:collapse; font-size:12px" width="100%" border="1" cellspacing="0" cellpadding="'.$spasi.'" align=center>
				...
				$query = $this->db->query("
								...
								FROM trdtrmpot a INNER JOIN trhtrmpot b on a.no_bukti=b.no_bukti 
								AND a.kd_skpd=b.kd_skpd
								WHERE jns_spp in('4')  AND left(a.kd_skpd,17)=left('$lcskpd',17)
								GROUP BY month(tgl_bukti)
								UNION ALL
								SELECT MONTH(tgl_bukti) as bulan, 
								0 AS pph21,								
			...
			$querypaj="SELECT  SUM(pph21) as pph21, SUM(pot) as pot, SUM(setor) as setor,
					...
					FROM trdtrmpot a INNER JOIN trhtrmpot b on a.no_bukti=b.no_bukti 
					AND a.kd_skpd=b.kd_skpd
					WHERE jns_spp in('4')  AND left(a.kd_skpd,17)=left('$lcskpd',17) AND MONTH(tgl_bukti)<'$nbulan'
					GROUP BY a.no_bukti,tgl_bukti,ket
					UNION ALL
					SELECT a.no_bukti, tgl_bukti, ket, 
					SUM(CASE WHEN a.kd_rek6='210105010001' THEN a.nilai*-1 ELSE 0 END) AS pph21,
			...
			$cRet .='<TABLE style="border-collapse:collapse; font-size:12px" width="100%" border="1" cellspacing="0" cellpadding="'.$spasi.'" align=center>
				...
				$query = $this->db->query("
								...
								FROM trdtrmpot a INNER JOIN trhtrmpot b on a.no_bukti=b.no_bukti 
								AND a.kd_skpd=b.kd_skpd
								WHERE jns_spp in('4','6')  AND left(a.kd_skpd,17)=left('$lcskpd',17)
								GROUP BY month(tgl_bukti)
								UNION ALL
								SELECT MONTH(tgl_bukti) as bulan, 
								0 AS pph21,
			...
			$querypaj="SELECT  SUM(pph21) as pph21, SUM(pph22) as pph22, SUM(pph23) as pph23,
					...
					FROM trdtrmpot a INNER JOIN trhtrmpot b on a.no_bukti=b.no_bukti 
					AND a.kd_skpd=b.kd_skpd
					WHERE jns_spp in('4','6')  AND left(a.kd_skpd,17)=left('$lcskpd',17) AND MONTH(tgl_bukti)<'$nbulan'
					GROUP BY a.no_bukti,tgl_bukti,ket
					UNION ALL
					SELECT a.no_bukti, tgl_bukti, ket, 
					SUM(CASE WHEN a.kd_rek6='210105010001' THEN a.nilai*-1 ELSE 0 END) AS pph21,
					SUM(CASE WHEN a.kd_rek6='210105020001' THEN a.nilai*-1 ELSE 0 END) AS pph22,
					SUM(CASE WHEN a.kd_rek6='210105030001' THEN a.nilai*-1 ELSE 0 END) AS pph23,
					SUM(CASE WHEN a.kd_rek6='210105030001' THEN a.nilai*-1 ELSE 0 END) AS pphn,
					SUM(CASE WHEN a.kd_rek6='2110901' THEN a.nilai*-1 ELSE 0 END) AS ppnpn,
					SUM(CASE WHEN a.kd_rek6='210108010001' THEN a.nilai*-1 ELSE 0 END) AS iwp,
					SUM(CASE WHEN a.kd_rek6='210107010001' THEN a.nilai*-1 ELSE 0 END) AS taperum,
					SUM(CASE WHEN a.kd_rek6='2110801' THEN a.nilai*-1 ELSE 0 END) AS hkpg,
					SUM(CASE WHEN a.kd_rek6 NOT IN ('210105010001','210105020001','210105030001','210105030001','2110701','210108010001','210107010001','2110901') THEN a.nilai*-1 ELSE 0 END) AS lain,
					0 as pot,
					SUM(a.nilai) as setor,
					2 as urut
					FROM trdstrpot a INNER JOIN trhstrpot b on a.no_bukti=b.no_bukti 
			...
			$cRet .='<TABLE style="border-collapse:collapse; font-size:12px" width="100%" border="1" cellspacing="0" cellpadding="'.$spasi.'" align=center>
				...
				$query = $this->db->query(" SELECT * FROM(
								...
								SUM(CASE WHEN a.kd_rek6='210107010001' THEN a.nilai ELSE 0 END) AS taperum,
								SUM(CASE WHEN a.kd_rek6='2110801' THEN a.nilai ELSE 0 END) AS hkpg,
								SUM(CASE WHEN a.kd_rek6 NOT IN ('210105010001','210105020001','210105030001','210105030001','2110701','210108010001','210107010001','2110901') THEN a.nilai ELSE 0 END) AS lain,
								SUM(a.nilai) as pot,
								0 as setor,
								1 as urut
								FROM trdtrmpot a INNER JOIN trhtrmpot b on a.no_bukti=b.no_bukti 
    ...
    function cetak_pajak4_global($lcskpd='',$nbulan='',$ctk='',$ttd1='',$tgl_ctk='',$ttd2='', $jns=''){
		$spasi = $this->uri->segment(11);
		$jns_bp = $this->uri->segment(12);
        $ttd1 = str_replace('123456789',' ',$ttd1);
		$ttd2 = str_replace('123456789',' ',$ttd2);
    ...
    function cetak_pajak5_global($lcskpd='',$nbulan='',$ctk='',$ttd1='',$tgl_ctk='',$ttd2='', $jns='', $rinci='', $pasal=''){
		$spasi = $this->uri->segment(12);
		$jns_bp = $this->uri->segment(13);
        $ttd1 = str_replace('123456789',' ',$ttd1);
		$ttd2 = str_replace('123456789',' ',$ttd2);
		...
		$querypaj="SELECT SUM(terima) as terima, SUM(keluar) as keluar  FROM
					...
					INNER JOIN trdtrmpot b on a.no_bukti=b.no_bukti AND a.kd_skpd=b.kd_skpd
					LEFT JOIN trhsp2d c on a.kd_skpd=c.kd_skpd AND a.no_sp2d=c.no_sp2d
					WHERE (nocek = '' OR nocek IS NULL)	AND left(a.kd_skpd,17)=left('$lcskpd',17)	
					AND b.kd_rek6='$pasal'	
					GROUP BY a.no_bukti, a.tgl_bukti, a.ket, a.no_sp2d, a.kd_skpd, c.no_sp2d, nocek
					UNION ALL
					SELECT a.no_bukti AS bku,a.tgl_bukti AS tgl,(ket+'  terima:'+a.no_terima) AS ket,
		...
		$querypaj="SELECT SUM(terima) as terima, SUM(keluar) as keluar  FROM
					...
					INNER JOIN trdtrmpot b on a.no_bukti=b.no_bukti AND a.kd_skpd=b.kd_skpd
					LEFT JOIN trhsp2d c on a.kd_skpd=c.kd_skpd AND a.no_sp2d=c.no_sp2d
					WHERE (nocek !='' AND nocek IS NOT NULL) AND left(a.kd_skpd,17)=left('$lcskpd',17)
					AND b.kd_rek6='$pasal'
					GROUP BY a.no_bukti, a.tgl_bukti, a.ket, a.no_sp2d, a.kd_skpd, c.no_sp2d, nocek
					UNION ALL
					SELECT a.no_bukti AS bku,a.tgl_bukti AS tgl,(ket+'  terima:'+a.no_terima) AS ket,
    ...
    function cetak_pajak3_global($lcskpd='',$nbulan='',$ctk='',$ttd1='',$tgl_ctk='',$ttd2='', $jns=''){
		$spasi = $this->uri->segment(11);
		$jns_bp = $this->uri->segment(12);
        $ttd1 = str_replace('123456789',' ',$ttd1);
		$ttd2 = str_replace('123456789',' ',$ttd2);
