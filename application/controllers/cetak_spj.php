...
function spj($lcskpd='',$nbulan='',$ttd1='',$tgl_ctk='',$ttd2='',$ctk='',$atas='', $bawah='', $kiri='', $kanan='', $jenis='', $jns_bp,$jns_ang=''){
		...
		$lcskpdd = substr($lcskpd,0,17).".0000";		
			...
			$lcskpdd = $lcskpd;
               ...
               if($bidang=="5"){ 
        $sqlttd1="SELECT top 1 * FROM (SELECT nama as nm,nip as nip,jabatan as jab, pangkat FROM ms_ttd where id_ttd='$ttd1'
        union all
        select '','','','') okei order by nm desc";
                 }else{
			$sqlttd1="SELECT top 1 * FROM (SELECT nama as nm,nip as nip,jabatan as jab, pangkat FROM ms_ttd where   id_ttd='$ttd1' union all
                select '','','','') okei order by nm desc";
			$lcskpdd = $lcskpdd; 
		}
        $sqlttd=$this->db->query($sqlttd1);
...
and kd_skpd='$lcskpd'";
            ...
            */
            ...
            and a.kd_skpd='$lcskpd' and left(a.kd_skpd,17) not in ('1.02.01') 
...
//			echo  '-'.$tox_ll;
            ...
            where a.jns_spp in ('4','6') and a.pay='BANK' and right(a.kd_skpd,2)<>'00' 
            and b.kd_skpd='$lcskpd' and left(a.kd_skpd,17) not in ('1.02.01') 
    ...
    function cetak_spj_rekap_baru($lcskpd='',$nbulan='',$ttd1='',$tgl_ctk='',$ttd2='',$ctk='',$atas='', $bawah='', $kiri='', $kanan='', $jenis='', $bk='', $ntgl1='', $ntgl2=''){
    $ttd1 = str_replace('123456789',' ',$ttd1);
    $ttd2 = str_replace('123456789',' ',$ttd2); 
    $sqlttd1="SELECT nama as nm,nip as nip,jabatan as jab, pangkat FROM ms_ttd where id_ttd='$ttd2'";
                 $sqlttd=$this->db->query($sqlttd1);
        ...
        /*$sqlanggaran1="select case when statu=1 and status_sempurna=1 and status_ubah=1 and $nbulan>=month(tgl_dpa_ubah) then 'nilai_ubah' 
             ...
             when statu=1 and status_sempurna=0 and status_ubah=0 and $nbulan>=month(tgl_dpa) then 'nilai'
                 ...
                 $sqlanggaran1="select case when statu=1 and status_sempurna=1 and status_ubah=1 then 'nilai_ubah_penyempurna' 
             when statu=1 and status_sempurna=1 and status_ubah=1 then 'nilai_sempurna'
             when statu=1 and status_sempurna=1 and status_ubah=1 then 'nilai'
             when statu=1 and status_sempurna=1 and status_ubah=0 then 'nilai_sempurna' 
             when statu=1 and status_sempurna=1 and status_ubah=0 then 'nilai'
    ...
    $tanda_ang=2;
        ...
        if($nbulan==0){
            $bulan = $this->support->tanggal_format_indonesia($ntgl1)." - ".$this->support->tanggal_format_indonesia($ntgl2);
        }else{
            $bulan= $this->support->getBulan($nbulan);         
        }
        
        $angxx = $this->uri->segment(17);
    ...
    if($angxx=='1'){
      ...
      $anx='nilai_ubah';
        ...
        $prv = $this->db->query("SELECT provinsi,daerah from sclient");
    $prvn = $prv->row();          
    $prov = $prvn->provinsi;         
    $daerah = $prvn->daerah;
    if($jenis=='1'){
      ...
      $judul='SPJ BELANJA';
        ...
        $skpd2 = $this->support->left($lcskpd,17);
                if($nbulan==0){
                    $att="spj_rekap_tgl '$skpd2','$ntgl1','$ntgl2','$anx'";       
                }else{
                    $att="spj_rekap '$skpd2','$nbulan','$anx'";       
                }
      ...
      $cRet .="
           <tr>
                <td   valign='top' width='8%' align='left' style='font-size:12px' ><b>".$rek."</b></td>
                <td   valign='top' align='left' width='25%' style='font-size:12px'><b>".$uraian."</b></td>
                <td   valign='top' align='right' style='font-size:12px'><b>".number_format($nilai,"2",",",".")."</b>&nbsp;</td>
                <td   valign='top' align='right' style='font-size:12px'><b>".number_format($real_gaji_ll,"2",",",".")."</b>&nbsp;</td>
                <td   valign='top' align='right' style='font-size:12px'><b>".number_format($real_gaji_ini,"2",",",".")."</b>&nbsp;</td>
                <td   valign='top' align='right' style='font-size:12px'><b>".number_format($real_gaji_ll+$real_gaji_ini,"2",",",".")."</b>&nbsp;</td>
      ...
      $cRet .="
        <tr>
                <td valign='top' width='8%' align='left' style='font-size:12px' >".substr($rek,16,30)."</td>
                <td valign='top' align='left' width='25%' style='font-size:12px'>".$uraian."</td>
                <td valign='top' align='right' style='font-size:12px'>".number_format($nilai,"2",",",".")."&nbsp;</td>
                <td valign='top' align='right' style='font-size:12px'>".number_format($real_gaji_ll,"2",",",".")."&nbsp;</td>
                <td valign='top' align='right' style='font-size:12px'>".number_format($real_gaji_ini,"2",",",".")."&nbsp;</td>
                <td valign='top' align='right' style='font-size:12px'>".number_format($real_gaji_ll+$real_gaji_ini,"2",",",".")."&nbsp;</td>
      ...
      $cRet .="
            ...
            $csql = "SELECT (SELECT SUM(b.nilai) FROM trhsp2d a INNER JOIN trdspp b 
                    ON a.no_spp = b.no_spp INNER JOIN trhspp c
                    ON a.no_spp = c.no_spp WHERE LEFT(a.kd_skpd,17) = LEFT('$lcskpd',17) AND 
                    (a.tgl_kas BETWEEN '$ntgl1' and '$ntgl2') AND c.jns_spp IN ('1','2','3') AND a.status='1') AS sp2d_up_ini,
                    (SELECT SUM(b.nilai) FROM trhsp2d a INNER JOIN trdspp b 
                    ON a.no_spp = b.no_spp INNER JOIN trhspp c
                    ON a.no_spp = c.no_spp WHERE LEFT(a.kd_skpd,17) = LEFT('$lcskpd',17) AND 
                    ...
                    ON a.no_spp = b.no_spp INNER JOIN trhspp c
                    ON a.no_spp = c.no_spp WHERE LEFT(a.kd_skpd,17) = LEFT('$lcskpd',17) AND 
                    (a.tgl_kas BETWEEN '$ntgl1' and '$ntgl2') AND c.jns_spp ='4' AND a.status='1') AS sp2d_gj_ini,
                    (SELECT SUM(b.nilai) FROM trhsp2d a INNER JOIN trdspp b 
                    ON a.no_spp = b.no_spp INNER JOIN trhspp c
                    ON a.no_spp = c.no_spp WHERE LEFT(a.kd_skpd,17) = LEFT('$lcskpd',17) AND 
                    ...
                    ON a.no_spp = b.no_spp INNER JOIN trhspp c
                    ON a.no_spp = c.no_spp WHERE LEFT(a.kd_skpd,17) = LEFT('$lcskpd',17) AND 
                    (a.tgl_kas BETWEEN '$ntgl1' and '$ntgl2') AND c.jns_spp ='6'  AND a.status='1') AS sp2d_brjs_ini,
                    (SELECT SUM(b.nilai) FROM trhsp2d a INNER JOIN trdspp b 
                    ON a.no_spp = b.no_spp INNER JOIN trhspp c
                    ON a.no_spp = c.no_spp WHERE LEFT(a.kd_skpd,17) = LEFT('$lcskpd',17) AND 
        ...
        <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
            ...
            SUM(CASE WHEN a.jns_spp IN ('4') AND a.tgl_kas<'$ntgl1' THEN b.nilai ELSE 0 END) AS gj_ll,
            SUM(CASE WHEN a.jns_spp IN ('4') AND (a.tgl_kas BETWEEN '$ntgl1' and '$ntgl2')  THEN b.nilai ELSE 0 END) AS gj_ini,
            SUM(CASE WHEN a.jns_spp IN ('4') AND a.tgl_kas<='$ntgl2' THEN b.nilai ELSE 0 END) AS gj_sdini,
            SUM(CASE WHEN a.jns_spp IN ('6') AND a.tgl_kas<'$ntgl1' THEN b.nilai ELSE 0 END) AS br_ll,
            SUM(CASE WHEN a.jns_spp IN ('6') AND (a.tgl_kas BETWEEN '$ntgl1' and '$ntgl2')  THEN b.nilai ELSE 0 END) AS br_ini,
            SUM(CASE WHEN a.jns_spp IN ('6') AND a.tgl_kas<='$ntgl2' THEN b.nilai ELSE 0 END) AS br_sdini,
            SUM(CASE WHEN a.jns_spp IN ('1','2','3') AND a.tgl_kas<'$ntgl1' THEN b.nilai ELSE 0 END) AS up_ll,
            SUM(CASE WHEN a.jns_spp IN ('1','2','3') AND (a.tgl_kas BETWEEN '$ntgl1' and '$ntgl2')  THEN b.nilai ELSE 0 END) AS up_ini,
            SUM(CASE WHEN a.jns_spp IN ('1','2','3') AND a.tgl_kas<='$ntgl2' THEN b.nilai ELSE 0 END) AS up_sdini
            FROM trhsp2d a INNER JOIN trdspp b 
            ON a.no_spp = b.no_spp INNER JOIN trhspp c
            ON a.no_spp = c.no_spp WHERE left(a.kd_skpd,17) = left('$lcskpd',17)
            AND a.status='1' AND (a.tgl_kas BETWEEN '$ntgl1' and '$ntgl2') 
            GROUP BY a.no_sp2d";    
            }else{            
      $csqlsp2d = "SELECT a.no_sp2d,
      ...
      $cRet .="
        ...
        <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
            ...
            $lcrek = '210106010001';//'2130301';//'2110401'; // ppn terima
            if($nbulan==0){             
            $csql = "SELECT (SELECT SUM(b.nilai) FROM trhtrmpot a INNER JOIN trdtrmpot b
                    ON a.no_bukti = b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17) AND 
                    b.kd_rek6 = '$lcrek' AND (a.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') AND 
                    a.jns_spp IN('1','2','3')) AS jppn_up_ini,
                    (SELECT SUM(b.nilai) FROM trhtrmpot a INNER JOIN trdtrmpot b
                    ON a.no_bukti = b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17) AND 
        ...
        <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
            ...
            $lcrek = '210105010001';// '2130101'; // pph 21 terima
            if($nbulan==0){             
            $csql = "SELECT (SELECT SUM(b.nilai) FROM trhtrmpot a INNER JOIN trdtrmpot b
                    ON a.no_bukti = b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17) AND 
        ...
        <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
            ...
            $lcrek = '210105020001';//'2130201'; // pph 22 terima
            if($nbulan==0){                
            $csql = "SELECT (SELECT SUM(b.nilai) FROM trhtrmpot a INNER JOIN trdtrmpot b
                    ON a.no_bukti = b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17) AND 
      ...
      $lcrek = '210105030001'; //'2130401'; // pph 23 terima
            if($nbulan==0){            
            $csql = "SELECT (SELECT SUM(b.nilai) FROM trhtrmpot a INNER JOIN trdtrmpot b
                    ON a.no_bukti = b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17) AND 
      ...
      $lcrek = '210108010001';// '2110701'; // IWP
            if($nbulan==0){            
            $csql = "SELECT 
          SUM(CASE WHEN b.jns_spp IN ('1','2','3') AND b.tgl_bukti<'$ntgl1' THEN a.nilai ELSE 0 END) AS up_iwp_lalu,
          SUM(CASE WHEN b.jns_spp IN ('1','2','3') AND (b.tgl_bukti BETWEEN '$ntgl1' AND '$ntgl2') THEN a.nilai ELSE 0 END) AS up_iwp_ini,
          ...
          SUM(CASE WHEN b.jns_spp IN ('4') AND (b.tgl_bukti BETWEEN '$ntgl1' AND '$ntgl2') THEN a.nilai ELSE 0 END) AS gj_iwp_ini,
          ...
          SUM(CASE WHEN b.jns_spp IN ('6') AND (b.tgl_bukti BETWEEN '$ntgl1' AND '$ntgl2') THEN a.nilai ELSE 0 END) AS ls_iwp_ini,
          SUM(CASE WHEN b.jns_spp IN ('6') AND b.tgl_bukti<='$ntgl2' THEN a.nilai ELSE 0 END) AS ls_iwp_sdini
          FROM trdtrmpot a INNER JOIN trhtrmpot b ON a.no_bukti=b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE a.kd_rek6='$lcrek' AND LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17)";    
            }else{
            $csql = "SELECT 
          SUM(CASE WHEN b.jns_spp IN ('1','2','3') AND MONTH(b.tgl_bukti)<'$nbulan' THEN a.nilai ELSE 0 END) AS up_iwp_lalu,
          SUM(CASE WHEN b.jns_spp IN ('1','2','3') AND MONTH(b.tgl_bukti)='$nbulan' THEN a.nilai ELSE 0 END) AS up_iwp_ini,
      ...
      $lcrek = '210107010001';// '2110501'; // TAPERUM
            if($nbulan==0){
            $csql = "SELECT 
          SUM(CASE WHEN b.jns_spp IN ('1','2','3') AND b.tgl_bukti<'$ntgl1' THEN a.nilai ELSE 0 END) AS up_tap_lalu,
          SUM(CASE WHEN b.jns_spp IN ('1','2','3') AND (b.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') THEN a.nilai ELSE 0 END) AS up_tap_ini,
          ...
          SUM(CASE WHEN b.jns_spp IN ('4') AND (b.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') THEN  a.nilai ELSE 0 END) AS gj_tap_ini,
          ...
          SUM(CASE WHEN b.jns_spp IN ('6') AND (b.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') THEN  a.nilai ELSE 0 END) AS ls_tap_ini,
      ...
      $lcrek = '210601050005';//'2130501'; // pph4
            if($nbulan==0){
            $csql = "SELECT 
          SUM(CASE WHEN b.jns_spp IN ('1','2','3') AND b.tgl_bukti<'$ntgl1' THEN  a.nilai ELSE 0 END) AS up_pph4_lalu,
          SUM(CASE WHEN b.jns_spp IN ('1','2','3') AND (b.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') THEN  a.nilai ELSE 0 END) AS up_pph4_ini,
          ...
          SUM(CASE WHEN b.jns_spp IN ('4') AND (b.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') THEN  a.nilai ELSE 0 END) AS gj_pph4_ini,
          ...
          SUM(CASE WHEN b.jns_spp IN ('6') AND (b.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') THEN  a.nilai ELSE 0 END) AS ls_pph4_ini,
      ...
      $lcrek = '';// '2110901'; // PPnPn
        ...
        <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
            ...
            if($nbulan==0){
                $sqlpanjarin="SELECT 
                                sum(x.jar_bln_lalu) as jar_bln_lalu,
                                sum(x.jar_bln_ini) as jar_bln_ini,
                                sum(x.jar_sd_bln_ini) as jar_sd_bln_ini
                                 from (
                                select 
                                            SUM(CASE WHEN tgl_kas<'$ntgl1' THEN nilai ELSE 0 END) as jar_bln_lalu,
                                            SUM(CASE WHEN (tgl_kas BETWEEN '$ntgl1' and '$ntgl2') THEN nilai ELSE 0 END) as jar_bln_ini,
                                            SUM(CASE WHEN tgl_kas<='$ntgl2' THEN nilai ELSE 0 END) as jar_sd_bln_ini
                                            from tr_jpanjar 
                                            WHERE left(kd_skpd,17)=left('$lcskpd',17) and jns='1'
                                union all
                                select 
                                            SUM(CASE WHEN tgl_kas<'$ntgl1' THEN nilai ELSE 0 END) as jar_bln_lalu,
                                            SUM(CASE WHEN (tgl_kas BETWEEN '$ntgl1' and '$ntgl2') THEN nilai ELSE 0 END) as jar_bln_ini,
                                            SUM(CASE WHEN tgl_kas<='$ntgl2' THEN nilai ELSE 0 END) as jar_sd_bln_ini
                                            from tr_panjar 
                                            WHERE left(kd_skpd,17)=left('$lcskpd',17) and jns='2'
                               union all
                                select 
                                            SUM(CASE WHEN tgl_kas<'$ntgl1' THEN nilai ELSE 0 END) as jar_bln_lalu,
                                            SUM(CASE WHEN (tgl_kas BETWEEN '$ntgl1' and '$ntgl2') THEN nilai ELSE 0 END) as jar_bln_ini,
                                            SUM(CASE WHEN tgl_kas<='$ntgl2' THEN nilai ELSE 0 END) as jar_sd_bln_ini
                                            from tr_setorsimpanan 
                                            WHERE left(kd_skpd,17)=left('$lcskpd',17) and jenis='3'                         
                                ) x";
            }else{
                $sqlpanjarin="SELECT 
                                sum(x.jar_bln_lalu) as jar_bln_lalu,
      ...
      $hasil = $this->db->query($sqlpanjarin);
          ...
          SUM(CASE WHEN a.jns_beban='1' AND (a.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') THEN  a.nilai ELSE 0 END) AS jlain_up_ini,
          SUM(CASE WHEN a.jns_beban='4' AND a.tgl_bukti<'$ntgl1' THEN  a.nilai ELSE 0 END) AS jlain_gaji_ll,
          SUM(CASE WHEN a.jns_beban='4' AND (a.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') THEN  a.nilai ELSE 0 END) AS jlain_gaji_ini,
          SUM(CASE WHEN a.jns_beban='6' AND a.tgl_bukti<'$ntgl1' THEN  a.nilai ELSE 0 END) AS jlain_brjs_ll,
          SUM(CASE WHEN a.jns_beban='6' AND (a.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') THEN  a.nilai ELSE 0 END) AS jlain_brjs_ini
          FROM TRHINLAIN a WHERE pengurang_belanja !='1'
          ...
          AND LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17)
            ...
            $jmtrmup_ll =  $trh1->sp2d_up_ll + $trh2->jppn_up_ll + $trh3->jpph21_up_ll +
                             $trh4->jpph22_up_ll + $trh5->jpph23_up_ll + $trh6->jlain_up_ll+$tox + $trh15->ppnpn_up_ll+
               $trh70->up_iwp_ini + $trh71->up_tap_ini + $trh72->up_pph4_lalu +$trhpanjarin->jar_bln_lalu;                           
            
            $jmtrmup_ini =  $trh1->sp2d_up_ini + $trh2->jppn_up_ini + $trh3->jpph21_up_ini +
                             $trh4->jpph22_up_ini + $trh5->jpph23_up_ini + $trh6->jlain_up_ini + $trh15->ppnpn_up_ini+
               $trh70->up_iwp_ini + $trh71->up_tap_ini + $trh72->up_pph4_ini +$trhpanjarin->jar_bln_ini;
        ...
        sum(brg_ini) as spj_brjs_ini, sum(up_lalu) as spj_up_ll, sum(up_ini) as spj_up_ini from
        (select  a.kd_skpd, 0 as gaji_ini, 0 as brg_ini, isnull(a.nilai,0) as up_ini, 0 as gaji_lalu, 0 as brg_lalu, 0 as up_lalu from trdtransout a join trhtransout b on a.no_bukti=b.no_bukti and a.kd_skpd=b.kd_skpd
        where (b.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') and jns_spp in (1,2,3) 
        union all
        ...
        where (b.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') and b.pengurang_belanja=1
        union all
        select a.kd_skpd, isnull(a.nilai,0) as gaji_ini, 0 as brg_ini, 0 as up_ini, 0 as gaji_lalu, 0 as brg_lalu, 0 as up_lalu from trdtransout a join trhtransout b on a.no_bukti=b.no_bukti and a.kd_skpd=b.kd_skpd
        where (b.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') and jns_spp in (4)
        union all
        select  a.kd_skpd, isnull(a.rupiah*-1,0) as gaji_ini, 0 as brg_ini, 0 as up_ini, 0 as gaji_lalu, 0 as brg_lalu, 0 as up_lalu from trdkasin_pkd a join trhkasin_pkd b on a.no_sts=b.no_sts and a.kd_skpd=b.kd_skpd
        where (b.tgl_sts BETWEEN '$ntgl1' and '$ntgl2') and b.jns_cp in (1) and b.pot_khusus<>0
        union all
        select a.kd_skpd, 0 as gaji_ini, isnull(a.nilai,0) as brg_ini, 0 as up_ini, 0 as gaji_lalu, 0 as brg_lalu, 0 as up_lalu from trdtransout a join trhtransout b on a.no_bukti=b.no_bukti and a.kd_skpd=b.kd_skpd
        where (b.tgl_bukti BETWEEN '$ntgl1' and '$ntgl2') and jns_spp in (6)
        union all
        select  a.kd_skpd, 0 as gaji_ini, isnull(a.rupiah*-1,0) as brg_ini, 0 as up_ini, 0 as gaji_lalu, 0 as brg_lalu, 0 as up_lalu from trdkasin_pkd a join trhkasin_pkd b on a.no_sts=b.no_sts and a.kd_skpd=b.kd_skpd
        where (b.tgl_sts BETWEEN '$ntgl1' and '$ntgl2') and b.jns_cp in (2) and b.pot_khusus<>0
        union all
        select a.kd_skpd, 0 as gaji_ini, 0 as brg_ini, 0 as up_ini, 0 as gaji_lalu, 0 as brg_lalu, isnull(a.nilai,0) as up_lalu from trdtransout a join trhtransout b on a.no_bukti=b.no_bukti and a.kd_skpd=b.kd_skpd
      ...
      <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
        ...
        <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
           ...
           $lcrek = '210106010001';//'2130301';//'2110401'; // ppn setor
           if($nbulan==0){
            $csql = "SELECT (SELECT SUM(b.nilai) FROM trhstrpot a INNER JOIN trdstrpot b
                    ON a.no_bukti = b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17) AND 
        ...
        <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
            ...
            $lcrek = '210105010001';//'2130101'; // pph 21 setor
            if($nbulan==0){
            $csql = "SELECT (SELECT SUM(b.nilai) FROM trhstrpot a INNER JOIN trdstrpot b
                    ON a.no_bukti = b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17)  AND 
        ...
        <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
            ...
            $lcrek = '210105020001';//'2130201'; // pph 22 setor
            if($nbulan==0){
             $csql = "SELECT (SELECT SUM(b.nilai) FROM trhstrpot a INNER JOIN trdstrpot b
                    ON a.no_bukti = b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17)  AND 
       ...
       <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
        ...
        <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
            ...
            $lcrek = '210105030001';//'2130401'; // pph 23 setor
            if($nbulan==0){
            $csql = "SELECT (SELECT SUM(b.nilai) FROM trhstrpot a INNER JOIN trdstrpot b
                    ON a.no_bukti = b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17)  AND 
      ...
      $lcrek = '210108010001';//'2110701'; // IWP
          ...
          SUM(CASE WHEN b.jns_spp IN ('4') AND (b.tgl_bukti BETWEEN '$ntgl1' AND '$ntgl2') THEN  a.nilai ELSE 0 END) AS gj_iwp_ini,
          SUM(CASE WHEN b.jns_spp IN ('4') AND b.tgl_bukti<='$ntgl2' THEN  a.nilai ELSE 0 END) AS gj_iwp_sdini,
          SUM(CASE WHEN b.jns_spp IN ('6') AND b.tgl_bukti<'$nbulan' THEN  a.nilai ELSE 0 END) AS ls_iwp_lalu,
          SUM(CASE WHEN b.jns_spp IN ('6') AND (b.tgl_bukti BETWEEN '$ntgl1' AND '$ntgl2') THEN  a.nilai ELSE 0 END) AS ls_iwp_ini,
          SUM(CASE WHEN b.jns_spp IN ('6') AND b.tgl_bukti<='$ntgl2' THEN  a.nilai ELSE 0 END) AS ls_iwp_sdini
          FROM trdstrpot a INNER JOIN trhstrpot b ON a.no_bukti=b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE a.kd_rek6='$lcrek' AND LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17) ";   
      ...
      $lcrek = '2110901'; // PPnpn
          ...
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17)  AND 
                    ...
                    ON a.no_bukti = b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17)  AND 
                    b.kd_rek6 = '$lcrek' AND a.tgl_bukti<'$ntgl2' AND 
                    a.jns_spp IN('1','2','3')) AS ppnpn_up_ll,
                    (SELECT SUM(b.nilai) FROM trhstrpot a INNER JOIN trdstrpot b
                    ON a.no_bukti = b.no_bukti AND a.kd_skpd=b.kd_skpd
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17)  AND 
      ...
      // HKPG
        ...
        SUM(isnull((case when pot_khusus='1' AND rtrim(jns_cp)= '3' and (tgl_sts BETWEEN '$ntgl1' AND '$ntgl2') then a.rupiah else 0 end),0)) AS up_hkpg_ini,
        ...
        SUM(isnull((case when pot_khusus='1' AND rtrim(jns_cp)= '2' and (tgl_sts BETWEEN '$ntgl1' AND '$ntgl2') then a.rupiah else 0 end),0)) AS ls_hkpg_ini,
        ...
        SUM(isnull((case when pot_khusus='1' AND rtrim(jns_cp)= '1' and (tgl_sts BETWEEN '$ntgl1' AND '$ntgl2') then a.rupiah else 0 end),0)) AS gj_hkpg_ini,
        SUM(isnull((case when pot_khusus='1' AND rtrim(jns_cp)= '1' and tgl_sts<='$ntgl2' then a.rupiah else 0 end),0)) AS gj_hkpg_sdini
        FROM trdkasin_pkd a 
        INNER JOIN trhkasin_pkd b on a.no_sts=b.no_sts AND a.kd_skpd=b.kd_skpd
        WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17)  AND jns_trans='5'";
            }else{
                $csql = "SELECT 
        SUM(isnull((case when pot_khusus='1' AND rtrim(jns_cp)= '3' and MONTH(tgl_sts)<'$nbulan' then a.rupiah else 0 end),0)) AS up_hkpg_lalu,
        SUM(isnull((case when pot_khusus='1' AND rtrim(jns_cp)= '3' and MONTH(tgl_sts)='$nbulan' then a.rupiah else 0 end),0)) AS up_hkpg_ini,
      ...
      // Potongan Penghasilan Lainnya
        ...
        SUM(isnull((case when pot_khusus='2' AND rtrim(jns_cp)= '3' and (tgl_sts BETWEEN '$ntgl1' AND '$ntgl2')  then a.rupiah else 0 end),0)) AS up_lain_ini,
        ...
        SUM(isnull((case when pot_khusus='2' AND rtrim(jns_cp)= '2' and (tgl_sts BETWEEN '$ntgl1' AND '$ntgl2')  then a.rupiah else 0 end),0)) AS ls_lain_ini,
        ...
        SUM(isnull((case when pot_khusus='2' AND rtrim(jns_cp)= '1' and (tgl_sts BETWEEN '$ntgl1' AND '$ntgl2')  then a.rupiah else 0 end),0)) AS gj_lain_ini,
        ...
        <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
            ...
            if($nbulan==0){
                $csql = "select 
      SUM(isnull((case when rtrim(jns_cp)= '3' and (tgl_sts BETWEEN '$ntgl1' AND '$ntgl2') then z.nilai else 0 end),0)) AS cp_spj_up_ini,
      SUM(isnull((case when rtrim(jns_cp)= '3' and tgl_sts<'$ntgl1' then z.nilai else 0 end),0)) AS cp_spj_up_ll,
      SUM(isnull((case when rtrim(jns_cp)= '1' and (tgl_sts BETWEEN '$ntgl1' AND '$ntgl2') then z.nilai else 0 end),0)) AS cp_spj_gaji_ini,
      SUM(isnull((case when rtrim(jns_cp)= '1' and tgl_sts<'$ntgl1' then z.nilai else 0 end),0)) AS cp_spj_gaji_ll,
      SUM(isnull((case when rtrim(jns_cp)= '2' and (tgl_sts BETWEEN '$ntgl1' AND '$ntgl2') then z.nilai else 0 end),0)) AS cp_spj_brjs_ini,
      SUM(isnull((case when rtrim(jns_cp)= '2' and tgl_sts<'$ntgl1' then z.nilai else 0 end),0)) AS cp_spj_brjs_ll
      from (select rupiah as nilai,jns_trans,pot_khusus,jns_cp,d.tgl_sts ,d.kd_skpd from 
      trdkasin_pkd c INNER JOIN trhkasin_pkd d ON c.no_sts = d.no_sts AND c.kd_skpd = d.kd_skpd where LEFT(d.kd_skpd,17)= LEFT('$lcskpd',17)  AND 
      ((jns_trans='5' AND pot_khusus='0') OR jns_trans='1')) z";
            }else{
                $csql = "select 
      SUM(isnull((case when rtrim(jns_cp)= '3' and MONTH(tgl_sts)='$nbulan' then z.nilai else 0 end),0)) AS cp_spj_up_ini,
      ...
      if($nbulan==0){
           $sqlpanjarout="select 
            ...
            SUM(CASE WHEN tgl_kas<='$ntgl2' THEN nilai ELSE 0 END) as jar_sd_bln_ini
            from tr_panjar
            WHERE left(kd_skpd,17)=left('$lcskpd',17)";
      }else{
          $sqlpanjarout="select 
            SUM(CASE WHEN MONTH(tgl_kas)<'$nbulan' THEN nilai ELSE 0 END) as jar_bln_lalu,
            SUM(CASE WHEN MONTH(tgl_kas)='$nbulan' THEN nilai ELSE 0 END) as jar_bln_ini,
      ...
      $hasil = $this->db->query($sqlpanjarout);
            $trhpanjaroutx = $hasil->row();
            $totalpanjarout = $trhpanjaroutx->jar_bln_lalu + $trhpanjaroutx->jar_bln_ini + $trhpanjaroutx->jar_sd_bln_ini ;
          ...
          WHERE LEFT(a.kd_skpd,17)= LEFT('$lcskpd',17) 
            ...
            $tox_awal="SELECT isnull(sld_awal,0) AS jumlah FROM ms_skpd where LEFT(kd_skpd,17)= LEFT('$lcskpd',17)  and '1'=$nbulan";
            $hasil = $this->db->query($tox_awal);
            $tox_ini = $hasil->row('jumlah');
//      echo  $tox_ini;        
            $tox_ini=(empty($tox_ini)?0:$tox_ini);
...
//      echo  '-'.$tox_ll;
            ...
            $jmsetup_ll =  $trh7->spj_up_ll + $trh8->jppn_up_ll + $trh9->jpph21_up_ll + $trh16->ppnpn_up_ll +
                             $trh10->jpph22_up_ll + $trh11->jpph23_up_ll + $trh12->jlain_up_ll + $tox_ll+$trh_x->cp_spj_up_ll+
               $trh73->up_iwp_lalu + $trh74->up_tap_lalu+$trh75->up_pph4_lalu+$trhxx->up_hkpg_lalu+$trhxy->up_lain_lalu+
                             $trhpanjaroutx->jar_bln_lalu;                             
            
            $jmsetup_ini =  $trh7->spj_up_ini + $trh8->jppn_up_ini + $trh9->jpph21_up_ini + $trh16->ppnpn_up_ini +
                             $trh10->jpph22_up_ini + $trh11->jpph23_up_ini + $trh12->jlain_up_ini+$tox_ini+$trh_x->cp_spj_up_ini+
               $trh73->up_iwp_ini + $trh74->up_tap_ini+$trh75->up_pph4_ini+$trhxx->up_hkpg_ini+$trhxy->up_lain_ini+
                             $trhpanjaroutx->jar_bln_ini;
      ...
      <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
        ...
        <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
                ...
                <td align='right' style='font-size:12px'>".number_format(0,"2",",",".")."&nbsp;</td>
                <td align='right' style='font-size:12px'>".number_format(0,"2",",",".")."&nbsp;</td>
                <td align='right' style='font-size:12px'>".number_format($trhpanjaroutx->jar_bln_lalu,"2",",",".")."&nbsp;</td>
                <td align='right' style='font-size:12px'>".number_format($trhpanjaroutx->jar_bln_ini,"2",",",".")."&nbsp;</td>
                <td align='right' style='font-size:12px'>".number_format($trhpanjaroutx->jar_sd_bln_ini,"2",",",".")."&nbsp;</td>
                <td align='right' style='font-size:12px'>".number_format($trhpanjaroutx->jar_sd_bln_ini,"2",",",".")."&nbsp;</td>
        <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
            </tr>
            ";
