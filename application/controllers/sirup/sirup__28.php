...
class Sirup extends CI_Controller {
    ...
    function input_penyedia_myears(){
        ...
        $this->template->load('template','anggaran/input_penyedia_myears',$data) ; 
    }     
	...
	function input_final_penyedia(){
        ...
        $this->template->load('template','anggaran/input_final_penyedia',$data) ; 
    }
	...
	function input_final_swakelola(){
        ...
        $this->template->load('template','anggaran/input_final_swakelola',$data) ; 
    }	
    
	function input_umumkan_penyedia(){
        $data['page_title']= 'INPUT UMUMKAN PENYEDIA';
        $this->template->set('title', 'INPUT UMUMKAN PENYEDIA');   
        $this->template->load('template','anggaran/input_umumkan_penyedia',$data) ; 
    }
	
	function input_umumkan_swakelola(){
        $data['page_title']= 'INPUT UMUMKAN SWAKELOLA';
        $this->template->set('title', 'INPUT UMUMKAN SWAKELOLA');   
        $this->template->load('template','anggaran/input_umumkan_swakelola',$data) ; 
    }

    function input_revisi_penyedia(){
        $data['page_title']= 'INPUT REVISI PENYEDIA';
        $this->template->set('title', 'INPUT REVISI PENYEDIA');   
        $bidang = $this->session->userdata('pcBidang');
        if($bidang==6){
            $this->template->load('template','anggaran/input_revisi_penyedia_ppkom',$data) ;
        }else{
            $this->template->load('template','anggaran/input_revisi_penyedia_pa',$data) ;
        }         
    }
    ...
    function listKegiatan(){                      
		...
		$sql   ="
                ...
                LEFT JOIN (
                select a.kd_kegiatan,b.nip,b.id,b.nama,a.username from m_giat_rup a left join ms_ttd b on a.username=b.username
    ...
    function listKegiatan_mYears(){                      
        ...
        $sql   ="
                SELECT d.kd_kegiatan,d.nm_kegiatan,d.nilai,d.kd_program,d.nilai_sirup,d.nip,d.id,d.nama,d.username from(
                SELECT a.kd_kegiatan,a.nm_kegiatan,a.nilai,b.kd_program,
                (SELECT isnull(sum(b.pagu),0) from sirup_detail b left join sirup_header d on d.id=b.id and d.username=b.username where (d.is_deleted<>1 or d.is_deleted is null) and b.kd_kegiatan=a.kd_kegiatan) nilai_sirup,
                c.nip,c.id,c.nama,c.username                                  
                FROM 
                (
                select kd_kegiatan,nm_kegiatan,SUM(nilai) nilai from(
                
                select a.kd_kegiatan,a.nm_kegiatan,SUM(b.nilai_ubah+a.nilai_ubah) nilai 
                FROM trdrka_n1 a left join trdrka b on b.kd_kegiatan=a.kd_kegiatan
                WHERE left(a.kd_skpd,7)=left('$skpd',7)
                GROUP BY a.kd_kegiatan,a.nm_kegiatan
                
                )x GROUP BY x.kd_kegiatan,x.nm_kegiatan
                )a 
                LEFT JOIN trskpd b ON a.kd_kegiatan=b.kd_kegiatan 
                LEFT JOIN (
                select a.kd_kegiatan,b.nip,b.id,b.nama,a.username from m_giat_rup a left join ms_ttd b on a.username=b.username
    ...
    function listRekening() {                      
        ...
        $sql = "SELECT a.kd_rek5,a.nm_rek5,a.sumber,a.nilai_ubah nilai FROM 				
...
group by c.kd_rek4,c.nm_rek4,b.lokasi,b.tu_capai,b.nm_skpd
    ...
    function idrup_lama() {                      
        ...
        $sql_       = "select a.*,
                       (select top 1 nm_program from m_prog where kd_program=left(a.kd_kegiatan,18)) as nm_program,
                       (select top 1 a.nm_skpd from ms_skpd a where a.kd_skpd='$kd_skpd') as nm_skpd,
                       (select top 1 nama from ms_ttd where kd_skpd='$kd_skpd' and id=a.id_ppk) as ppk,
                       ...
                       where a.username='$usernam' and a.kd_skpd='$kd_skpd' and a.is_revisi in ('1','2')  ";
        $query1 = $this->db->query($sql_);  
        $result = array();
        foreach($query1->result_array() as $resulte){            
            $result[] = array(
	...
	function loadPenyedia() {
        ...
        $sql = "SELECT c.* FROM(SELECT TOP $rows b.*,
                (select top 1 nm_program from m_prog where kd_program=left(b.kd_kegiatan,18)) as nm_program,
                (select top 1 a.nm_skpd from ms_skpd a where a.kd_skpd='$kd_skpd') as nm_skpd,
                (select top 1 nama from ms_ttd where kd_skpd='$kd_skpd' and id=b.id_ppk) as ppk,
    ...
    function loadPenyedia_pa() {
        ...
        $sql = "
                ...
                (select top 1 nm_program from m_prog where kd_program=left(b.kd_kegiatan,18)) as nm_program,
                (select top 1 a.nm_skpd from ms_skpd a where a.kd_skpd='$kd_skpd') as nm_skpd,
                (select top 1 nama from ms_ttd where kd_skpd='$kd_skpd' and id=b.id_ppk and username=b.username) as ppk,
    ...
    function loadSwakelola() {
        ...
        $sql = "SELECT TOP $rows b.*,
                ...
                (select top 1 nama from ms_ttd where id=b.id_ppk) namappk,
    ...
    function loadSwakelola_pa() {
        ...
        $sql = "SELECT TOP $rows b.*,
                (select top 1 a.nm_program from m_prog a where a.kd_program=left(b.kd_kegiatan,18)) as nm_program,
                (select top 1 a.nm_skpd from ms_skpd a where a.kd_skpd='$kd_skpd') as nm_skpd,
                (select top 1 nm_lokasi from sirup_lokasi where kd_lokasi like b.lokasi ) nm_lokasi,
                (select top 1 nama from ms_ttd where id=b.id_ppk) namappk,
	 ...
	 */
	 ...
	 function load_cek_list_sirup(){
        ...
        $sql = "select a.idrup,a.id,a.nm_kegiatan,a.nm_paket,
                ...
                case when a.is_revisi=1 then 'YA' else '-' end as revisi,
         ...
         $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
           ...
           if($kd_ppkom=="-"){
            ...
            $cRet .="
                    ...
                    <td valign=\"top\" align=\"center\" width=\"30%\" style=\"font-size:11px;\"><b>PROGRAM</b></td>
                    <td valign=\"top\" align=\"center\" width=\"30%\" style=\"font-size:11px;\"><b>KEGIATAN</b></td>
           ...
           if($kd_ppkom=="-"){
            ...
            (select nm_program from m_prog where kd_program=left(a.kd_kegiatan,18)) nm_program,
            (select count(idrup) from sirup_header where username=a.username and kd_kegiatan=a.kd_kegiatan) paket
            from m_giat_rup a 
                   where substring(a.kd_kegiatan,6,7)=left('$kd_skpd',7) order by a.kd_kegiatan";   
           }else{
                 $sql = "select 'aktif' status,a.kd_kegiatan,a.nm_kegiatan,
            (select top 1 nama from [user] where id_user=a.id and bidang='6' and kd_skpd='$kd_skpd') ppk,
            (select nm_program from m_prog where kd_program=left(a.kd_kegiatan,18)) nm_program,
            0 paket
            from m_giat_rup a 
                   where substring(a.kd_kegiatan,6,7)=left('$kd_skpd',7) and a.username='$kd_ppkom' order by a.kd_kegiatan";   
           }
           ...
           foreach ($hasil->result() as $row)
            ...
            if($cstatus=='aktif'){
                $cRet .="
                    ...
                    <td valign=\"top\" align=\"justify\" width=\"30%\" style=\"font-size:11px; \">&nbsp;$cnmpro</td>
                ...
                $cRet .="
                    ...
                    <td valign=\"top\" align=\"justify\" width=\"30%\" style=\"font-size:11px; color:red;\">&nbsp;$cnmpro</td>
