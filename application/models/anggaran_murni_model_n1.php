...
class anggaran_murni_model_n1 extends CI_Model {
	...
	function tsimpan_ar_rancang($kdskpd,$kdkegi,$kdrek,$nilai,$sdana1,$sdana2,$sdana3,$sdana4,$ndana1,$ndana2,$ndana3,$ndana4){ 
        ...
        $query_del = $this->db->query("DELETE from trdrka_n1 where kd_skpd='$kdskpd' and kd_sub_kegiatan='$kdkegi' and kd_rek6='$kdrek' ");
        $query_ins = $this->db->query("INSERT into trdrka_n1(no_trdrka,kd_skpd,nm_skpd,kd_sub_kegiatan,nm_sub_kegiatan,kd_rek6,nm_rek6,nilai,nilai_sempurna,nilai_ubah,
    ...
    function load_nilai_kua_rancang($cskpd){ 
        ...
        $query1 = $this->db->query("SELECT a.nilai_kua, 
                                (SELECT SUM(nilai) FROM trdrka_n1 WHERE LEFT(kd_rek6,1)='5' AND left(kd_skpd,20) = left(a.kd_skpd,20)) as nilai_ang,
                                (SELECT SUM(nilai_sempurna) FROM trdrka_n1 WHERE LEFT(kd_rek6,1)='5' AND left(kd_skpd,20) =left(a.kd_skpd,20)) as nilai_angg_sempurna,
                                (SELECT SUM(nilai_ubah) FROM trdrka_n1 WHERE LEFT(kd_rek6,1)='5' AND left(kd_skpd,20) = a.kd_skpd) as nilai_angg_ubah
    ...
    function thapus_rancang($skpd,$kegiatan,$rek) {
        ...
        $query = $this->db->query(" DELETE from trdrka_n1 where left(kd_skpd,20)=left('$skpd',20) and kd_sub_kegiatan='$kegiatan' and kd_rek6='$rek' ");
    ...
    function select_rka_rancang($kegiatan,$skpd) {
        ...
        $sql = "SELECT '5' as jns_kegiatan,b.nm_rek6, a.* from trdrka_n1 a inner join ms_rek6 b on a.kd_rek6=b.kd_rek6 
    ...
    function load_sum_rek_rancang($kdskpd,$sub_kegiatan){
        ...
        $query1 = $this->db->query(" SELECT sum(nilai) as rektotal,sum(nilai_sempurna) as rektotal_sempurna,sum(nilai_ubah) as rektotal_ubah from 
                                     trdrka_n1 where $sort and kd_sub_kegiatan='$sub_kegiatan'");  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
        { 
    ...
    function load_sum_rek_rinci_rancang($kdskpd,$kegiatan,$rek){
        ...
        $query1 = $this->db->query("SELECT sum(total) as rektotal_rinci, sum(total_sempurna) as rektotal_rinci_sempurna, sum(total_ubah) as rektotal_rinci_ubah from trdpo_n1 where no_trdrka='$norka' ");  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte){ 
            $result[] = array(
    ...
    function rka_rinci_rancang($skpd,$kegiatan,$rekening,$norka,$idlokasi) {
        ...
        $sql    = "SELECT *, volume1*isnull(volume2,1)*isnull(volume3,1) tvol from trdpo_n1 where no_trdrka='$norka' order by id";                   
        ...
        { 
            ...
            $result[] = array(
                        ...
                        'harga2'  => number_format($resulte['harga1'],"2",".",","),                             
                        'harga3'  => number_format($resulte['harga1'],"2",".",","),
    ...
    function tsimpan_rinci_jk_rancang($norka,$csql,$cskpd,$kegiatan,$rekening,$id,$sdana1,$sdana2,$sdana3,$sdana4,$ndana1,$ndana2,$ndana3,$ndana4){
        ...
        $asg       = $this->db->query($sql);
                ...
                if (!($asg)){
                    ...
                    $sql = "INSERT into trdpo_n1(no_po,header,kd_skpd,kd_sub_kegiatan,kode,kd_barang,no_trdrka,uraian,volume1,satuan1
                    ...
                    $query1 = $this->db->query(" UPDATE trdrka_n1 set nilai= (select sum(total) as nl from trdpo where no_trdrka=trdrka.no_trdrka),
    ...
    function thapus_rinci_ar_all_rancang($norka,$rek,$skpd,$giat){
        ...
        $query = $this->db->query("UPDATE trdrka_n1 set nilai='0', nilai_sempurna='0', nilai_ubah='0' where no_trdrka='$norka'");
        if ( $query > 0 ){
            return '1' ;
        } else {
            return '0' ;
    ...
    function simpan_det_keg_rancang($ttd, $ang_lalu, $skpd,$giat,$lokasi,$keterangan,$waktu_giat,$waktu_giat2,$sub_keluaran,$sas_prog,  
        ...
        $this->db->query(" UPDATE trskpd_n1 set 
                                            lokasi='$lokasi',
    ...
    function load_det_keg_rancang($kdskpd,$kegiatan){
        ...
        $query1 = $this->db->query("SELECT * from trskpd_n1 where left(kd_skpd,20)=LEFT('$kdskpd',20) and kd_sub_kegiatan='$kegiatan'");  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
        { 
