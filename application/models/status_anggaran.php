...
class status_anggaran extends CI_Model {
    ...
    function cek_status_ang(){
        ...
        $sql = "SELECT 
				...
				when statu=0 and status_sempurna=0 and status_ubah=0  then 'Penyusunan'
				when statu=0 and status_sempurna=1 and status_ubah=0  then 'Penyusunan'
				when statu=0 and status_sempurna=1 and status_ubah=1  then 'Penyusunan'
				when statu=1 and status_sempurna=0 and status_ubah=1  then 'Perubahan'
