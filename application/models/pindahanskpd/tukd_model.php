...
class Tukd_model extends CI_Model {
	...
	function cek_sisa_spd($skpd,$jns,$nospp,$no_bukti,$tgl,$jnsspp=''){
		...
		$csql2 ="		union all
						...
						where LEFT(kd_rek5,2)='$jns' and b.jns_spp in ('3','4','5','6') and a.kd_skpd='$skpd' and b.no_spp<>'$nospp' and (sp2d_batal is null or sp2d_batal <>'1')
						union all
						...
						where LEFT(kd_rek5,2)='$jns' and b.jns_spp in ('1','2') and a.kd_skpd='$skpd' and a.no_bukti<>'$no_bukti'
						union all
						...
						and a.kd_skpd=b.kd_skpd where LEFT(kd_rek5,2)='$jns' and b.jns_spp in ('1','2') and a.kd_skpd='$skpd' and status_validasi<>'1'"; 
...
// -----------------------------------------------------	
    function qangg_sdana($tgl,$skpd,$giat,$kdrek5){
        ...
        $hasil='';
        $csql ="select kd_kegiatan,kd_rek5,rtrim(ltrim($sumber1)) [sumber],nilai_sumber [nilai_sumber],nsumber1_su [nilai_sumber_semp],nsumber1_ubah [nilai_sumber_ubah]  
                from trdrka  where kd_skpd='$skpd' and kd_kegiatan='$giat' and kd_rek5='$kdrek5' and rtrim(ltrim($sumber1))<>''
                union all
                select kd_kegiatan,kd_rek5,rtrim(ltrim($sumber2)) [sumber],nilai_sumber2 [nilai_sumber],nsumber2_su [nilai_sumber_semp],nsumber2_ubah [nilai_sumber_ubah] 
                from trdrka  where kd_skpd='$skpd' and kd_kegiatan='$giat' and kd_rek5='$kdrek5' and rtrim(ltrim($sumber2))<>''
                union all
                select kd_kegiatan,kd_rek5,ltrim($sumber3) [sumber],nilai_sumber3 [nilai_sumber],nsumber3_su [nilai_sumber_semp],nsumber3_ubah [nilai_sumber_ubah] 
                from trdrka  where kd_skpd='$skpd' and kd_kegiatan='$giat' and kd_rek5='$kdrek5' and rtrim(ltrim($sumber3))<>''
                union all
                select kd_kegiatan,kd_rek5,rtrim(ltrim($sumber4)) [sumber],nilai_sumber4 [nilai_sumber],nsumber4_su [nilai_sumber_semp],nsumber4_ubah [nilai_sumber_ubah] 
                from trdrka  where kd_skpd='$skpd' and kd_kegiatan='$giat' and kd_rek5='$kdrek5' and ltrim(ltrim($sumber4))<>'' ";
            $hasil = $this->db->query($csql);
            return $hasil;
    }    
...
// -----------------------------------------------------	
    ...
    function qtrans_sdana($sumber,$giat,$rek,$skpd,$nobkuk){
        ...
        $csql ="select sum(nilai) [total] from (
                    ...
                    where b.kd_skpd='$skpd' and b.kd_kegiatan='$giat' and b.kd_rek5='$rek'  and jns_spp not in ('1','2') AND (a.sp2d_batal<>1 OR a.sp2d_batal IS NULL)
                    union all
                    ...
                    where b.kd_skpd='$skpd' and b.kd_kegiatan='$giat' and b.kd_rek='$rek' and b.no_bukti not in (select no_tagih from trhspp where kd_skpd='$skpd')
                    union all
					...
					where b.kd_skpd='$skpd' and b.kd_kegiatan='$giat' and b.kd_rek5='$rek' and jns_spp  in ('1') and a.no_bukti not in('$nobkuk')
                ) as gabung ";
        $hasil = $this->db->query($csql);
        return $hasil;
    }    
    ...
    function qtrans_sdana2($sumber,$giat,$rek,$skpd,$nobkuk){
        ...
        $csql ="select sum(nilai) [total] from (
                    ...
                    where b.kd_skpd='$skpd' and b.kd_kegiatan='$giat' and b.kd_rek5='$rek'  and jns_spp not in ('1','2') and b.sumber='$sumber' AND (a.sp2d_batal<>1 OR a.sp2d_batal IS NULL)
                    union all
                    select 'tagih' [jdl],isnull(sum(isnull(b.nilai,0)),0) [nilai] from trhtagih a join trdtagih b on a.no_bukti=b.no_bukti 
                    and a.kd_skpd=b.kd_skpd
                    where b.kd_skpd='$skpd' and b.kd_kegiatan='$giat' and b.kd_rek='$rek' and b.no_bukti not in 
                    (select no_tagih from trhspp where kd_skpd='$skpd') and b.sumber='$sumber'
                    union all
                    select 'trans' [jdl],isnull(sum(isnull(b.nilai,0)),0) [nilai]  from trhtransout a join trdtransout b on a.no_bukti=b.no_bukti and a.kd_skpd=b.kd_skpd
					where b.kd_skpd='$skpd' and b.kd_kegiatan='$giat' and b.kd_rek5='$rek' and jns_spp  in ('1') and a.no_bukti not in('$nobkuk') and b.sumber='$sumber'
                ) as gabung ";
        $hasil = $this->db->query($csql);
        return $hasil;
    }    	
