    ...
    function cek2(cetak){
        ...
        var url="<?php echo site_url(); ?>cetak_perda/lampiran2_murni/"+ctglttd+'/'+tipe_doc+'/'+cetak+'/<?php echo $jenis ?>';
...
<embed src='<?php echo site_url(); ?>cetak_perda/lampiran2_murni/<?php echo $this->session->userdata('pcThang'); ?>-1-1/<?php echo $jenis1 ?>/0' width='100%' height='600px'></embed>
