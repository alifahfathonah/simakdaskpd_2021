    ...
    function cek2(cetak){
        ...
        var url="<?php echo site_url(); ?>cetak_perda/lampiran4_murnid/"+ctglttd+'/'+tipe_doc+'/'+cetak+'/<?php echo $jenis ?>';
...
<embed src='<?php echo site_url(); ?>cetak_perda/lampiran4_murnid/<?php echo $this->session->userdata('pcThang'); ?>-1-1/<?php echo $jenis1 ?>/0' width='100%' height='600px'></embed>
