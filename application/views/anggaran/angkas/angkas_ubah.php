...
<head> 
    ...
    function simpan(){
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data: ({csts:'ubah',cskpda:kode,cskpd:skpdd,crek5:xrekening,cgiat:xkegiatan,jan:a,feb:b,mar:c,apr:d,mei:e,jun:f,jul:g,ags:h,sep:i,okt:j,nov:k,des:l,tr1:m,tr2:n,tr3:o,tr4:p}),
            dataType:"json",
    ...
    function load(){         
        ...
        $(function(){      
         $.ajax({
            ...
            url:"<?php echo base_url(); ?>index.php/rka_ro/load_trdskpd/nilai_ubah",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
                    bulan = n['bulan'];
