...
function ttd2(){
    ...
    function cek(cetak){
        ...
        url="<?php echo site_url(); ?>preview_pendapatan_pergeseran/"+ctglttd+'/'+ttd+'/'+ttd2+'/'+ckdskpd+'/'+cetak+'/'+doc+'/'+status_anggaran1+'/nilai_sempurna/RKA Pendapatan Penyusunan-'+ckdskpd;
    ...
    function cetakbawah(){
        ...
        var  status_anggaran1    = document.getElementById('status_anggaran1').value;
        var  status_anggaran2    = document.getElementById('status_anggaran2').value;
        url="<?php echo site_url(); ?>preview_pendapatan_pergeseran/2020-1-1/tanpa/tanpa/"+ckdskpd+"/0/"+doc+"/"+status_anggaran1+"/nilai_sempurna/ Pendapatan Penyusunan-"+ckdskpd;        
        if(ckdskpd!=''){
