...
group by left(kd_gabungan,22) ,nm_skpd order by left(kd_gabungan,22) "); 
    ...
    ?>
    	<tr>
    		...
    		<td width="25%" align="center"><a class="button" href="<?php echo base_url(); ?>cetak_rka/list_cetak<?php echo $jenis ?>_belanja_rinci_pergeseran/<?php  echo $abc->kd_skpd; ?>/<?php echo $jenis ?>">PILIH</a></td>
    	</tr>
    <?php endforeach; ?>
    </table>
</div>
