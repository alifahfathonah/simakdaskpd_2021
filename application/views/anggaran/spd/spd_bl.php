...
//var con_blk_bl='/BL/BPKAD-B/'.tahun_anggaran;
    ...
    $(document).ready(function() {
        ...
        function get_skpd(kd_s='',nm='') {
				...
				//kode = data.kd_skpd;
                kode = kd_s;
				$('#bendahara').combogrid({url:'<?php echo base_url(); ?>index.php/rka_simakda/load_bendahara_p',
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/rka_simakda/load_spd_bl',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onSelect:function(rowIndex,rowData){
		  ...
		  //alert (tot);
          get(nomor,tgl,kode,nama,bulan1,bulan2,jns,tot,ketentuan,nama_bend,status_spd);
          //load_detail();
          //beban();
		   //tombol(status_spd);
          //jumlah_detail();
        ...
        onDblClickRow:function(rowIndex,rowData){         
          ...
          nama_bend  = rowData.nama_bend; 
          status_spd  = rowData.status; 
          tot   = angka(rowData.total)//number_format(
			get(nomor,tgl,kode,nama,bulan1,bulan2,jns,tot,ketentuan,nama_bend,status_spd);
          load_detail();
          //beban();
		   tombol(status_spd);
		  ...
		  $(function(){
            ...
            onSelect:function(rowIndex,rowData){
                ...
                nmskpd = rowData.nm_skpd;
				 ...
				 $('#dg').edatagrid({
				url:'<?php echo base_url(); ?>index.php/anggaran_spd/load_spd_bl_skpd/'+skpd,				
				});	
			}
            });
        });	
		...
		$('#bendahara_ppkd').combogrid({  
           ...
           textField:'nip_ppkd',  
           mode:'remote',
           url:'<?php echo base_url(); ?>index.php/rka_simakda/load_bendahara_ppkd',
//		   queryParams:({kode:kode}),
           columns:[[  
    ...
    function gett_bendahara(skpd){
        $('#bendahara').combogrid({  
           panelWidth:700,  
           idField:'nip',  
           textField:'nip',  
           mode:'remote',
           url:'<?php echo base_url(); ?>index.php/rka_simakda/load_bendahara_p/'+skpd,
		  // queryParams:({kode:kode}),
           columns:[[  
               {field:'nip',title:'NIP',width:150},  
               {field:'nama',title:'Nama',width:500}    
    ...
    function beban(){
         ...
         $('#giat').combogrid({
               url:'<?php echo base_url(); ?>index.php/rka_simakda/load_trskpd',
    ...
    function load_detail(){
		...
		var bln1  = angka(document.getElementById('bulan1').value);
        	//alert(kk);alert(jenis);alert(tgl1);alert(bln1);alert(kode);
			...
			nowrap:"true",	
			url: '<?php echo base_url(); ?>/index.php/anggaran_spd/load_dspd_ag_blx',
    ...
    function jumlah_detail()
        {
        	...
        	$.ajax({
        		url:'<?php echo base_url(); ?>index.php/rka_simakda/jumlah_detail_spd/',
        		type: "POST",
        		dataType:"json",   
    ...
    function load_detail_kosong(){
        var no_kos = '' ;
			$('#dg1').edatagrid({
			url: '<?php echo base_url(); ?>/index.php/anggaran_spd/load_dspd',
    ...
    function aktif_spd(){
		...
		$(document).ready(function(){
			$.ajax({
                    ...
                    url: '<?php echo base_url(); ?>/index.php/rka_simakda/cek_simpan',
                    success:function(data){                        
						...
						$.ajax({
							...
							url: '<?php echo base_url(); ?>/index.php/rka_simakda/update_sts_spd',
							success:function(data){
								status = data;
    ...
    function validate1(){
		...
		$("#bulan2").attr("value",bln1);
            ...
            $(function(){
			$('#dg1').edatagrid({
				 url: '<?php echo base_url(); ?>/index.php/rka_simakda/load_dspd_all_keg/'+jenis+'/'+kode+'/'+bln1+'/'+bln1+'/'+cno,
                 idField:'id',
                 toolbar:"#toolbar",              
                 rownumbers:"true", 
                 fitColumns:"true",
...
//			set_grid();
    ...
    function validate2(){
		...
		if (bln2 < bln1){
			...
			$(document).ready(function(){
    			$('#dg1').edatagrid({
    				 url: '<?php echo base_url(); ?>/index.php/rka_simakda/load_dspd_bl/52/'+kode+'/'+bln1+'/'+bln2+'/'+cnomor,
     ...
     function get_total() {
		...
		var cnomor =cno.split("/").join("123456789");		
        	$.ajax({
				 url: '<?php echo base_url(); ?>/index.php/rka_simakda/load_tot_dspd_bl/52/'+kode+'/'+bln1+'/'+bln2+'/'+cnomor+'/'+tgl1,
        		type: "POST",
        		dataType:"json",   
        		success:function(data){
...
function cetak()
        {
          ...
          var kd = skpd;
        //  alert(kd);
        var url ="<?php echo site_url(); ?>cetak_spd/cetak_register_spd";       
        //var jenis = document.getElementById('jenis').value;
        //var bulan = document.getElementById('bulan').value;
        
            window.open(url+'/'+kd+'', '_blank');
            window.focus();
    ...
    function hapus(){
        ...
        var urll = '<?php echo base_url(); ?>index.php/rka_simakda/hapus_spd';
    ...
    function cek_spd(){
        ...
        var cjenis_spp = document.getElementById('jenis_spp').value;
                	...
                	//-------------------------------------------------------			
                        $(document).ready(function(){
                            $.ajax({
                                type: "POST",    
                                dataType:'json',                            
                                data: ({tabel:'trhspd',mode_tox:'tambah',no2:cno,no:cno,tgl:ctgl,skpd:cskpd,nmskpd:cnmskpd,bend:cbend,bln1:cbln1,bln2:cbln2,ketentuan:cketentuan,pengajuan:cpengajuan,jenis:cjenis,total:ctotal,jns_spp:cjenis_spp}),
                                url: '<?php echo base_url(); ?>/index.php/rka_simakda/simpan_spd',
                                success:function(data){
                                    status = data.pesan;                    
                                }
                            });
    ...
    function spdlalu(cgiat){
        ...
        $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/rka_simakda/spd_lalu',
    ...
    function tes(){
        urrl= '<?php echo base_url(); ?>/index.php/rka_simakda/sql_tes'
       $(document).ready(function(){
    ...
    function bend(c){                
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:c}),
            url:"<?php echo base_url(); ?>index.php/rka_simakda/load_bendahara_p",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
 ...
 */		   
    ...
    function get_realisasi_spd(){
        ...
        $(function(){      
         $.ajax({
            ...
            url:"<?php echo base_url(); ?>index.php/rka_simakda/get_realisasi_keg_spd",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
    ...
    function get_anggkas_keg(){
        ...
        $(function(){      
         $.ajax({
            ...
            url:"<?php echo base_url(); ?>index.php/rka_simakda/get_anggkas_keg",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
    ...
    function cekbln_akhir(kd_s){
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,jenis:b}),
            url:"<?php echo base_url(); ?>index.php/rka_simakda/bln_spdakhir",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
	...
	function cekspd2(){
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,jenis:b,bulan:bln1}),
            url:"<?php echo base_url(); ?>index.php/rka_simakda/bln_spdakhir_cek",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
                    stt = n['status'];
...
<h3><a href="#" id="section1">List SPD</a></h3>
    ...
    <p align="center" style="width: 100%">
		<table align="center">
			<tr>
				<td align="left">SKPD &nbsp;<input id="kpskpd" name="kpskpd" style="width: 155px;"  onchange="javascript:load_list();" /></td>
				<!--<td align="right"><a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:kosong();section2();">Tambah Baru</a></td>-->
				<td align="right"><a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak();">cetak</a>
          <a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari();">Cari</a>
				<input type="text" value="" id="txtcari"/></td>
			</tr>
		</table>
		
        <table id="dg" title="List SPD" style="width:870px;height:450px; position: relative;" >  
        </table>                          
    </p> 
    </div>   
...
<h3><a href="#" id="section2"><b id="p1" style="font-size:17px;color: red;"></b></a></h3>
   ...
   <p>       
        <table align="center" border='1' style="width:870px;" cellpadding="2" cellspacing="2">
           ...
           <tr style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">
                ...
                <td style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;border-right-style:hidden;">&nbsp;<input id="skpd" name="skpd" style="width: 155px;" disabled readonly="true" onchange="javascript:kosong();" /></td>
            ...
            <tr style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">
				...
				&nbsp;<input type="text" id="nomor" style="width: 300px;" readonly="true" />
                ...
                <td style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">&nbsp;&nbsp;<input type="text" id="tanggal" disabled readonly="true" style="width: 140px;" /></td>     
            </tr>                        
              ...
              <tr style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">
                ...
                <input  type="hidden" id="jenis" name="jenis" value="0" style="width: 20px;" />
                
                <!--<select name="jenis" id="jenis" style="width: 150px;">
				<option value="52">Belanja   Langsung</option>
                </select>-->
                
                <input  type="hidden" id="jenis_spp" name="jenis_spp" value="0" style="width: 20px;" />
            ...
            <tr style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">
                ...
                <td style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;border-right-style:hidden;"><textarea type="text" disabled readonly="true" id="ketentuan" cols="30" rows="1" ></textarea></td>
                <td style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;border-right-style:hidden;"></td>
            ...
            <tr style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">
				...
				&nbsp;<input type="text"  name="nip" readonly="true" id="bendahara" style="width:300px" /> &nbsp;
            ...
            <tr style="padding:3px;border-spacing:5px 5px 5px 5px;">
				...
				<a class="easyui-linkbutton" iconCls="icon-ok" plain="true" disabled onclick="javascript:aktif_spd();" align="left"><b id="id_aktif"></b></a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr style=";padding:3px;border-spacing:5px 5px 5px 5px;">
                <td colspan="5" style="padding:3px;border-spacing:5px 5px 5px 5px;border-bottom-color:black;">     <table id="dg1" title="Kegiatan S P D" style="width:870px;height:600px;" >  
         </table>  </td>
            </tr>                        
