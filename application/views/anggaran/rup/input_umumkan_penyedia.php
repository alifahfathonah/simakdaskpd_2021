...
<head>
    ...
    $(document).ready(function() {
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>index.php/sirup/sirup/loadPenyedia_pa',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        if (row.umumkan == 1 && row.is_final == 1){
          return 'color:#6217FA;';
        }else if (row.umumkan == 0 && row.is_final == 0){
          return 'color:red;';
        }
        ...
        onSelect:function(rowIndex,rowData){
		  ...
		  lcstatus		='edit';
		  get(idrup,id,dppk,tahun,kldi,nm_paket,kd_program,kd_kegiatan,nm_kegiatan,volume,uraian,spesifikasi,tkdn,uk,nuk,pradipa,total,mtd_pengadaan,pilih_awal,pilih_akhir,kerja_mulai,kerja_akhir,aktif,umumkan,id_swakelola,skpd,is_final,no_renja,izin_tahun_jamak,tanggal_kebutuhan,tanggal_kebutuhan_2,ket_final,username,nm_paket_gab,nm_program,is_revisi);
		},
    ...
    function get(idrup,id,dppk,tahun,kldi,nm_paket,kd_program,kd_kegiatan,nm_kegiatan,volume,uraian,spesifikasi,tkdn,uk,nuk,pradipa,total,mtd_pengadaan,pilih_awal,pilih_akhir,kerja_mulai,kerja_akhir,aktif,umumkan,id_swakelola,skpd,is_final,no_renja,izin_tahun_jamak,tanggal_kebutuhan,tanggal_kebutuhan_2,ket_final,username,nm_paket_gab,nm_program,is_revisi){
    ...
    function listdg_kegiatan(kdkeg){
       ...
       $(function(){ 
		$('#dg').edatagrid({
			url: '<?php echo base_url(); ?>index.php/sirup/sirup/loadPenyedia_pa_kegiatan',
    ...
    */
	...
	function validasi(){
		...
		var r = confirm("Apakah Sudah Yakin Akan Diumumkan Paket ini!");
		if (r == true) {
			
			var xurl = '<?php echo base_url(); ?>index.php/sirup/sirup/editPenyedia_umumkan'
			$(document).ready(function(){
				$.ajax({
					type: "POST",       
					dataType : 'json',         
					data: ({cskpd:skpd_,cid:id_,ctahun:ntahun_,cfinall:final_,cuser:username_}),  	
					url:xurl,
					success:function(data){
						pesan = data.pesan;
						if(pesan=='1'){
							alert("Berhasil Diumumkan");
                            keluar_app();
						}else{
							alert("Gagal Diumumkan");
						}
	...
	function validasi_batal(){
		...
		var xurl = '<?php echo base_url(); ?>index.php/sirup/sirup/editPenyedia_validasi_batal'
		$(document).ready(function(){
				$.ajax({
					type: "POST",       
					dataType : 'json',         
    ...
    function tambah(){
     ...
     function keluar_app(){
        var url = '<?php echo site_url(); ?>index.php/sirup/sirup/input_umumkan_penyedia';
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">UMUMKAN PAKET PENYEDIA OLEH PA/KPA</a></b></u></h3>
    <div>
    <p align="right">          
		...
		<a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cetak_item()">Lihat Dan Umumkan</a>                               
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
			...
			<tr>
				...
				<a class="easyui-linkbutton" id="vali" iconCls="icon-save" plain="true" onclick="javascript:validasi()">Umumkan Paket</a>
                &nbsp;
