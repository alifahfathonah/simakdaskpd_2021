...
<head>
     ...
     $('#dg').edatagrid({
        ...
        $('#nm_paket').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               $('#nm_paket_detail').combogrid({url:'<?php echo base_url(); ?>index.php/sirup/sirup/listRincianpaket',queryParams:({kd_keg:kd_giat,kd_rek:kd_rekk5,tahun:kd_tahun})});
    ...
    */
    ...
    function get_nourut(){
        ...
        function runBelanja(){
            alert("Tombol -> [Master] untuk menarik data Master Rekening Belanja, Jika tidak tersedia pada penganggaran.");
        }

        function runMaster(){
            kd_giat = '-';
            $('#nm_paket').combogrid({url:'<?php echo base_url(); ?>index.php/sirup/sirup/listRekening',queryParams:({kd_keg:kd_giat})});
            alert("Menarik data rekening belanja berhasil, silahkan pilih belanja.";
...
<h3 align="center"><u><b><a href="#" id="section1">PAKET PENYEDIA</a></b></u></h3>
    ...
    <p align="right">          
        ...
        <table id="dg" title="Listing Data Paket Penyedia" style="width:1036px;height:450px;" >  
        </table>
    </p> 
     ...
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <td><input type="text" id="nm_paket" style="width: 610px;" /> 
                    <a class="easyui-linkbutton" iconCls="icon-help" title="Info Input Manual Belanja" plain="true" onclick="javascript:runBelanja();"></a>
                    <a class="easyui-linkbutton" iconCls="icon-search" title="Manual Rekening Belanja" plain="true" onclick="javascript:runMaster();">Master</a>
                </td>                
            </tr>
			<tr>
                <td>Nama Paket</td>
