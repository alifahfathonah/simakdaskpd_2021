...
<head>   
  ...
  <script type="text/javascript">
     ...
     $(function(){ 
        $('#kode').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
            ...
            textField:'username',  
            mode:'remote',          
			//url:'<?php echo base_url(); ?>index.php/rka/user_cppkrup_all', 	
            columns:[[  
        ...
        $('#fstatus').combogrid({  
           ...
           textField:'dstatus',  
           mode:'remote',
           url:'<?php echo base_url(); ?>index.php/sirup/rka/load_status_cek_anggaran',  
           columns:[[  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               $(function(){ 
                $('#dg').edatagrid({
		            url: '<?php echo base_url(); ?>/index.php/sirup/rka/load_cek_anggaran_sirup_ppkom',
    ...
    if(cek_username==''){
        ...
        url="<?php echo site_url(); ?>index.php/sirup/rka/preview_cetakan_cek_anggaran_sirup/"+cek_kd_kegiatan+'/'+status_ang+'/'+cek_username+'/Report-cek-anggaran-RUP'
         
        window.open(url,'_blank');  
        
    }

    function lihat_detail_ang(){
      var rows = $('#dg').datagrid('getSelections'); 
      ...
      var idskpd = $('#kode').combogrid('getValue'); 
     ...
     var cstatus = $('#fstatus').combogrid('getValue');
      ...
      exit();
       ...
       url="<?php echo site_url(); ?>index.php/sirup/rka/rka_dppa/"+idskpd+'/'+cek_kd_kegiatan+'/'+cstatus+'/Report-cek-anggaran-skpd'
...
<h3 align="center"><u><b><a>CEK NILAI ANGGARAN DAN SIRUP</a></b></u></h3>
    ...
    <table style="width:400px;" border="0">
        ...
        |&nbsp;&nbsp; 
				...
				<!--|&nbsp;&nbsp; 
        <a class="easyui-linkbutton" iconCls="icon-print" plain="true" title="Pilih/Klik List Data Kegiatan" onclick="javascript:lihat_detail_ang();">Lihat Detail Anggaran</a>
        -->
        </td>
        </tr> 
