      ...
      function kunci_inputan(){
        ...
        function get_nilai_kua()
        {
            ...
            $.ajax({
                ...
                url:'<?php echo base_url(); ?>index.php/sirup/rka_n1/load_nilai_kua_rancang/'+kdskpd,
        ...
        function cek_transaksi(){
            ...
            $.ajax({
               ...
               url       : '<?php echo base_url(); ?>/index.php/sirup/rka_n1/cek_transaksi',
               type      : 'POST',
               dataType  : 'json',
        ...
        function validate_combo(){
            ...
            $(function(){
            $('#dg').edatagrid({
                 url: '<?php echo base_url(); ?>index.php/sirup/rka_n1/select_rka_rancang/'+cgiat+'/'+cskpd,
                 idField     : 'id',
                 toolbar     : "#toolbar",              
                 rownumbers  : "true", 
                 fitColumns  : "true",
        ...
        function hapus(){
                ...
                if  (del==true){
                    ...
                    $(function(){
                        $('#dg').edatagrid({
                             url: '<?php echo base_url(); ?>/index.php/sirup/rka_n1/thapus_rancang/'+cskpd+'/'+cgiat+'/'+rek,
                             idField:'id',
                             toolbar:"#toolbar",              
                             rownumbers:"true", 
                             fitColumns:"true",
                ...
                if ( cfm == true ){
                    ...
                    $(document).ready(function(){
                        $.ajax({
                               ...
                               url      : '<?php echo base_url(); ?>index.php/sirup/rka_n1/hapus_rincian_dpo',
                               success  : function(data){
                                            kosong();
                                            get_nilai_kua();
                                            get_nilai_kua_rek(); 
...
/*==========untuk update apabila rincian tidak diisi*/
        ...
        if ( rows.length == 0 ) { 
            ...
            $.ajax({
                    ...
                    url      : '<?php echo base_url(); ?>index.php/sirup/rka_n1/thapus_rinci_ar_all_rancang',
                    success  : function(data){
...
/*end ==========untuk update apabila rincian tidak diisi*/       
        ...
        for(var i=0;i<rows.length;i++){     
            ...
            if ( i > 0 ) {
                csql = csql+","+"('"+no+"','"+cheader+"','"+cskpd+"','"+cgiat+"','"+ckode+"','"+ckode_brg+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume2+"','"+csatuan2+"','"+cvolume2+"','"+csatuan2+"','"+cvolume3+"','"+csatuan3+"','"+cvolume3+"','"+csatuan3+"','"+cvolume+"','"+cvolume+"','"+cvolume1+"','"+cvolume2+"','"+cvolume3+"','"+cvolume+"','"+csatuan1+"','"+csatuan2+"','"+csatuan3+"','"+charga1+"','"+ctotal+"')";
            } else {
                csql = "values('"+no+"','"+cheader+"','"+cskpd+"','"+cgiat+"','"+ckode+"','"+ckode_brg+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume1+"','"+csatuan1+"','"+charga1+"','"+ctotal+"','"+cvolume2+"','"+csatuan2+"','"+cvolume2+"','"+csatuan2+"','"+cvolume3+"','"+csatuan3+"','"+cvolume3+"','"+csatuan3+"','"+cvolume+"','"+cvolume+"','"+cvolume1+"','"+cvolume2+"','"+cvolume3+"','"+cvolume+"','"+csatuan1+"','"+csatuan2+"','"+csatuan3+"','"+charga1+"','"+ctotal+"')";                                            
        ...
        $(document).ready(function(){
                $.ajax({
                    ...
                    url      : '<?php echo base_url(); ?>/index.php/sirup/rka_n1/tsimpan_rinci_jk_rancang',
                    success  : function(data) {
                        status = data.pesan;
                        if (status == '1') {
                            $("save1").show();
    ...
    /*id,header,no_po,kode,kd_barang,uraian,volume1,satuan1,volume2,satuan2,volume3,satuan3,volume,harga1,total */                         
        ...
        function section(kdrek){
           ...
           if ( mgiat=='' ){
            ...
            $(document).ready(function(){
                ...
                $(function(){
                    $('#dg1').edatagrid({
                         url          : '<?php echo base_url(); ?>/index.php/sirup/rka_n1/rka_rinci_rancang/'+mskpd+'/'+mgiat+'/'+kdrek,
                         idField      : 'id',
                         toolbar      : "#toolbar1",              
                         rownumbers   : "true", 
                         fitColumns   : false,
       ...
       function section_lokasi(kdrek){
            ...
            $(document).ready(function(){
                ...
                $(function(){
                    $('#dg1').edatagrid({
                         url          : '<?php echo base_url(); ?>/index.php/sirup/rka_n1/rka_rinci_rancang/'+mskpd+'/'+mgiat+'/'+kdrek+'/'+lokasi,
                         idField      : 'id',
                         toolbar      : "#toolbar1",              
                         rownumbers   : "true", 
                         fitColumns   : false,
    ...
    function load_sum_rek(){   /*total nilai satu kegiatan*/             
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,keg:b}),
            url:"<?php echo base_url(); ?>index.php/sirup/rka_n1/load_sum_rek_rancang",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
    ...
    function load_sum_rek_rinci(c){     /* rincian rekening trdpo*/          
        ...
        $(function(){      
         $.ajax({
            ...
            url:"<?php echo base_url(); ?>index.php/sirup/rka_n1/load_sum_rek_rinci_rancang",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
    ...
    function tambah(){
        ...
        $.ajax({
           ...
           data     : ({kd_skpd:skpd,kd_kegiatan:kegi,kd_rek5:reke,nilai:nrek,dana1:sdana1,dana2:sdana2,dana3:sdana3,dana4:sdana4,
                        vdana1:ndana1,vdana2:ndana2,vdana3:ndana3,vdana4:ndana4}),
           url      : '<?php echo base_url(); ?>index.php/sirup/rka_n1/tsimpan_ar_rancang',
           success  : function(data){
                      st12 = data;
                      if ( st12 == '1' ){
                        $("#proses").hide();
    ...
    function simpan_det_keg(){
        ...
        $(function(){      
         $.ajax({
            ...
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/sirup/rka_n1/simpan_det_keg_rancang",
            success:function(data){ 
                    alert('Data Tersimpan');
                    }
         });
    ...
    function load_detail_keg(){  /*untuk menampilkan Indikator*/            
        ...
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,keg:b}),
            url:"<?php echo base_url(); ?>index.php/sirup/rka_n1/load_det_keg_rancang",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
...
/*==================  */    
                 ...
                 $.ajax({
                    ...
                    data: ({
                        ...
                        nsumber3:nsumber3}),
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/sirup/rka_n1/simpan_rincian_dpo",
                    success:function(data){
                        alert('Data Tersimpan');
                        //$("#loading").dialog('close');
                        section(crek);
                ...
                $(function(){      
                 $.ajax({
                    ...
                    data: ({
                        ...
                        sdana1:sdana1}),
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/sirup/rka_n1/update_rincian_dpo",
                    success:function(data){ 
                        $("#dg1").datagrid("reload");
                        section(crek);
                        $("#loading").dialog('close');
        ...
        var sskpd = $('#sskpd').combogrid('getValue'); 
               $(function(){      
                 $.ajax({
                    ...
                    dataType:"json",
                    url:"<?php echo base_url(); ?>index.php/anggaran_murnix/save_lokasi",
                    success:function(data){
            ...
            if(cek=='edit'){
                $(function(){      
                     $.ajax({
                        ...
                        dataType:"json",
                        url:"<?php echo base_url(); ?>index.php/anggaran_murnix/edit_lokasi",
                        success:function(data){
                ...
                $(function(){      
                     $.ajax({
                        ...
                        dataType:"json",
                        url:"<?php echo base_url(); ?>index.php/anggaran_murnix/hapus_lokasi",
                        success:function(data){
...
<h3><a href="#" id="section2" >Rincian Rekening</a></h3>
    ...
    <div >
        ...
        <td style="border-style: hidden;">
            ...
            <button style="background-color: red; border: 1px solid black; padding: 3px; cursor:pointer; color: #ffffff" id="del1" class="easyui-linkbutton" hidden iconCls="icon-remove" plain="true" onclick="javascript:hapus_rinci();"><b>Hapus</button>
...
<div id="dialog-modal-edit" title="Edit Rincian Rekening">
    ...
    <table border='0' style="width:800px;">
        ...
        <button hidden id="pil_edit";class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:pilih_edit();">Simpan</button> &nbsp; &nbsp; &nbsp;
