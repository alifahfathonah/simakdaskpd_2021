...
<head>
    ...
    $(document).ready(function() {
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/sirup/sirup/loadSwakelola_pa',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onSelect:function(rowIndex,rowData){
		  ...
		  lcstatus		='edit';
		  get(idrup,id,user,namappk,idppk,tahun,kldi,nm_paket,kd_program,kd_kegiatan,nm_kegiatan,lokasi,nm_lokasi,det_lokasi,jns_pengadaan,volume,uraian,spesifikasi,tkdn,uk,pradipa,total,mtd_pengadaan,pilih_awal,pilih_akhir,kerja_mulai,kerja_akhir,aktif,umumkan,id_swakelola,skpd,is_final,tipeswa,nama_satker_lain,ket_final,username,nm_program);
		},
    ...
    function get(idrup,id,user,namappk,idppk,tahun,kldi,nm_paket,kd_program,kd_kegiatan,nm_kegiatan,lokasi,nm_lokasi,det_lokasi,jns_pengadaan,volume,uraian,spesifikasi,tkdn,uk,pradipa,total,mtd_pengadaan,pilih_awal,pilih_akhir,kerja_mulai,kerja_akhir,aktif,umumkan,id_swakelola,skpd,is_final,tipeswa,nama_satker_lain,ket_final,username,nm_program){	
    ...
    function cetak_item(){
        ...
        var skpd = dskpd;
        var id = did;
        var user = document.getElementById('nm_username').value;
    ...
    var username_   = document.getElementById('nm_username').value;
		...
		var xurl = '<?php echo base_url(); ?>/index.php/sirup/sirup/editSwakelola_umumkan'
		$(document).ready(function(){
				$.ajax({
					type: "POST",       
					dataType : 'json',         
    ...
    function tambah(){
     ...
     function keluar_app(){
        var url = '<?php echo site_url(); ?>/sirup/sirup/input_umumkan_swakelola';
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">UMUMKAN PAKET SWAKELOLA OLEH PA/KPA</a></b></u></h3>
    <div>
    <p align="right">          
        ...
        <a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cetak_item()">Lihat dan Validasi</a>                               
         | &nbsp;                      
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
				...
				<a class="easyui-linkbutton" id="vali" iconCls="icon-save" plain="true" onclick="javascript:validasi()">Umumkan</a>
				&nbsp;
