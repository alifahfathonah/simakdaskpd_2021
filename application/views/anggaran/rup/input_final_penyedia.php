...
<head>
    ...
    */
	...
	function validasi(){
        ...
        var cek_rek=kd_rek_cek.length;
        //alert(cek_rek);
        if(cek_rek!=12){
            alert('Paket/Mak Tidak Lengkap, Silahkan Hapus dan Buat Ulang Paket');
            exit();
        }    


		var xurl = '<?php echo base_url(); ?>index.php/sirup/sirup/editPenyedia_validasi'
		$(document).ready(function(){
				$.ajax({
					type: "POST",       
					dataType : 'json',         
    ...
    function tambah(){
     ...
     function keluar_app(){
        var url = '<?php echo site_url(); ?>index.php/sirup/sirup/input_final_penyedia';
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">FINALISASI DRAF PENYEDIA OLEH PPKOM</a></b></u></h3>
    <div>
    <p align="right">          
