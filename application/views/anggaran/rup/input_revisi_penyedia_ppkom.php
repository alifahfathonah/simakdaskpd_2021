...
<head>
    ...
    $(document).ready(function() {
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>index.php/sirup/sirup/loadPenyedia_revisi',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onSelect:function(rowIndex,rowData){
		  idrup			= rowData.idrup;
          idrup_lama    = rowData.idrup_lama;	
          alasan_revisi = rowData.alasan_revisi;   
          dppk          = rowData.ppk;          
          dskpd         = rowData.skpd;
          did           = rowData.id; 
		  id   			= rowData.id;
		  ...
		  lcstatus		='edit';
		  get(idrup,id,dppk,tahun,kldi,nm_paket,kd_program,kd_kegiatan,nm_kegiatan,volume,uraian,spesifikasi,tkdn,uk,nuk,pradipa,total,mtd_pengadaan,pilih_awal,pilih_akhir,kerja_mulai,kerja_akhir,aktif,umumkan,id_swakelola,skpd,is_final,no_renja,izin_tahun_jamak,tanggal_kebutuhan,tanggal_kebutuhan_2,ket_final,username,nm_paket_gab,idrup_lama,alasan_revisi);
		},
        ...
        $('#tm_idrup_lama').combogrid({  
           panelWidth:760,  
           idField:'idrup',  
           textField:'idrup',  
           mode:'remote',
           url:'<?php echo base_url(); ?>index.php/sirup/sirup/idrup_lama',  
           columns:[[  
               {field:'idrup',title:'IDRUP',width:60},
               {field:'nm_paket_gab',title:'Nama Paket',width:390},
               {field:'tkd_kegiatan',title:'Kegiatan',width:60},
               {field:'total',title:'Total',width:120},   
               {field:'ket_revisi',title:'Revisi',width:110} 
           ]],  
           onSelect:function(rowIndex,rowData){
                id_rup_lama = rowData.idrup;

                $("#tm_nmrup_lama").attr("value",rowData.alasan_revisi);
          idrup         = 0;      
          dppk          = rowData.ppk;          
          dskpd         = rowData.skpd;
          did           = rowData.id; 
          ...
          username      = rowData.username;
          lcstatus      ='tambah';
          get(idrup,id,dppk,tahun,kldi,nm_paket,kd_program,kd_kegiatan,nm_kegiatan,volume,uraian,spesifikasi,tkdn,uk,nuk,pradipa,total,mtd_pengadaan,pilih_awal,pilih_akhir,kerja_mulai,kerja_akhir,aktif,umumkan,id_swakelola,skpd,is_final,no_renja,izin_tahun_jamak,tanggal_kebutuhan,tanggal_kebutuhan_2,ket_final,username,nm_paket_gab,idrup_lama);
          edit_data_revisi();  
          get_nourut();
               }  
        });
        ...
        $('#nm_paket').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               $('#nm_paket_detail').combogrid({url:'<?php echo base_url(); ?>index.php/sirup/sirup/listRincianpaket',queryParams:({kd_keg:kd_giat,kd_rek:kd_rekk5,idrup_lama:id_rup_lama,tahun:kd_tahun})});
	...
	function getGiat(){
	 var skpd = $('#skpd').combogrid('getValue');
        //alert(skpd);
     $('#kd_kegiatan').combogrid({url:'<?php echo base_url(); ?>index.php/sirup/sirup/listKegiatan',queryParams:({skpd:skpd,tahun:kd_tahun})});  
     $('#homekd_kegiatan').combogrid({url:'<?php echo base_url(); ?>index.php/sirup/sirup/listKegiatan',queryParams:({skpd:skpd,tahun:kd_tahun})});
     } 
	 ...
	 function listdg_kegiatan(kdkeg){
		...
		$(function(){ 
		$('#dg').edatagrid({
			url: '<?php echo base_url(); ?>index.php/sirup/sirup/loadPenyedia_kegiatan_revisi',
			queryParams:({cari:kriteria})
			});        
		});
	}
	
    function get(idrup,id,dppk,tahun,kldi,nm_paket,kd_program,kd_kegiatan,nm_kegiatan,volume,uraian,spesifikasi,tkdn,uk,nuk,pradipa,total,mtd_pengadaan,pilih_awal,pilih_akhir,kerja_mulai,kerja_akhir,aktif,umumkan,id_swakelola,skpd,is_final,no_renja,izin_tahun_jamak,tanggal_kebutuhan,tanggal_kebutuhan_2,ket_final,username,nm_paket_gab,idrup_lama,alasan_revisi){
        ...
        $("#idrup_lama").attr("value",idrup_lama);
        $("#tm_alasan_revisi").attr("value",alasan_revisi);
    ...
    function simpan(){
        ...
        var idruplama_      = $("#tm_idrup_lama").combogrid("getValue");
        ...
        if(idruplama_==''){
            alert('IDRUP Lama Belum di Pilih');
            exit();
        }
        ...
        if(lcstatus=='tambah'){
            var xurl = '<?php echo base_url(); ?>index.php/sirup/sirup/simpanPenyedia_revisi'
        }else{
            var xurl = '<?php echo base_url(); ?>index.php/sirup/sirup/editPenyedia_srevisi';
        }
			...
			$(document).ready(function(){
				$.ajax({
					...
					data: ({cskpd:skpd_,ctahun:ntahun_,cpaket:nm_paket_,ckdgiat:kd_kegiatan_,ckdprog:kd_program_,clok:lokasi_,cdetlok:det_lokasi_, 	
							...
							cumum:umumkan_,cnmgiat:nm_kegiatan_,cid:id_,cdet:csql,cfinall:final_,cidppk:idppk,cjamak:jamak_,crenja:renja_,cdet_lok:csql_lok,cidruplama:idruplama_}),  	
					url:xurl,
					success:function(data){
						pesan = data.pesan;
						if(pesan=='1'){
    ...
    */
    ...
    function get_nourut(){
        ...
        function runTambahpaket(){
            alert("Tambah Paket ini Digunakan untuk Memecah Paket dari 1 Sub Rincian Objek, Digunakan dalam keadaan/kondisi tertentu dan mengikuti aturan yang berlaku.");
        }
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">PAKET REVISI PENYEDIA</a></b></u></h3>
    <div>
    <p align="right">          
        ...
        <table id="dg" title="Listing Data Paket Penyedia" style="width:1000px;height:450px;" >  
        </table>
    </p> 
	</div>
</div>
...
<div id="dialog-modal" title="">
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                <td>ID RUP SEBELUMNYA</td>
                <td></td>
                <td><input id="tm_idrup_lama" name="tm_idrup_lama" style="width: 170px;" type="text" /> <input type="text" id="tm_nmrup_lama" style="border:0;width: 300px;" readonly="true"/>
                </td>                            
            </tr>
            <tr>
                <td>PPKOM / USER</td>
			...
			<tr>
                ...
                <td><input type="hidden" id="kd_paket_detail" style="width: 170px;"/>       
					...
					<input type="checkbox" id="paket_kecuali" onclick="javascript:runEffect_1();"/> &nbsp; Tambah Paket
                    <a class="easyui-linkbutton" iconCls="icon-help" title="Info Tambah Paket Manual" plain="true" onclick="javascript:runTambahpaket();"></a>
                </td>                
            </tr>
			<tr>
				<td colspan="3">
...
<div id="dialog-modal-lihat" title="">
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                <td><b>ID RUP SEBELUMNYA</b></td>
                <td></td>
                <td><input id="idrup_lama" name="idrup_lama" style="width: 170px;border:0; font-weight: bold;" type="text" /> <input id="tm_alasan_revisi" name="tm_alasan_revisi" style="width: 300px;border:0; font-weight: bold;" type="text" />
                </td>                            
            </tr>
			<tr>
                <td><b>ID RUP</b></td>
