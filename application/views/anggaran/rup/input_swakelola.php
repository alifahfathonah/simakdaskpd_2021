...
<head>
    ...
    $(document).ready(function() {
     ...
     $('#dg').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){
          ...
          lcstatus		='edit';
		  get(idrup,id,user,namappk,idppk,tahun,kldi,nm_paket,kd_program,kd_kegiatan,nm_kegiatan,lokasi,nm_lokasi,det_lokasi,jns_pengadaan,volume,uraian,spesifikasi,tkdn,uk,pradipa,total,mtd_pengadaan,pilih_awal,pilih_akhir,kerja_mulai,kerja_akhir,aktif,umumkan,id_swakelola,skpd,is_final,tipeswa,nama_satker_lain,username,nm_program);
		},
       ...
       $('#dgsd_lokasi').datagrid({
		...
		$('#kd_kegiatan').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               $('#nm_paket_detail').combogrid({url:'<?php echo base_url(); ?>index.php/sirup/sirup/listRincianpaket_swakelola',queryParams:({kd_keg:kd_giat,skpd:kd_skpd_c})});
        ...
        $('#tipeswakelola').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               //if(cektipeswa!='Tipe Swakelola 1'){
               //     $("#skpd_swakelola").attr("value",'');  
               //}
        ...
        $('#nm_paket_detail').combogrid({  
           ...
           columns:[[  
               ...
               {field:'nm_dpaket',title:'Detail Paket',width:470},
               {field:'total_ubah',title:'Sisa',width:150, align:"right"}    
           ]],  
           onSelect:function(rowIndex,rowData){
               $("#nsumber").attr("value",rowData.sumber);
    ...
    function get(idrup,id,user,namappk,idppk,tahun,kldi,nm_paket,kd_program,kd_kegiatan,nm_kegiatan,lokasi,nm_lokasi,det_lokasi,jns_pengadaan,volume,uraian,spesifikasi,tkdn,uk,pradipa,total,mtd_pengadaan,pilih_awal,pilih_akhir,kerja_mulai,kerja_akhir,aktif,umumkan,id_swakelola,skpd,is_final,tipeswa,nama_satker_lain,username,nm_program){	
        
		if(is_final==1 && umumkan==0){
			hasil_final = 'STATUS PAKET : SUDAH DI FINALISASI OLEH PPKOM';
			$('#vhapus').linkbutton('disable');
			$('#vedit').linkbutton('disable');
		}else if(is_final==0 && umumkan==0){
        ...
        $("#skpd_swakelola").attr("value",nama_satker_lain);
        $("#tm_tipeswakelola").combogrid("setValue",tipeswa);
        $("#tm_skpd_swakelola").attr("value",nama_satker_lain);
    ...
    function simpan(){
        ...
        var skpdswa_ 		= document.getElementById('skpd_swakelola').value;
        ...
        if (tipeswa_!=1){
            if(skpdswa_==''){
                alert('Instansi/Ormas/Kelmas tidak boleh kosong, anda memilih Tipe Swakelola : '+tipeswa_);
                exit();
            }
        }
    ...
    function tambah(){
     ...
     function keluar_app(){
        var url = '<?php echo site_url(); ?>rup_swakelola';
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">PAKET SWAKELOLA</a></b></u></h3>
    <div>
    <p align="right">          
        <a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:tambah()">Tambah</a>               
        <a id="vhapus" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:hapus();">Hapus</a>
        <a id="vedit" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="javascript:edit_data();">Edit</a>        
        ...
        <table id="dg" title="Listing Data Paket Swakelola" style="width:1000px;height:450px;" >  
        </table>
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <td></td>
                <td><input type="text" id="tipeswakelola" style="width: 170px;" />
                <input type="text" id="ketswakelola" style="width: 400px; border:none;" />  </td>                
            </tr> 
            <tr>
                <td>KLPD/Ormas/Pokmas</td>
                <td></td>
                <td><input type="text" placeholder="Silahkan Diisi (Instansi/Ormas/Kelmas Lainnya) Selain Pilih Tipe Swakelola 1" id="skpd_swakelola" name="skpd_swakelola" style="width: 500px;" /><br/>
				        <!--<font color="red">*) Pilih Selain Tipe Swakelola 1 (di kerjakan oleh Instansi lain)</font>-->
                </td>                            
            </tr>
			<tr>
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
			...
			<tr>
                <td>Tipe Swakelola</td>
                <td>:</td>
                <td><input type="text" id="tm_tipeswakelola" style="width: 170px;" />
                <input type="text" id="tm_ketswakelola" style="width: 300px; border:none;" />  </td>                
            </tr> 
            <tr>
                <td>LPKD/Ormas/Pokmas</td>
                <td>:</td>
                <td><input id="tm_skpd_swakelola" name="skpd_swakelola" style="width: 500px; border:none;" readonly="true" />
				</td>                            
            </tr>
            ...
            <tr hidden="true">
             ...
             <tr>
                ...
                <td>:</td>
                <td><input type="text" id="tm_kerja_awal" style="width: 140px; border:none;" /> s/d <input type="text" id="tm_kerja_akhir" style="width: 140px; border:none;" /> </td>                
            </tr> 
            <tr>
