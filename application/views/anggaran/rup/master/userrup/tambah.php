...
<div id="content">
	<h1><?php echo $page_title; ?><span><a href="<?php echo site_url(); ?>/master/user_rup">Kembali</a></span></h1>

	<?php echo form_open('master/tambah_user_rup', array('class' => 'basic')); ?>
    <table class="form">
       <!-- <tr>
