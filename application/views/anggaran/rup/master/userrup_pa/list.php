<div id="content">
    	<h1><?php echo $page_title; ?> PPK
        <span><a href="<?php echo site_url(); ?>/master/tambah_user_rup_pa">Tambah</a></span>
        </h1>
        ...
        <table class="narrow">
            ...
            <tr>
                ...
                <td>
                &nbsp;&nbsp;
				<a href="<?php echo site_url(); ?>/master/hapus_user_rup_pa/<?php echo $user->id_user; ?>" title="Hapus"><img src="<?php echo base_url(); ?>assets/images/icon/cross.png" /></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
