...
<head>   
  ...
  <script type="text/javascript">
    ...
    function lihat_detail(){        
        ...
        url="<?php echo site_url(); ?>/rka/preview_cetakan_cek_anggaran_sirup/"+cek_kd_kegiatan+'/'+status_ang+'/Report-cek-anggaran-RUP'
 ...
 function openWindow( url,$jns ){
  ...
  function carilah(){
   ...
   function cetak_item(){
      ...
      if(jnsrup==1){
      var url = '<?php echo site_url(); ?>/sirup/sirup/cetak_listpenyedia_rup/'+idrup+'/PAKET PENYEDIA';
            }else{
      var url = '<?php echo site_url(); ?>/sirup/sirup/cetak_listswakelola_rup/'+idrup+'/PAKET SWAKELOLA';
            }
            window.open(url, '_blank');
            window.focus();            
...
<div id="content"> 
<h3 align="center"><u><b><a>CEK LIST PAKET RUP</a></b></u></h3>
    <div align="center">
    <p align="center">     
    <table style="width:400px;" border="0">
        ...
        <!--&nbsp;&nbsp;|&nbsp;&nbsp; 
				<a class="easyui-linkbutton" iconCls="icon-print" plain="true" title="Pilih/Klik List Data Kegiatan" onclick="javascript:lihat_detail();">Lihat Detail Kegiatan</a>
				-->
				</td>
        </tr> 
