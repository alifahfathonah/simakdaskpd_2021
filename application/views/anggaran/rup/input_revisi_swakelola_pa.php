...
<head>
    ...
    $(document).ready(function() {
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/sirup/sirup/loadSwakelola_pa_revisi',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onSelect:function(rowIndex,rowData){
          ...
          lcstatus		= 'edit';
		  get(idrup,id,user,namappk,idppk,tahun,kldi,nm_paket,kd_program,kd_kegiatan,nm_kegiatan,lokasi,nm_lokasi,det_lokasi,jns_pengadaan,volume,uraian,spesifikasi,tkdn,uk,pradipa,total,mtd_pengadaan,pilih_awal,pilih_akhir,kerja_mulai,kerja_akhir,aktif,umumkan,id_swakelola,skpd,is_final,tipeswa,nama_satker_lain,ket_final,username,nm_program,is_revisi,revisi_alasan,revisi_init);
		},
       ...
       $('#dgsd_lokasi').datagrid({
        ...
        $('#tm_tipe_alasan').combogrid({  
           ...
           textField:'tipe',  
           mode:'remote',
           url:'<?php echo base_url(); ?>index.php/sirup/sirup/tipe_revisi_swakelola',  
           columns:[[
    ...
    function get(idrup,id,user,namappk,idppk,tahun,kldi,nm_paket,kd_program,kd_kegiatan,nm_kegiatan,lokasi,nm_lokasi,det_lokasi,jns_pengadaan,volume,uraian,spesifikasi,tkdn,uk,pradipa,total,mtd_pengadaan,pilih_awal,pilih_akhir,kerja_mulai,kerja_akhir,aktif,umumkan,id_swakelola,skpd,is_final,tipeswa,nama_satker_lain,ket_final,username,nm_program,is_revisi,revisi_alasan,revisi_init){	
    ...
    var id_ 			= document.getElementById('tm_idrup').value;
        ...
        var jenis_          = "SWAKELOLA";
        
		var r = confirm("Apakah Sudah Yakin Akan Direvisi Paket ini!");
		if (r == true) {
		
		var xurl = '<?php echo base_url(); ?>/index.php/sirup/sirup/editSwakelola_revisi'
		$(document).ready(function(){
				$.ajax({
					type: "POST",       
					dataType : 'json',         
	...
	function validasi_batal(){
		...
		var r = confirm("Apakah Sudah Yakin Akan Dibatal Revisi Paket ini!");
		if (r == true) {
		
		var xurl = '<?php echo base_url(); ?>/index.php/sirup/sirup/editSwakelola_revisi_batal'
		$(document).ready(function(){
				$.ajax({
					type: "POST",       
					dataType : 'json',         
    ...
    function tambah(){
     ...
     function keluar_app(){
        var url = '<?php echo site_url(); ?>/sirup/sirup/input_revisi_swakelola';
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">REVISI SWAKELOLA OLEH PA</a></b></u></h3>
    <div>
    <p align="right">          
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
			...
			<tr>
                <td><b>ID RUP<b></td>
                <td></td>
                <td><input id="tm_idrup" name="tm_idrup" style="width: 250px; border:none; font-weight:bold;" type="text" />
                    <input type="hidden" id="nm_username" style="width: 300px; border:none;" readonly="true"/></td>                            
            </tr> 
			<tr>
            ...
            <tr>
                ...
                &nbsp;
				<a class="easyui-linkbutton" id="valibtl" iconCls="icon-save" plain="true" onclick="javascript:validasi_batal()">Batalkan Revisi</a>
				&nbsp;
