...
<head>
     ...
     $('#dg').edatagrid({
		...
		$('#kd_kegiatan').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               kd_giat = rowData.kd_kegiatan;
               kd_skpd_c = rowData.kode_lokasi;
               $("#nilai_totalkeg").attr("value",rowData.nilai); 
               $("#nilai_totalsirup").attr("value",rowData.nilai_sirup);

               if(kode_tahun==2021){
                   $('#nm_paket').combogrid({url:'<?php echo base_url(); ?>index.php/sirup/sirup/listRekening',queryParams:({kd_keg:kd_giat,skpd:kd_skpd_c})});
                              
               }else{
                   $('#nm_paket').combogrid({url:'<?php echo base_url(); ?>index.php/sirup/sirup/listRekening_mYears',queryParams:({kd_keg:kd_giat,skpd:kd_skpd_c})});
        ...
        $('#nm_paket').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               kd_skpd_c = rowData.kd_lokasi;  
               
               if(kode_tahun==2021){
               $('#nm_paket_detail').combogrid({url:'<?php echo base_url(); ?>index.php/sirup/sirup/listRincianpaket',queryParams:({kd_keg:kd_giat,kd_rek:kd_rekk5,tahun:kd_tahun,skpd:kd_skpd_c})});
               }else{
               $('#nm_paket_detail').combogrid({url:'<?php echo base_url(); ?>index.php/sirup/sirup/listRincianpaket_mYears',queryParams:({kd_keg:kd_giat,kd_rek:kd_rekk5,tahun:kd_tahun,skpd:kd_skpd_c})});
               }             
           }
        });
    ...
    function simpan(){
		...
		var lokasi_ 		= kd_skpd_c;//$('#lokasi').combogrid('getValues');
    ...
    */
    ...
    function tambah(){
     ...
     function keluar_app(){
        var url = '<?php echo site_url(); ?>index.php/sirup/sirup/input_penyedia_myears';
    ...
    function get_nourut(){
        ...
        */
        ...
        function tambah_rek(){
            ...
            csumb = document.getElementById("nsumber").value;
            cpagu = document.getElementById("npagu").value;
            cpagu_sisa = document.getElementById("npagu_sisa").value;
            dpagu = angka(document.getElementById("npagu").value);
            dpagu_sisa = angka(document.getElementById("npagu_sisa").value);
            hpagu = angka(document.getElementById('total_pagu').value); 
            hpagu_total = angka(document.getElementById('total_pagu_myears').value);
            hjns_peng = $('#jns_pengadaan').combogrid('getValue');
            hnmjns_peng = document.getElementById('nmjns_pengadaan').value;
            huser = document.getElementById('userppk').value;
            ctotalkeg = document.getElementById("nilai_totalkeg").value;
            dtotalkeg = angka(document.getElementById("nilai_totalkeg").value);
            dtotalsrp = angka(document.getElementById("nilai_totalsirup").value);           
            gvol = 0;
            ...
            /*if(hpagu>dpagu_sisa){
                alert('Isi Paket Melebihi Aturan Inputan Paket Rincian Sisa = '+cpagu_sisa);
                exit();
            }*/
            
            /*if(hpagu>dpagu){
                alert('Isi Paket Melebihi Aturan Inputan Paket Rincian = '+cpagu);
                exit();
            }
            
            if(hpagu>ctotal_paket_myears){
                alert('Isi Paket Melebihi Aturan Inputan MultiYears, Nilai Total Belanja = '+ctotal_paket_myears);
                exit();
            }
            ...
            if(ntotal_sirup>dtotalkeg){
                alert('Isi Paket Melebihi Aturan Inputan Kegiatan ='+ctotalkeg);
                exit();
            }*/
        ...
        function runTambahpaket(){
            alert("Tambah Paket ini Digunakan untuk Memecah Paket dari 1 Sub Paket Belanja, Digunakan dalam keadaan/kondisi tertentu dan mengikuti aturan yang berlaku.");
        }
		
        function runSubpaket(){
            alert("Kode ( 0 ) adalah Total Sub Paket Belanja, Digunakan apabila 1 paket bernilai ( = ) sama dengan Rekening Belanja.");
        }
		
        function runBelanja(){
            alert("Tambah Master ini digunakan untuk menarik data master rekening belanja, jika tidak tersedia di penganggaran.");
        }

        function runMaster(){
            var kd_giat = '-';
            var nilai = '3000000000000';
            $("#nilai_totalkeg").attr("value",number_format(nilai,2));
            $('#nm_paket').combogrid({url:'<?php echo base_url(); ?>index.php/sirup/sirup/listRekening_master',queryParams:({kd_keg:kd_giat})});               
            alert("Penarikkan Tambah Master Berhasil, silahkan pilih rekening belanja.");
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">PAKET MULTIYEARS PENYEDIA</a></b></u></h3>
    <div>
    <p align="right">          
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                <td>Belanja</td>
                <td></td>
                <td><input type="text" id="nm_paket" style="width: 610px;" />
                    <!--<a class="easyui-linkbutton" iconCls="icon-help" title="Info Penarikkan Master" plain="true" onclick="javascript:runBelanja();"></a>
                    <a class="easyui-linkbutton" iconCls="icon-search" title="Tambah Penarikkan Master" plain="true" onclick="javascript:runMaster();">Master</a>
                    -->
                </td>                
            </tr>
			<tr>
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
        ...
        <tr>
            <td>Pagu</td>
            <td></td>
            <td><input type="text" id="npagu" name="npagu" style="width: 150px; align:right;" readonly="true"/>
                <input type="text" id="npagu_sisa" name="npagu_sisa" style="width: 150px; align:right;" readonly="true"/></td>                
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
