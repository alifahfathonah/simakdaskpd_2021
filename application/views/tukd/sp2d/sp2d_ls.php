...
<head>
    ...
    $(function(){		
            $('#nospm').combogrid({  
                panelWidth:500,  
                url: '<?php echo base_url(); ?>/index.php/tukd/nospm_ls',  
                    idField:'no_spm',                    
                    textField:'no_spm',
                    mode:'remote',  
                    fitColumns:true,  
  ...
  $('#bank1').combogrid({  
	...
	function jumlah_anggaran(kd_skpd){           
        $(function(){      
         $.ajax({
            type: 'POST',
            url:"<?php echo base_url(); ?>index.php/tukd/load_sisa_anggaran/"+kd_skpd,
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
                    $("#anggaran").attr("value",n['nilai']);
	...
	function jumlah_sp2d(kd_skpd){           
        $(function(){      
         $.ajax({
            type: 'POST',
            url:"<?php echo base_url(); ?>index.php/tukd/load_sisa_sp2d/"+kd_skpd,
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
                    $("#non_gaji").attr("value",n['nilai']);
                   // $("#rekspm1").attr("value",n['rekspm1']);
                });
            }
         });
		...
		//$("#dd").datebox("setValue",'2017-12-29');
 ...
 function simpan_sp2d(){        
        ...
        var tot_anggaran = angka(document.getElementById('anggaran').value);
        var tot_sp2d = angka(document.getElementById('non_gaji').value);

		var m = angka(total);
		var sisa_ang=tot_anggaran-tot_sp2d-m;	

      $('#dg').datagrid('selectAll');
            var rows = $('#dg').datagrid('getSelections');           
			for(var p=0;p<rows.length;p++){
			ckdkegiatan  = rows[p].kdkegiatan;
			}
		kodekegiatan=(ckdkegiatan.trim()).substr(16.5);
        alert("SISA ANGGARAN SETELAH SP2D= "+sisa_ang)
		if((sisa_ang<0) && (kodekegiatan!='00.51')){
			alert("Total SP2D Belanja Langsung Akan melebihi Anggaran. SP2D Tidak Tersimpan!");
			return;
		}			
...
<table border='1' style="font-size:11px" >
 ...
 <tr style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td width='53%' style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">&nbsp;<input id="cc" name="dept" style="width: 190px;" value=" Pilih Jenis Beban" readonly="true" disabled></td>
   <td width='8%' style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">&nbsp;</td>
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td width='8%'  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">Anggaran</td>
   <td width='31%' style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><input type="text" name="anggaran" id="anggaran"  readonly="true" align="right" style="width:200px;" /></td>
 </tr>
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   <td width='8%'  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"></td>
   <td width='53%' style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"></td>
   <td width='8%'  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">SP2D Non Gaji</td>
   <td width='31%' style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><input type="text" name="non_gaji" id="non_gaji"  readonly="true" align="right" style="width:200px" /></td>
 </tr>
  <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">&nbsp;</td>
   <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">&nbsp;</td>
