...
<head>
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>easyui/jquery.edatagrid.js"></script>
    ...
    $('#dg1').edatagrid({  
		    ...
		    {field:'daknf',title:'DAK NON FISIK',width:100,align:'right'},
    ...
    $('#dg2').edatagrid({		                
        ...
        $('#dg3').edatagrid({  
            ...
            nowrap:"true",                                                  
            columns:[[
                {field:'sumber',title:'Sumber Dana',hidden:"true"},
        ...
        $('#giat').combogrid({  
           ...
           mode:'remote',
           url:'<?php echo base_url(); ?>index.php/tukd2/load_trskpd_koreksi',
           ...
           onSelect:function(rowIndex,rowData){
               ...
               $("#sp2d").combogrid({url:'<?php echo base_url(); ?>index.php/tukd2/load_sp2d_koreksi',queryParams:({jenis:jnsbeban,giat:giat,kd:kode,bukti:nomor})});
		...
		$('#giat_koreksi').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               idxGiat = rowIndex;               
               giat_koreksi = rowData.kd_kegiatan;
               var jnsbeban = document.getElementById('beban').value;
               var nomor = document.getElementById('nomor').value;
               var kode = document.getElementById('skpd').value;//$('#skpd').combogrid('getValue');
               $("#nmgiat_koreksi").attr("value",rowData.nm_kegiatan);
               $("#sp2d_koreksi").combogrid({url:'<?php echo base_url(); ?>index.php/tukd2/load_sp2d_koreksi',queryParams:({jenis:jnsbeban,giat:giat_koreksi,kd:kode,bukti:nomor})});
               sdana1kosong();
               sdana2kosong();
               sdana3kosong();
        ...
        $('#sp2d').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
             ...
             // $('#sisasp2d').attr('value',number_format(sisa,2,'.',','));
              ...
              $('#rek').combogrid({url:'<?php echo base_url(); ?>index.php/tukd2/load_rek_koreksi2',
		  ...
		  $('#sp2d_koreksi').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
              ...
              //var tglsp2d = rowData.tgl_sp2d;              
              var nobukti = document.getElementById('nomor').value;
			  var nobkuk = document.getElementById('nobkuk').value;
             // var tglbukti = document.getElementById('tanggal').value;
              var jnsbeban = document.getElementById('beban').value;                                  
              //var sisa = angka(rowData.sisa);              
              //alert(nosp2d+'/'+nilsp2d+'/'+tglsp2d+'/'+nobukti+'/'+jnsbeban+'/'+sisa);
             ...
             // $('#sisasp2d').attr('value',number_format(sisa,2,'.',','));
              $('#dg1').edatagrid('unselectAll');                              
              $('#rek_koreksi').combogrid({url:'<?php echo base_url(); ?>index.php/tukd2/load_rek_koreksi3',
                                   queryParams:({sp2d:nosp2d,
                                                 no:nobukti,
                                                 jenis:jnsbeban,
                                                 giat:giat,
                                                 kd:kode,
                                                 rek:frek,nobkuk:nobkuk})
                                   });
			 //load_sisa_bank();
			 //load_sisa_tunai();
			 //load_sisa_pot_ls();
        ...
        $('#rek').combogrid({  
           ...
           mode:'remote',                                   
           columns:[[  
               {field:'no_bku',title:'No BKU',width:50,align:'center'},  
           ...
           onSelect:function(rowIndex,rowData){
				...
				$('#nobkuk').attr('value',rowData.no_bku);
    ...
    function loadsumber(rek_koreksi,kd_giat){
        ...
        $("#sdana1").combogrid({
            ...
            onSelect :function(rowIndex,rowData){
                ...
                $('#sdana1_sempurna').attr('value',rowData.anggaran_semp);
                $('#sdana1_ubah').attr('value',rowData.anggaran_ubah);
        ...
        $("#sdana3").combogrid({
            ...
            onSelect :function(rowIndex,rowData){
                selectRow = rowData.sumber;  
                jdl = '#sdana3_real';
                $('#sdana3_susun').attr('value',rowData.anggaran);
                $('#sdana3_sempurna').attr('value',rowData.anggaran_semp);
                $('#sdana3_ubah').attr('value',rowData.anggaran_ubah);
                load_total_sdana(kd_giat,rek_koreksi,selectRow,jdl);
            }                            
        });   
	...
	$('#rek_koreksi').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
                $('#nmrek_koreksi').attr('value',rowData.nm_rek5);
    ...
    function load_total_sdana(giat,kode_rek,sumber,jdl){
		...
		$(function(){      
         $.ajax({
            ...
            dataType:"json",
			data: ({giat:giat,kode:kode,sumber:sumber,kode_rek:kode_rek,nobkuk:nobkuk}),
    ...
    function sdana3kosong(){
        $("#sdana3").combogrid("clear");
        var sdana3 = $('#sdana3').combogrid('grid');    
        sdana3.datagrid('loadData', []);                        
    }
    ...
    function get_skpd()
        {
        	...
        	$.ajax({
        		...
        		success:function(data){
        								...
        								kode = data.kd_skpd;
                                        statu = data.statu;
                                        status_sempurna = data.status_sempurna;
                                        status_ubah = data.status_ubah;
                                        if(status_ubah==1){
                                            $("#txtstatus").attr("value",'Perubahan');    
                                        }else if(status_sempurna==1){
                                            $("#txtstatus").attr("value",'Penyempurnaan');
                                        }else if(statu==1){
                                            $("#txtstatus").attr("value",'Penyusunan');
                                        }
    ...
    function kegia(){
     ...
     $('#giat').combogrid({url:'<?php echo base_url(); ?>index.php/tukd2/load_trskpd_koreksi',queryParams:({kd:kode,jenis:jns1})});  
     $('#giat_koreksi').combogrid({url:'<?php echo base_url(); ?>index.php/tukd/load_trskpd',queryParams:({kd:kode,jenis:jns1})});  
    }     
           ...
           $(document).ready(function(){
            $.ajax({
                ...
                success:function(data){                                          
                    ...
                    $('#dg1').edatagrid('appendRow',{no_bukti:no,no_sp2d:nosp2d,kd_kegiatan:giat,nm_kegiatan:nmgiat,kd_rek5:rek5,nm_rek5:nmrek5,
                    nilai:nil,lalu:clalu,pad:nil_pad,dak:nil_dak,daknf:nil_daknf,dau:nil_dau,dbhp:nil_dbhp,did:nil_did,sp2d:csp2d,anggaran:canggaran});                                                                                                                                                                                                                                                                                                                                                                                             
                    });                                                                           
                }
            });
           });                
           ...
           $(document).ready(function(){
            $.ajax({
                ...
                success:function(data){                                          
                    ...
                    canggaran = number_format(n['anggaran'],2,'.',',');                                                                                      
                    $('#dg1').edatagrid('appendRow',{no_bukti:no,no_sp2d:nosp2d,kd_kegiatan:giat,nm_kegiatan:nmgiat,kd_rek5:rek5,nm_rek5:nmrek5,
                    nilai:nil,pad:nil_pad,dak:nil_dak,daknf:nil_daknf,dau:nil_dau,dbhp:nil_dbhp,did:nil_did,lalu:clalu,sp2d:csp2d,anggaran:canggaran});                                                                                                                                                                                                                                                                                                                                                                                             
                    });                                                                           
                }
            });
           });                
    ...
    function load_detail2(){        
       ...
       if (rows.length==0){
		...
		for(var p=0;p<rows.length;p++){
            ...
            $('#dg2').edatagrid('appendRow',{no_bukti:no,no_sp2d:nosp2d,kd_kegiatan:giat,nm_kegiatan:nmgiat,kd_rek5:rek5,nm_rek5:nmrek5,nilai:nil,
                                            pad:nil_pad,dak:nil_dak,daknf:nil_daknf,dau:nil_dau,dbhp:nil_dbhp,did:nil_did,lalu:lal,sp2d:csp2d,anggaran:canggaran});            
        }
        $('#dg1').edatagrid('unselectAll');
    } 
...
//            });
	...
	function append_save_koreksi(){
        ...
        var rek_koreksi     = $('#rek_koreksi').combogrid('getValue');
		var jenis       = document.getElementById('beban').value;
        ...
        var ang_semp = angka(document.getElementById('ang_semp').value);
        ...
        var sdana2_susun = angka(document.getElementById('sdana2_susun').value);
        var sdana3_susun = angka(document.getElementById('sdana3_susun').value);
        var sdana1_semp  = angka(document.getElementById('sdana1_sempurna').value);
        var sdana2_semp  = angka(document.getElementById('sdana2_sempurna').value);
        var sdana3_semp  = angka(document.getElementById('sdana3_sempurna').value);
        var sdana1_ubah  = angka(document.getElementById('sdana1_ubah').value);
        var sdana2_ubah  = angka(document.getElementById('sdana2_ubah').value);
        var sdana3_ubah  = angka(document.getElementById('sdana3_ubah').value);
        var sdana1_trans  = angka(document.getElementById('sdana1_trans').value);
        var sdana2_trans  = angka(document.getElementById('sdana2_trans').value);
        var sdana3_trans  = angka(document.getElementById('sdana3_trans').value);
        var sdana1_real  = angka(document.getElementById('sdana1_real').value);
        var sdana2_real  = angka(document.getElementById('sdana2_real').value);
        var sdana3_real  = angka(document.getElementById('sdana3_real').value);
        var vsdana1 = $('#sdana1').combogrid('getValue').trim();
        var vsdana2 = $('#sdana2').combogrid('getValue').trim();
        var vsdana3 = $('#sdana3').combogrid('getValue').trim();
        var nil_pad=0;var nil_dak=0;var nil_daknf=0;var nil_dau=0;var nil_dbhp=0;var nil_did=0;
        ...
        if(vsdana2!=''){
            var ceksumber2 = cek_sumber(vsdana2);
            if(ceksumber2==0){
                swal("Error", "Nama Sumber Dana Ke-2 tidak ada. Cek lagi.", "error");
                return;
            }
        }        

        if(vsdana3!=''){
            var ceksumber3 = cek_sumber(vsdana3);
            if(ceksumber3==0){
                alert('Nama Sumber Dana Ke-3 tidak ada. Cek lagi.');
                return;
            }
        }        
       ...
       if (rek_koreksi==''){
        ...
        if(vsdana2=='' && sdana2_trans>0){
            swal("Error", "Sumber Dana Ke-2 tidak boleh kosong jika Nilai dibawahnya tidak bernilai 0", "error");
            return;
        }


        if(vsdana3=='' && sdana3_trans>0){
            swal("Error", "Sumber Dana Ke-3 tidak boleh kosong jika Nilai dibawahnya tidak bernilai 0", "error");
            return;
        }
        
        
        
        if(vsdana1==vsdana2 || vsdana1==vsdana3){
            swal("Error", "Sumber Dana yg sama hanya boleh dipilih sekali.", "error");
            return;            
        }
        ...
        var sisa_ang = ang - (lalu+nilai_rek_koreksi);
        var sisa_ang_semp = ang_semp - (lalu+nilai_rek_koreksi);
        var sisa_ang_ubah = ang_ubah - (lalu+nilai_rek_koreksi);
        
        if(vstatus=='Penyusunan'){
            //----------------------------------------Penyusunan--------------------------------------------------------
            var sisa1_susun = sdana1_susun - (sdana1_trans+sdana1_real);
            var sisa1_semp  = sdana1_semp - (sdana1_trans+sdana1_real);
            var sisa1_ubah  = sdana1_ubah - (sdana1_trans+sdana1_real);
            if(sisa1_susun<0){
                swal("Error", "Nilai "+vsdana1+" Melebihi Sisa Sumber Dana Penyusunan!!!, Cek Lagi...!!!", "error");
                return;
            }else if(sisa1_semp<0){                
                swal("Error", "Nilai "+vsdana1+" Melebihi Sisa Sumber Dana Penyempurnaan!!!, Cek Lagi...!!!", "error");
                return;
            }else if(sisa1_ubah<0){
                swal("Error", "Nilai "+vsdana1+" Melebihi Sisa Sumber Dana Perubahan!!!, Cek Lagi...!!!", "error");
                return;                
            }
            
            if(vsdana2!=''){
                var sisa2_susun = sdana2_susun - (sdana2_trans+sdana2_real);
                var sisa2_semp  = sdana2_semp - (sdana2_trans+sdana2_real);
                var sisa2_ubah  = sdana2_ubah - (sdana2_trans+sdana2_real);
                if(sisa2_susun<0){
                    swal("Error", "Nilai "+vsdana2+" Melebihi Sisa Sumber Dana Penyusunan!!!, Cek Lagi...!!!", "error");
                    return;
                }else if(sisa2_semp<0){                
                    swal("Error", "Nilai "+vsdana2+" Melebihi Sisa Sumber Dana Penyempurnaan!!!, Cek Lagi...!!!", "error");
                    return;
                }else if(sisa2_ubah<0){
                    swal("Error", "Nilai "+vsdana2+" Melebihi Sisa Sumber Dana Perubahan!!!, Cek Lagi...!!!", "error");
                    return;                
                }                
            }                

            if(vsdana3!=''){
                var sisa3_susun = sdana3_susun - (sdana3_trans+sdana3_real);
                var sisa3_semp  = sdana3_semp - (sdana3_trans+sdana3_real);
                var sisa3_ubah  = sdana3_ubah - (sdana3_trans+sdana3_real);
                if(sisa3_susun<0){
                    swal("Error", "Nilai "+vsdana3+" Melebihi Sisa Sumber Dana Penyusunan!!!, Cek Lagi...!!!", "error");
                    return;
                }else if(sisa3_semp<0){                
                    swal("Error", "Nilai "+vsdana3+" Melebihi Sisa Sumber Dana Penyempurnaan!!!, Cek Lagi...!!!", "error");
                    return;
                }else if(sisa3_ubah<0){
                    swal("Error", "Nilai "+vsdana3+" Melebihi Sisa Sumber Dana Perubahan!!!, Cek Lagi...!!!", "error");
                    return;                
                }                
            } 
            ...
            if(sisa_ang<0){
                    swal("Error", "Nilai Transaksi Melebihi Anggaran Penyusunan!!!, Cek Lagi...!!!", "error");
                    return;                                
            }else if(sisa_ang_semp<0){
                    swal("Error", "Nilai Transaksi Melebihi Anggaran Penyempurnaan!!!, Cek Lagi...!!!", "error");
                    return;                                                
            }else if(sisa_ang_ubah<0){
                    swal("Error", "Nilai Transaksi Melebihi Anggaran Perubahan!!!, Cek Lagi...!!!", "error");
                    return;                                                                
            }
            //-------------------------------------------------end Penyusunan----------------------------------------------------               
        ...
        rsumber1 = nmsdana(vsdana1);
        switch(rsumber1){
            case 'pad':
                nil_pad = sdana1_trans;
                break;
            case 'dak fisik':
                nil_dak = sdana1_trans;
                break;
            case 'dak non fisik':
                nil_daknf = sdana1_trans;
                break;
            case 'dau':
                nil_dau = sdana1_trans;
                break;
            case 'dbhp':
                nil_dbhp = sdana1_trans;
                break;
            case 'did':
                nil_did = sdana1_trans;
        }   
        
        if(vsdana2!=''){    
            rsumber2 = nmsdana(vsdana2);
            switch(rsumber2){
                case 'pad':
                    nil_pad = sdana2_trans;
                    break;
                case 'dak fisik':
                    nil_dak = sdana2_trans;
                    break;
                case 'dak non fisik':
                    nil_daknf = sdana2_trans;
                    break;
                case 'dau':
                    nil_dau = sdana2_trans;
                    break;
                case 'dbhp':
                    nil_dbhp = sdana2_trans;
                    break;
                case 'did':
                    nil_did = sdana2_trans;
            }              
        }

        if(vsdana3!=''){ 
            rsumber3 = nmsdana(vsdana3);
            switch(rsumber3){
                case 'pad':
                    nil_pad = sdana3_trans;
                    break;
                case 'dak fisik':
                    nil_dak = sdana3_trans;
                    break;
                case 'dak non fisik':
                    nil_daknf = sdana3_trans;
                    break;
                case 'dau':
                    nil_dau = sdana3_trans;
                    break;
                case 'dbhp':
                    nil_dbhp = sdana3_trans;
                    break;
                case 'did':
                    nil_did = sdana3_trans;
            }              
        }
       
                $('#dg1').edatagrid('appendRow',{no_bukti:no,
                                                 no_sp2d:nosp2d_koreksi,
                                                 kd_kegiatan:giat_koreksi,
                                                 nm_kegiatan:nmgiat_koreksi,
                                                 kd_rek5:rek_koreksi,
                                                 nm_rek5:nmrek_koreksi,
                                                 nilai:nil_koreksi,
                                                 pad:number_format(nil_pad,2,'.',','),
                                                 dak:number_format(nil_dak,2,'.',','),
                                                 daknf:number_format(nil_daknf,2,'.',','),
                                                 dau:number_format(nil_dau,2,'.',','),
                                                 dbhp:number_format(nil_dbhp,2,'.',','),
                                                 did:number_format(nil_did,2,'.',','),
                                                 lalu:0,
                                                 sp2d:0,
                                                 anggaran:0});
                $('#dg2').edatagrid('appendRow',{no_bukti:no,
    ...
    function simpan_transout(){
		...
		*/
		...
		if (ctot_det == 0){
			alert('Nilai Koreksi Harus ada sisa');
			exit();
		}
		*/
        ...
        $(document).ready(function(){
            $.ajax({
                type: "POST",       
                dataType : 'json',         
                data: ({tabel:'trhtransout',no:cno,tgl:ctgl,nokas:cno,tglkas:ctgl,ctgl_koreksi:ctgl_koreksi,skpd:cskpd,nmskpd:cnmskpd,beban:cjenis,ket:cket,status:cstatus,notagih:ctagih,tgltagih:ctgltagih,total:ctotal,cpay:cjenis_bayar,nokas_pot:cnokaspot}),
                url: '<?php echo base_url(); ?>/index.php/tukd2/simpan_transout_koreksi2',
                success:function(data){
                    status = data.pesan;                                                               
                }
            });
        ...
        if (status !='0'){            
			...
			for(var p=0;p<rows.length;p++){
                ...
                csql =  csql+","+"('"+cnobukti+"','"+cnosp2d+"','"+ckdgiat+"','"+cnmgiat+"','"+crek+"','"+cnmrek+"','"+cnilai+"','"+cskpd+"',"+
                        "'"+cnil_pad+"','"+cnil_dak+"','"+cnil_daknf+"','"+cnil_dau+"','"+cnil_dbhp+"','"+cnil_did+"')";
                } else {
...
//---------
		...
		$(document).ready(function(){
            $.ajax({
                type: "POST",       
                dataType : 'json',         
                data: ({tabel:'trhtransout',no:cno,tgl:ctgl,nokas:cno,tglkas:ctgl,ctgl_koreksi:ctgl_koreksi,skpd:cskpd,nmskpd:cnmskpd,beban:cjenis,ket:cket,status:cstatus,notagih:ctagih,tgltagih:ctgltagih,total:ctotal,cpay:cjenis_bayar,nokas_pot:cnokaspot,no_bku:no_simpan}),
                url: '<?php echo base_url(); ?>/index.php/tukd2/simpan_transout_koreksi2_edit',
                success:function(data){
                    status = data.pesan;                                                               
                }
            });
...
<h3><a href="#" id="section1" >List Koreksi Pembayaran</a></h3>
    ...
    <p align="right">  
        <a href="<?php echo site_url(); ?>/tukd2/cetak_jurnal_k2" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:input_lengkap(this.href);return false">Cetak</a>
        ...
        <table id="dg" title="List Koreksi Transaksi" style="width:870px;height:600px;" >  
        </table>                          
    </p> 
    </div>   
...
<h3><a href="#" id="section2">KOREKSI TRANSAKSI</a></h3>
   ...
   <p> <B>INPUTAN JURNAL KOREKSI HARUS MASUK DALAM LPJ / DI-LPJ-KAN AGAR NILAI BISA BERUBAH</b> </BR>      
   <div id="demo"></div>
        <table align="center" style="width:100%;">
            ...
            <tr>
                <td>No. Bukti</td>
                <td><input type="text" id="nomor" style="width: 200px;" maxlength="35" placeholder="Nomor muncul Otomatis"/></td>
                <td>&nbsp;&nbsp;</td>
                <td>Tanggal Bukti</td>
            ...
            <tr>
                ...
                <td><input type="text" id="tgl_koreksi" style="width:140px;"/></td>
           </tr>                       
            <tr>
                <td>S K P D</td>
            ...
            <tr>
				...
				<div class="tooltip easyui-linkbutton" iconCls="icon-help">
                    <span class="tooltiptext">Keterangan diisi dengan lengkap sekaligus perubahan nomimalnya</span>
                </div>
				</td>
                <td colspan="4"><textarea id="keterangan" style="width: 650px; height: 40px;"></textarea>
    ...
    <fieldset>
       ...
       <table border='0' style="font-size:11px"> 
           ...
           <tr>
                <td>Keterangan</td>
                <td>:</td>
                <td colspan='2'><input type="text" id="kete"   name="kete" style="width:400px;"/>
				</td>
           </tr>
           <tr>
...
<div id="dialog-modal" title="Input Kegiatan">
    ...
    <table>
		<tr>
            <td colspan="7">Pilih Transaksi Awal</td>
        </tr>   
        <tr>
            <td>Kode Kegiatan</td>
            <td>:</td>
        ...
        <tr>
         ...
         <tr>
            <td >Kode Rekening</td>
            <td>:</td>
            <td><input id="rek" name="rek" style="width: 200px;" /><input id="nobkuk" name="nobkuk" style="width: 200px;" hidden="true"/></td>
            <td >Nama Rekening</td>
            <td>:</td>
        ...
        <tr>
            ...
            <td>:</td>
            <td colspan="7">
                <input disabled="true" type="text" id="nilai" class="satu" style="text-align: right;" onkeypress="return(currencyFormat(this,',','.',event))" />
                <input readonly="true" type="text" id="nil_pad_a" class="satu" style="text-align: right;" hidden="true"/>
                <input readonly="true" type="text" id="nil_dak_a" class="satu" style="text-align: right;" hidden="true"/>
                <input readonly="true" type="text" id="nil_daknf_a" class="satu" style="text-align: right;" hidden="true"/>
                <input readonly="true" type="text" id="nil_dau_a" class="satu" style="text-align: right;" hidden="true"/>
                <input readonly="true" type="text" id="nil_dbhp_a" class="satu" style="text-align: right;" hidden="true"/>
                <input readonly="true" type="text" id="nil_did_a" class="satu" style="text-align: right;" hidden="true"/>
            </td>            
		...
		<tr>
            <td >&nbsp;</td>
            <td>&nbsp;</td>
            <td colspan="7"> <a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:append_save();">Tambah</a></td>            
        </tr>
    
		<tr>
            <td colspan="7">Pilih Transaksi Koreksi</td>
        </tr>   
		<tr>
            <td colspan="2">Status</td>
            <td ><input id="txtstatus" name="txtstatus" class="satu" readonly="true"/></td>
        </tr>   
        <tr>
            <td>Kode Kegiatan</td>
            <td>:</td>
            <td ><input id="giat_koreksi" name="giat_koreksi" style="width: 200px;" /></td>
            <td>Nama Kegiatan</td>
            <td>:</td>
            <td colspan="4"><input type="text" id="nmgiat_koreksi" readonly="true" style="border:0;width: 400px;"/></td>
        </tr>        
        <tr>
            <td>Nomor SP2D</td>
            <td>:</td>
            <td colspan="7" ><input id="sp2d_koreksi" name="sp2d_koreksi" style="width: 200px;" /></td>
        </tr>
         <tr>
            <td >Kode Rekening</td>
            <td>:</td>
            <td><input id="rek_koreksi" name="rek_koreksi" style="width: 200px;" /></td>
            <td >Nama Rekening</td>
            <td>:</td>
            <td colspan="4"><input type="text" id="nmrek_koreksi" readonly="true" style="border:0;width: 400px;"/></td>
        </tr> 
        <tr>
            <td >Sumber Dana</td>
            <td>:</td>
            <td><input id="sdana1" name="sdana1" style="width: 200px;" /></td>
            <td colspan="2"><input id="sdana2" name="sdana2" style="width: 200px;" /></td>
            <td><input id="sdana3" name="sdana3" style="width: 200px;" /></td>
        </tr>  
        
        <tr style="background-color:#ff4759">
            <td >D.Penyusunan</td>
            <td>:</td>
            <td><input type="text" id="sdana1_susun" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td>  
			<td colspan="2"><input type="text" id="sdana2_susun" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td> 
			<td><input type="text" id="sdana3_susun" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td>            
        </tr>

        <tr style="background-color:#ff4759">
            <td >D.Penyempurnaan</td>
            <td>:</td>
            <td><input type="text" id="sdana1_sempurna" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td>  
			<td colspan="2"><input type="text" id="sdana2_sempurna" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td> 
			<td><input type="text" id="sdana3_sempurna" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td>            
        </tr>

        <tr style="background-color:#ff4759">
            <td >D.Perubahan</td>
            <td>:</td>
            <td><input type="text" id="sdana1_ubah" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td>  
			<td colspan="2"><input type="text" id="sdana2_ubah" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td> 
			<td><input type="text" id="sdana3_ubah" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td>            
        </tr>
        <tr style="background-color:#ff4759">
            <td >D. Real</td>
            <td>:</td>
            <td><input type="text" id="sdana1_real" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td>  
			<td colspan="2"><input type="text" id="sdana2_real" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td> 
			<td><input type="text" id="sdana3_real" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td>            
        </tr>     
        <tr style="background-color:#00FF00">
            <td >Nilai</td>
            <td>:</td>
            <td><input type="text" id="sdana1_trans" value="0.00" style="text-align:right;border:0;" class="satu" onkeypress="return(currencyFormat(this,',','.',event))" onkeyup="javascript:hitung_nilai();"/></td>  
			<td colspan="2"><input type="text" value="0.00" id="sdana2_trans" style="text-align:right;border:0;" class="satu" onkeypress="return(currencyFormat(this,',','.',event))" onkeyup="javascript:hitung_nilai();"/></td> 
			<td><input type="text" id="sdana3_trans" value="0.00" style="text-align:right;border:0;" class="satu" onkeypress="return(currencyFormat(this,',','.',event))" onkeyup="javascript:hitung_nilai();"/></td>            
        </tr>
        <tr style="background-color:#00FFFF">
            <td >A.Penyusunan</td>
            <td>:</td>
            <td colspan="4"><input type="text" id="ang" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td>  
        </tr>
        <tr style="background-color:#00FFFF">
            <td >A.Penyempurnaan</td>
            <td>:</td>
            <td colspan="4"><input type="text" id="ang_semp" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td>          
        </tr>
        <tr style="background-color:#00FFFF">
            <td >A.Perubahan</td>
            <td>:</td>
            <td colspan="4"><input type="text" id="ang_ubah" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td>         
        </tr>
        <tr style="background-color:#00FFFF">
            <td >Realisasi</td>
            <td>:</td>
            <td colspan="4"><input type="text" id="lalu" value="0.00" style="text-align:right;border:0;" class="satu" disabled="true"/></td>         
        </tr>
         <tr>
            <td >Total</td>
            <td>:</td>
            <td colspan="7"><input type="text" id="nilai_koreksi" style="text-align: right;" onkeypress="return(currencyFormat(this,',','.',event))" class="satu" disabled="true" /></td>            
        </tr>
		<tr>
            <td >&nbsp;</td>
            <td>&nbsp;</td>
            <td colspan="7"> <a class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:append_save_koreksi();">Simpan</a></td>            
        </tr>
    ...
    <fieldset>
        <table align="right">           
            <tr>
                <td>Total</td>
                <td>:</td>
                <td><input type="text" id="total1" readonly="true" style="font-size: large;text-align: right;border:0;" class="satu" disabled="true" /></td>
            </tr>
        </table>
