    ...
    var cid   = 0;
     ...
     $(function(){ 
      $('#dg').edatagrid({
		...
		url: '<?php echo base_url(); ?>/index.php/tukd2/load_transout_koreksi',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
...
//       });              
		...
		$('#giat_koreksi').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               $("#sp2d_koreksi").combogrid({url:'<?php echo base_url(); ?>index.php/tukd2/load_sp2d_koreksi',queryParams:({jenis:jnsbeban,giat:giat,kd:kode,bukti:nomor})});
	           sp2dkoreksikosong();
               rekkoreksikosong();
               sdana1kosong();
               sdana2kosong();
        ...
        $('#sp2d').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
             ...
             // $('#sisasp2d').attr('value',number_format(sisa,2,'.',','));
              ...
              $('#rek').combogrid({url:'<?php echo base_url(); ?>index.php/tukd2/load_rek_koreksi',
		  ...
		  $('#sp2d_koreksi').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
             ...
             // $('#sisasp2d').attr('value',number_format(sisa,2,'.',','));
              $('#dg1').edatagrid('unselectAll');                              
              $('#rek_koreksi').combogrid({url:'<?php echo base_url(); ?>index.php/tukd/load_rek',
                                   queryParams:({sp2d:nosp2d,
                                                 no:nobukti,
                                                 jenis:jnsbeban,
                                                 giat:giat,
           ...
           $(document).ready(function(){
            $.ajax({
				...
				$.each(data,function(i,n){                                    
                    ...
                    nilai:nil,lalu:clalu,pad:nil_pad,dak:nil_dak,daknf:nil_daknf,dau:nil_dau,dbhp:nil_dbhp,did:nil_did,
                    sp2d:csp2d,anggaran:canggaran});                                                                                                                                                                                                                                                                                                                                                                                             
                    });                                                                           
                }
            });
           });                
           ...
           $(document).ready(function(){
            $.ajax({
                ...
                success:function(data){                                          
                    ...
                    $('#dg1').edatagrid('appendRow',{no_bukti:no,no_sp2d:nosp2d,kd_kegiatan:giat,nm_kegiatan:nmgiat,kd_rek5:rek5,nm_rek5:nmrek5,
                    nilai:nil,pad:nil_pad,dak:nil_dak,daknf:nil_daknf,dau:nil_dau,dbhp:nil_dbhp,did:nil_did,lalu:clalu,
                    sp2d:csp2d,anggaran:canggaran});                                                                                                                                                                                                                                                                                                                                                                                             
                    });                                                                           
                }
            });
		...
		*/
        ...
        $(document).ready(function(){
            $.ajax({
                ...
                url: '<?php echo base_url(); ?>/index.php/tukd2/simpan_transout_koreksi',
                success:function(data){
                    status = data.pesan;                                                               
                }
            });
...
//---------
		...
		$(document).ready(function(){
            $.ajax({
                ...
                url: '<?php echo base_url(); ?>/index.php/tukd2/simpan_transout_koreksi_edit',
                success:function(data){
                    status = data.pesan;                                                               
                }
            });
...
<h3><a href="#" id="section2">KOREKSI TRANSAKSI</a></h3>
   ...
   <div id="demo"> </div>
        <table align="center" style="width:100%;">
            ...
            <tr>
                <td>No. Bukti</td>
                <td><input type="text" id="nomor" style="width: 200px;" maxlength="35"/></td>
                <td>&nbsp;&nbsp;</td>
            ...
            <tr>
                <td>S K P D</td>
                <td><input id="skpd" name="skpd" style="width: 140px;" disabled="true"/></td>
                <td></td>
                <td>Nama SKPD :</td> 
    ...
    <table border='0'>
        ...
        <tr style="background-color:#00FFFF">
         ...
         <tr>
            <td >Total</td>
            <td>:</td>
            <td colspan="7"><input type="text" id="nilai_koreksi" value="0.00" style="text-align: right;" onkeypress="return(currencyFormat(this,',','.',event))" disabled="true" class="satu"/></td>            
        </tr>
		<tr>
            <td >&nbsp;</td>
            <td>&nbsp;</td>
