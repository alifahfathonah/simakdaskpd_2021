    ...
    <script type="text/javascript">
     ...
     $(document).ready(function() {
      ...
      $('#dg').edatagrid({
		...
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_list_belumpanjar_upload_cms',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        autoRowHeight:"false",
...
function cari(){
    ...
    $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_listpanjar_upload_cms',
...
function cari_upload(){
    ...
    $(function(){ 
     $('#dg3').edatagrid({
        url: '<?php echo base_url(); ?>index.php/tukd_cms/load_hdraf_upload_panjar',		
        queryParams:({cari:kriteria})
        });        
     });     
    }    	
...
function ctotal_upload(){
    ...
    $(function(){      
         $.ajax({
            type: 'POST',
            url:"<?php echo base_url(); ?>index.php/tukd_cms/load_total_upload_panjar/"+kriteria,                        
            dataType:"json",
        ...
        var init_nomor_up = nomor_uplhari;
            ...
            $(document).ready(function(){               
                $.ajax({
                    type: "POST",   
                    dataType : 'json',                 
                    data: ({tabel:'trdupload_cmsbank_panjar',no:nomor_upload,sql:csql,skpd:dskpd,total:total_2,urut_tglupload:init_nomor_up}),
                    url: '<?php echo base_url(); ?>/index.php/tukd_cms/simpan_uploadcms_panjar',
                    success:function(data){                        
                        status = data.pesan;   
                         if (status=='1'){               
...
function section_awal(){
        /*$(document).ready(function(){                
         ...
         bersih_list();*/
        urll ='<?php echo base_url(); ?>index.php/tukd_cms/upload_panjar';
...
function lihat_list(){
    ...
    $(function(){ 
     $('#dg2').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_draf_upload_panjar',
...
function proses_listcsv(){
    ...
    urll ='<?php echo base_url(); ?>index.php/tukd_cms/csv_cmsbank_panjar/'+nomor_upload;
...
<div id="content">    
<div id="accordion">
<h3><a href="#" id="section1" >UPLOAD - PEMBAYARAN PANJAR NON TUNAI</a></h3>
    <div>
    <p align="center">         
    <table width="100%">
            <tr>
...
<h3><a href="#" id="section2">DRAF ANTRIAN UPLOAD</a></h3>
   ...
   <table width="100%">
            ...
            <a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:section_awal();">Daftar Panjar</a>                                 
            </td>
        </tr>        
   </table>
...
<div id="dialog-modal-cekdata" title="Review Data Panjar">
    <fieldset>
        <table width="100%">
