    ...
    <script type="text/javascript">
     ...
     $(document).ready(function() {
      ...
      $('#dg').edatagrid({
		...
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_listsetor_belum_upload_cms',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        autoRowHeight:"false",
...
function cari(){
    ...
    $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_listsetor_upload_cms',
...
function cari_upload(){
    ...
    $(function(){ 
     $('#dg3').edatagrid({
        url: '<?php echo base_url(); ?>index.php/tukd_cms/load_hdraf_upload_bidang',		
        queryParams:({cari:kriteria})
        });        
     });     
    }    	
...
function ctotal_upload(){
    ...
    $(function(){      
         $.ajax({
            type: 'POST',
            url:"<?php echo base_url(); ?>index.php/tukd_cms/load_total_upload_bidang/"+kriteria,                        
            dataType:"json",
            success:function(data){ 
        ...
        var init_nomor_up = nomor_uplhari;
            ...
            $(document).ready(function(){               
                $.ajax({
                    ...
                    url: '<?php echo base_url(); ?>/index.php/tukd_cms/simpan_uploadcms_setorbidang',
                    success:function(data){                        
                        status = data.pesan;   
                         if (status=='1'){               
...
function section_awal(){
        /*$(document).ready(function(){                
         ...
         bersih_list();*/
        urll ='<?php echo base_url(); ?>index.php/tukd_cms/upload_setor_simpanan_bidang';
...
function lihat_list(){
    ...
    $(function(){ 
     $('#dg2').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_draf_upload_bidang',
...
function proses_listcsv(){
    ...
    urll ='<?php echo base_url(); ?>index.php/tukd_cms/csv_cmsbank_setorbidang/'+nomor_upload;
...
<h3><a href="#" id="section1" >UPLOAD - SETOR SIMPANAN NON TUNAI PERBIDANG</a></h3>
    ...
    <table width="100%">
        ...
        <table id="dg" title="List Data" style="width:1024px;height:390px;"  >  
        </table>
...
<h3><a href="#" id="section2">DRAF ANTRIAN UPLOAD</a></h3>
   ...
   <table id="dg3" title="List Data Upload" style="width:1024px;height:350px;"  >  
   </table>     
   <table width="100%" style="text-align: right;">
            <tr>
