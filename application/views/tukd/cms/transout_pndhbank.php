  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>easyui/jquery.edatagrid.js"></script>
    ...
    $('#dg2').edatagrid({		                
        ...
        $('#rekening_tujuan').combogrid({            
            url:"<?php echo base_url(); ?>index.php/cmsc/cari_rekening_tujuan/1",
            panelWidth:730,
            idField:'rekening',
            textField:'rekening',
            mode:'remote',
        ...
        $('#kd_bank_tujuan').combogrid({            
            url:"<?php echo base_url(); ?>index.php/cmsc/cari_bank",
            panelWidth:200,
            idField:'nama',
            textField:'nama',
            columns:[[
        ...
        $('#sp2d').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
              ...
              $('#rek').combogrid({url:'<?php echo base_url(); ?>index.php/cmsc/load_rek',
	...
	function load_total_trans(){
		...
		$(function(){      
         $.ajax({
            type: 'POST',
            url:"<?php echo base_url(); ?>index.php/pindah_bank/load_total_trans_bnk",
            dataType:"json",
...
<h3><a href="#" id="section2">TRANSAKSI PEMINDAHBUKUAN BANK</a></h3>
   ...
   <div id="demo"></div>
        <table align="center" style="width:100%;">
            ...
            <tr>
                <td>S K P D</td>
                <td><input id="skpd" class="input" name="skpd" style="width: 200px;" /></td>
                <td></td>
                <td>Nama :</td> 
            ...
            <tr>
                <td>USER BPP</td>
                <td><input id="kdbidang" class="input" name="kdbidang" style="width: 200px;" /></td>
                <td></td>
                <td>Nama :</td> 
