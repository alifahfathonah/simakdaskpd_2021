    ...
    <script type="text/javascript">
     ...
     $(document).ready(function() {
      ...
      $('#dg').edatagrid({
		...
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_liststsbelum_upload',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        autoRowHeight:"false",
        ...
        onSelect:function(rowIndex,rowData){                                                      
          skdvoucher    = rowData.no_sts; 
          stglvoucher   = rowData.tgl_sts;         
...
function cari(){
    ...
    $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_liststs_upload',
...
function ctotal_upload(){
    ...
    $(function(){      
         $.ajax({
            type: 'POST',
            url:"<?php echo base_url(); ?>index.php/tukd_cms/load_total_upload_sts/"+kriteria,                        
            dataType:"json",
...
function proses_list(){
    ...
    var rows = $('#dg').datagrid('getSelections');     
		      for(var p=0;p<rows.length;p++){ 
		            cno_sts   = rows[p].no_sts;
                    ctgl_sts  = rows[p].tgl_sts;
                    ...
                    $('#dg2').edatagrid('appendRow',{no_sts:cno_sts,tgl_sts:ctgl_sts,kd_skpd:cskpd,ket:cket,total:ctotal,viewtotal:cviewtotal,status_upload:cstt_upload,rekening_awal:crekening_awal,nm_rekening_tujuan:cnm_rekening_tujuan,rekening_tujuan:crekening_tujuan,bank_tujuan:cbank_tujuan,ket_tujuan:cket_tujuan});                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
              }    
     ...
     $('#proses').linkbutton('disable');                          
        ...
        var init_nomor_up = nomor_uplhari;
            ...
            for(var p=0;p<rows.length;p++){
                    ...
                    cno_voucher   = rows[p].no_sts;
                    ctgl_voucher  = rows[p].tgl_sts;
                    cskpd         = rows[p].kd_skpd;
                    cket          = rows[p].ket;                    
                    ctotal        = rows[p].total;                    
                    cstt_upload   = rows[p].status_upload;                   
            ...
            $(document).ready(function(){               
                $.ajax({
                    type: "POST",   
                    dataType : 'json',                 
                    data: ({tabel:'trdupload_sts_cmsbank',no:nomor_upload,sql:csql,skpd:dskpd,total:total_2,urut_tglupload:init_nomor_up}),
                    url: '<?php echo base_url(); ?>/index.php/tukd_cms/simpan_uploadcms_sts',
                    success:function(data){                        
                        status = data.pesan;   
                         if (status=='1'){               
                            alert('Data Berhasil diproses, Silahkan [Buat File .CSV]');		
...
function section_awal(){
        /*$(document).ready(function(){                
         ...
         bersih_list();*/
        urll ='<?php echo base_url(); ?>index.php/tukd_cms/sts_upload_cms';
...
function lihat_list(){
    ...
    $(function(){ 
     $('#dg2').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_draf_upload_sts',
...
function proses_listcsv(){
    ...
    urll ='<?php echo base_url(); ?>index.php/tukd_cms/csv_cmsbank_sts/'+nomor_upload;
...
<div id="content">    
<div id="accordion">
<h3><a href="#" id="section1" >UPLOAD - STS NON TUNAI</a></h3>
    <div>
    <p align="center">         
    <table width="100%">
            <tr>
        ...
        <table id="dg" title="List Data STS" style="width:860px;height:390px;"  >  
        </table>
...
<h3><a href="#" id="section2">DRAF ANTRIAN UPLOAD</a></h3>
   ...
   <table width="100%">
            ...
            <a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:section_awal();">Daftar STS</a>                                 
            </td>
        </tr>        
   </table>
...
<h3><a href="#" id="section3"></a></h3>
   ...
   <table width="100%">
            ...
            &nbsp; 
            <a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:cari_batalz();">Cari</a>
            </td>            
            <td align="right"><label><b>Aksi</b></label> :            
