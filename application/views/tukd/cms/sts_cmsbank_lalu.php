...
<head>
     ...
     $('#dg').edatagrid({
        ...
        $('#tanggal').datebox({  
            ...
            formatter :function(date){
                ...
                textField:'nip',  
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/tukd/load_ttd_pa',  
                columns:[[  
    ...
    function load_detail(kk){        
            ...
            $.ajax({
                ...
                success:function(data){                                   
                                ...
                                $('#dg1').datagrid('appendRow',{id:id,no_sts:lcnosts,no_terima:lcnoterima,kd_rek5:kdrek,nilai:lnrp,nm_rek:lcnmrek});
    ...
    function kosong(){
        ...
        $('#rek_sts').combogrid('setValue','');
        $('#rek_sts_rinci').combogrid('setValue','');
    ...
    function append_save(){        
            ...
            var ckdrek = $('#rek_sts').combogrid('getValue');
            var ckdrek6 = $('#rek_sts_rinci').combogrid('getValue');
            var lcno = document.getElementById('nomor').value;
            var lcnm = document.getElementById('nmrek_sts').value;
            var lcnl = angka(document.getElementById('nilai_rek').value);
            var lstotal = angka(document.getElementById('jumlahtotal').value);
            ...
            if (ckdrek != '' && lcnl != 0 ) {
                ...
                cid = cid + 1;            
                $('#dg1').datagrid('appendRow',{id:cid,no_sts:lcno,kd_rek5:ckdrek,nilai:lcnl1,no_terima:'',kd_rek6:ckdrek6});    
                $('#jumlahtotal').attr('value',total);    
                //rek_filter(); 
            }
...
<div id="content"> 
<div id="accordion">
<h3><a href="#" id="section1">LIST - STS NON TUNAI (PENYETORAN ATAS PENERIMAAN TAHUN LALU)</a></h3>
   ...
   <p>       
        <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <input type="text" name="nomor_tambahan" id="nomor_tambahan" style="width: 250px;" readonly="true"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td>Sub. Rekening</td>
                <td><input id="rek_sts_rinci" name="rek_sts_rinci" style="width: 200px;" /></td>
                <td><input type="text" id="nmrek_rinci" style="border:0;width: 450px;" readonly="true"/></td>                
            </tr> 
            <tr>
           <!-- <td colspan="4">Dengan Penetapan --><input id="jns_tetap" hidden type="checkbox"/></td>            
            ...
            <tr hidden="true" style="border-bottom-style:hidden;border-spacing:0px;padding:3px 3px 3px 3px;border-collapse:collapse;">
				<td width='20%'>No Terima</td>
			    <td width="80%"><input id="noterima" name="noterima" style="width:200px" /></td> 
			</tr>
            <tr>
                <td>Nilai</td>
                <td colspan="2"><input type="text" id="nilai_rek" style="text-align: right; width: 195px;" onkeypress="return(currencyFormat(this,',','.',event))"/>&nbsp;&nbsp;
