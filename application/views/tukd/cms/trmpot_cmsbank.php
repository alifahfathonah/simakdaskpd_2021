...
<head>
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>easyui/jquery.edatagrid.js"></script>
    ...
    $('#dg').edatagrid({
        ...
        url: '<?php echo base_url(); ?>/index.php/cmsc_trmpot/load_pot_in',
        idField: 'id',
        rownumbers: "true",
        fitColumns: "true",
        singleSelect: "true",
        ...
        columns: [
            [{
                ...
                formatter: function(value, rec) {
                    return '<img style="cursor:pointer" src="<?php echo base_url(); ?>/assets/images/icon/edit.bmp" ondblclick="javascript:section3();" />';
                }
            }, ]
        ],
        ...
        onDblClickRow: function(rowIndex, rowData) {
            ...
            detail_potongan();
            load_sum_pot();
            document.getElementById('psn').innerHTML = "Klik 2x di List Potongan untuk edit E-Billing";
        }
    });
    ...
    $('#no_voucher_tr').combogrid({
        ...
        mode: 'remote',
        url: '<?php echo base_url(); ?>index.php/cmsc_trmpot/load_trans_trmpot',
        columns: [
            [{
                    field: 'no_voucher',
                    title: 'No.',
    ...
    $('#npwp').combogrid({
        ...
        textField: 'npwp',
        mode: 'remote',
        url: '<?php echo base_url(); ?>index.php/cmsc_trmpot/config_npwp',
        columns: [
            [{
                    field: 'npwp',
                    title: 'NPWP',
    ...
    $('#rekanan').combogrid({
        panelWidth: 200,
        url: '<?php echo base_url(); ?>/index.php/cmsc_trmpot/perusahaan',
        idField: 'nmrekan',
        textField: 'nmrekan',
        mode: 'remote',
        fitColumns: true,
    ...
    $('#kd_rek_bank').combogrid({
        url: "<?php echo base_url(); ?>index.php/cmsc_trmpot/cari_rekening_tujuan/3",
        panelWidth: 370,
        idField: 'rekening',
        textField: 'rekening',
        columns: [
    ...
    $('#rekpajak').combogrid({
        ...
        textField: 'kd_rek5',
        mode: 'remote',
        url: '<?php echo base_url(); ?>index.php/cmsc_trmpot/rek_pot',
        columns: [
            [{
                field: 'kd_rek5',
                title: 'Kode Rekening',
   ...
   function detail_potongan() {
       $(function() {
           $('#dgpajak').edatagrid({
               url: '<?php echo base_url(); ?>/index.php/cmsc_trmpot/trdtrmpot_list/',
               queryParams: ({
                   nomor: bukti
               }),
               //idField       : 'idx',
               ...
               onDblClickRow: function(rowIndex, rowData) {
                   ...
                   $("#idx").attr("Value", rowData.id);
                   $("#ebilll").attr("Value", rowData.ebill);
    ...
    function perbaiki(){
        var ebilll= document.getElementById('ebilll').value;
        var idx= document.getElementById('idx').value;
        $('#dgpajak').datagrid('updateRow',{index:idx,row:{ ebill:ebilll}});
        $("#ebilll").attr("Value",'');
  ...
  function getpot(bukti, voucher, tgl, ket, npwp, kd_giat, no_sp2d, nm_giat, kd_rek, nm_rek, rekanan, dir, alamat, jns_spp, st, stu) {
      ...
      document.getElementById('beban').selectedIndex = jns_spp;
   ...
   function get_skpd() {
       ...
       $.ajax({
           ...
           success: function(data) {
               ...
               $("#iduser").attr("value", data.user_name);
           }
       });
   }
                            ...
                            if (status_cek == 0) {
                                ...
                                if (status != '0') {
                                    ...
                                    for (var q = 0; q < rows.length; q++) {
                                        ...
                                        cebil = rows[q].ebill;
                                        cid_user = "<?php echo $this->session->userdata('pcNama') ?>";

                                        if (q > 0) {
                                            csql = csql + "," + "('" + cnobukti + "','" + crek + "','" + cnmrek + "','" + cnilai + "','" + cskpd + "','" + crek_trans + "','" + cebil + "','" + cid_user + "')";
                                            csqljur = csqljur + "," + "('" + cnobukti + "','" + crek + "','" + cnmrek + "','0','" + cnilai + "','K','2','1')";

                                        } else {
                                            csql = "values('" + cnobukti + "','" + crek + "','" + cnmrek + "','" + cnilai + "','" + cskpd + "','" + crek_trans + "','" + cebil + "','" + cid_user + "')";
      ...
      //alert(nokas);
        $(function(){      
         $.ajax({
            type      : 'POST',
            data      : ({bukti:nokas}),
            url       : "<?php echo base_url(); ?>index.php/cmsc_trmpot/load_trm_pot",
            dataType  : "json",
            success   : function(data){ 
  ...
  function hapus(){
        ...
        var cno_voucher= $("#no_voucher_tr").combogrid("getValue") ;  
        var urll = '<?php echo base_url(); ?>index.php/cmsc_trmpot/hapus_trmpot';
...
<h3><a href="#" id="section1" >List Terima Potongan - Transaksi Non Tunai</a></h3>
    <div>
    <p align="right">  
        <button onclick="javascript:section3();kosong();datagrid_kosong();" class="button"><i class="fa fa-tambah"></i> Tambah</button>       
        <button onclick="javascript:cari();" class="button-abu"><i class="fa fa-cari"></i> Cari</button>              
        <input type="text" value="" class="input" style="display: inline;" id="txtcari"/>
        <table id="dg" title="List Terima Potongan" style="width:1024px;height:600px;" >  
        </table>                          
    </p> 
   ...
   <h3><a href="#" id="section3" >Potongan</a></h3>
     ...
     <tr>
        ...
        <td style="border-bottom: double 1px red;border-top: double 1px red;">&nbsp;&nbsp;<i>Tidak Perlu diisi atau di Edit</i></td>
         ...
         <tr>
                <td>No Terima</td>
                <td>:</td>
                <td><input type="text" id="nokas" class="input"  name="nokas" style="width:188px;" readonly="true"/>
          <input type="hidden" id="iduser"   name="iduser" style="width:200px;" />
        </td>
       ...
       <tr>
                <td>SKPD</td>
                <td>:</td>
                <td><input readonly="true" border="0" type="text" id="skpd" class="input"  name="skpd" style="width:188px;"/></td>
       ...
       <tr>
        ...
        <td>Beban &nbsp;&nbsp;&nbsp;&nbsp;:<select name="beban" id="beban" style="width:200px; display: inline;" class="select">
       ...
       <tr>
                ...
                <td>Pimpinan :  <input type="text" id="dir" class="input" name="dir" style="width:188px; display: inline;"/></td>
           </tr>
       
      <tr>
            <td>ALamat Perusahaan</td>
                <td>:</td><td colspan='2'><textarea  id="alamat" class="textarea" style="width:600px; height: 30px;" /></textarea></td>
           </tr>           
           <tr>
                <td>Keterangan</td>
                <td>:</td><td colspan='2'><textarea  id="kete" class="textarea" style="width:600px; height: 30px;" /></textarea></td>
           </tr>
           ...
           <td>No. e-Billing</td>
                <td>:</td><td colspan='2'><input type="text"  id="ebilling" name="ebilling" class="input" style="width:188px; display: inline;" />&nbsp; *) Per Pasal</td>
           </tr>
           <tr>
                <td align="left">Nilai</td>
                <td>:</td>
                <td><input type="text" id="nilairekpajak" name="nilairekpajak" class="input" style="width:188px;text-align:right;" onkeypress="return(currencyFormat(this,',','.',event))"/></td>
                <td></td>
           </tr>
           <tr>
             <td colspan="4" align="center" >
             <button id="pott" class="button" onclick="javascript:append_save_pot();"><i class="fa fa-tambah"></i> Tambah Potongan</button> 
      ...
      &nbsp;&nbsp; 
       <table border='0' style="font-size:11px;width:1024px;height:30px;"> 
           <tr>
                <td colspan="2" align="left" width='50%'>
    <button id="tambah" class="button-biru" onclick="javascript:simpan_potongan();"><i class="fa fa-simpan"></i> Simpan</button>
    ...
    <button  id="hapus" class="button-merah" onclick="javascript:hapus();kosong();datagrid_kosong();section1();"><i class="fa fa-hapus"></i> Hapus</button>   
       ...
       <table id="dgpajak" title="List Potongan" style="width:1024px;height:170px;">  
       </table>   
...
<div align="" id="dialog-modal-edit" title="Edit E-Billing">
    <table align="">

        <tr>
            <td>E-Billing</td>
            <td><input type="text" name="ebilll" id="ebilll" style="width: 250px"><input type="text" name="idx" id="idx" style="width: 250px" hidden> &nbsp;&nbsp;<button class="button-biru" onclick="javascript:perbaiki();">Perbaiki</button></td>
        </tr>
