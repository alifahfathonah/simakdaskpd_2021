...
<head>
  ...
  <script type="text/javascript">
    ...
    $(function() {
        $('#dg').edatagrid({
            ...
            url: '<?php echo base_url(); ?>/index.php/cmsc/load_transout',
            idField: 'id',
            rownumbers: "true",
            fitColumns: "true",
            singleSelect: "true",
        ...
        $('#dgpajak').edatagrid({
            url: '<?php echo base_url(); ?>/index.php/cmsc/pot',
            idField: 'id',
            //toolbar        : "#toolbar",              
            rownumbers: "true",
            fitColumns: false,
        ...
        $('#giat').combogrid({
            ...
            textField: 'kd_kegiatan',
            mode: 'remote',
            url: '<?php echo base_url(); ?>index.php/cmsc/load_trskpd_sub',
            queryParams: ({
                kd: kode,
                jenis: jenis
            }),
            ...
            onSelect: function(rowIndex, rowData) {
                ...
                $("#sp2d").combogrid({
                    url: '<?php echo base_url(); ?>index.php/cmsc/load_sp2d_transout',
                    queryParams: ({
                        jenis: jnsbeban,
                        giat: giat,
                        kd: kode,
        ...
        $('#sp2d').combogrid({
            ...
            onSelect: function(rowIndex, rowData) {
                ...
                $('#rek').combogrid({
                    url: '<?php echo base_url(); ?>index.php/cmsc/load_rek',
                    queryParams: ({
                        sp2d: nosp2d,
                        no: nobukti,
                        jenis: jnsbeban,
        ...
        $('#rek').combogrid({
            ...
            onSelect: function(rowIndex, rowData) {
                ...
                $('#sumber_dn').combogrid({
                    url: '<?php echo base_url(); ?>index.php/cmsc/load_reksumber_dana',
                    queryParams: ({
                        giat: giat,
                        kd: kode,
                        rek: hrek
  ...
  function load_total_spd(){
    ...
    $(function(){      
     $.ajax({
      type: 'POST',
      url:"<?php echo base_url(); ?>index.php/cmsc/load_total_spd",
      dataType:"json",
  ...
  function load_total_trans(){
    ...
    $(function(){      
     $.ajax({
      type: 'POST',
      url:"<?php echo base_url(); ?>index.php/cmsc/load_total_trans",
      dataType:"json",
      data: ({giat:giat,kode:kode,no_simpan:no_simpan,beban:beban}),
      success:function(data){ 
        $.each(data, function(i,n){
  ...
  function load_sisa_pot_ls(){ 
   ...
   $(function(){      
     $.ajax({
      type: 'POST',
      url:"<?php echo base_url(); ?>index.php/cmsc/load_sisa_pot_ls",
      dataType:"json",
      data: ({sp2d:sp2d_pot}),
      success:function(data){ 
        $.each(data, function(i,n){
  ...
  function get_skpd(){
     $.ajax({
      ...
      success:function(data){
        ...
        $("#kduser").attr("value",data.user_name);
        kode = data.kd_skpd;
      }                                     
    });  
 }
    ...
    function kegia(){
     ...
     $('#giat').combogrid({url:'<?php echo base_url(); ?>index.php/cmsc/load_trskpd_sub',queryParams:({kd:kode,jenis:jns1})});  
    }     
    ...
    function load_detail(){
        ...
        var cskpd = document.getElementById("skpd").value;//$('#skpd').combogrid('getValue');     
           ...
           $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/cmsc/load_dtransout',
    ...
    function load_detail_rekbank(){
        ...
        var cskpd = document.getElementById("skpd").value;//$('#skpd').combogrid('getValue');             
           ...
           $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/cmsc/load_dtransout_transfercms',
                data: ({no:kk,skpd:cskpd}),
                dataType:"json",
                success:function(data){                                        
                    $.each(data,function(i,n){                                    
    ...
    function load_detail_pot(nosts){
        ...
        $(function(){
			$('#dgpajak').edatagrid({
				url: '<?php echo base_url(); ?>/index.php/cmsc/load_dpot',
    ...
    function load_detail_baru(){        
        var kk =''; 
           ...
           $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/cmsc/load_dtagih',
                data: ({no:kk}),
                dataType:"json",
                success:function(data){                                          
                    $.each(data,function(i,n){                                    
   ...
   function get(nomor,nomor_tgl,tgl,kode,nama,ket,jns,tot,notagih,tgltagih,ststagih,vpay,nokas_pot,tglpot,ketpot,statup,statval,statpot,srekwal,snmrek_awal,sbank_tjn,srek_tjn,ssp2d,kettjnn){
    ...
    function kosong(){
     ...
     function get_nourut()
        {
        	$.ajax({
        		url:'<?php echo base_url(); ?>index.php/cmsc/no_urut_cms',
        		type: "POST",
        		dataType:"json",                         
        		success:function(data){
    ...
    function get_nourut_tgl()
        {
        	$.ajax({
        		url:'<?php echo base_url(); ?>index.php/cmsc/no_urut_tglcms',
        		type: "POST",
        		dataType:"json",                         
        		success:function(data){
    ...
    function hapus_rekening_bnk(){
     ...
     function hapus(){
        ...
        var urll = '<?php echo base_url(); ?>index.php/cmsc/hapus_transout';
    ...
    function pilihanpot(){
     var url    = "<?php echo site_url(); ?>cmsc_trmpot/trmpot";
    ...
    function simpan_transout() {
        ...
        var ciduser = "<?php echo $this->session->userdata('pcNama'); ?>";
        var ctgl = $('#tanggal').datebox('getValue');
        var no_simpan = document.getElementById('no_simpan').value;
        ...
        if (r == true) {
            ...
            if (cjenis == "6" || cjenis == "4") {
                if (cjenis_bayar == 'BANK' && ctotal > ckas) {
            ...
            if (status_transaksi == 'tambah') {
                $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        data: ({
                            no: cno,
                            tabel: 'trhtransout_cmsbank',
                            field: 'no_voucher'
                        }),
                        url: '<?php echo base_url(); ?>/index.php/cmsc/cek_simpan_user',
                        success: function(data) {
                            ...
                            if (status_cek == 0) {
                                ...
                                $(document).ready(function() {
                                    $.ajax({
                                        ...
                                        data: ({
                                            ...
                                            nosp2d2: nosp2d2,
                                            rek_awal: crekawal,
                                            anrek_awal: cnmrekawal,
                                            rek_tjn: crektujuan,
                                            rek_bnk: cbanktujuan,
                                            cinit_ket: init_cmss
                                        }),
                                        url: '<?php echo base_url(); ?>/index.php/cmsc/simpan_transout',
                                        success: function(data) {
                                            status = data.pesan;
                                        }
                                    });
                                ...
                                if (status != '0') {
                                    ...
                                    for (var p = 0; p < rows.length; p++) {
                                        ...
                                        if (p > 0) {
                                            csql = csql + "," + "('" + cnobukti + "','" + cnosp2d + "','" + ckdgiat + "','" + cnmgiat + "','" + crek + "','" + cnmrek + "','" + cnilai + "','" + cskpd + "','" + csumber + "','" + ciuser + "')";
                                        } else {
                                            csql = "values('" + cnobukti + "','" + cnosp2d + "','" + ckdgiat + "','" + cnmgiat + "','" + crek + "','" + cnmrek + "','" + cnilai + "','" + cskpd + "','" + csumber + "','" + ciuser + "')";
                                        }
                                    }
                                    ...
                                    for (var j = 0; j < rows_rek.length; j++) {
                                        ...
                                        if (j > 0) {
                                            csql_rek = csql_rek + "," + "('" + cnobukti + "','" + ctgl + "','" + lrekawal + "','" + lnmrektj + "','" + lrektj + "','" + lbank + "','" + lskpd + "','" + lnilai + "','" + ciuser + "')";
                                        } else {
                                            csql_rek = "values('" + cnobukti + "','" + ctgl + "','" + lrekawal + "','" + lnmrektj + "','" + lrektj + "','" + lbank + "','" + lskpd + "','" + lnilai + "','" + ciuser + "')";
                                        }
                                    }
    ...
    function simpan_potongan(){
        ...
        $(document).ready(function(){
            $.ajax({
                ...
                url: '<?php echo base_url(); ?>/index.php/cmsc/simpan_potongan',
                success:function(data){
                    status = data.pesan;                                                               
                }
            });
...
<h3><a href="#" id="section1" >List Daftar Transaksi Non Tunai</a></h3>
    <div>
      <table width="100%" border="0" style="border-style: hidden">
        ...
        &nbsp;
        <button class="button-abu" onclick="javascript:cari_tgl();"><i class="fa fa-cari"></i> Cari</button>
        <button class="button-cerah" onclick="javascript:cetak_list();"><i class="fa fa-print"></i> Cetak List</button>                
          </td>
          <td>
          <a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="javascript:lihat_trans();">Info</a>                       
          <button class="button" onclick="javascript:section2();kosong();datagrid_kosong();"><i class="fa fa-tambah"></i> Tambah</button>               
            
          </td>
        </tr>
        <tr>
          <td colspan="2">
              <table id="dg" title="List Transaksi" style="width:1024px;height:540px;" > </table> 
          </td>
        </tr>
      </table>
...
<h3><a href="#" id="section2">TRANSAKSI NON TUNAI</a></h3>
   ...
   <p>       
   <div id="demo"></div>
        <table align="center" style="width:100%; border-bottom: 1px white;">
            ...
            <tr>
                ...
                <td><input type="text" id="nomor" class="input" style="width: 200px;" readonly="true"/>
            ...
            <tr>
                <td>USER BPP</td>
                <td><input id="kdbidang" name="kdbidang" class="input" style="width: 200px;" />
					<input type="hidden" id="kduser" name="kduser" style="width: 140px;" />
				</td>
                <td></td>
                <td>Nama :</td> 
            ...
            <tr>
                <td>Keterangan</td>
                <td colspan="4"><textarea id="keterangan" class="textarea" style="height: 40px;"></textarea></td>
           </tr>            
            ...
            <tr>
                ...
                <td>Pembayaran</td>
                 <td colspan="5">
                     <select name="jns_tunai" class="select" style="width: 200px; display: inline;" id="jns_tunai">
                         <option value="">......</option>     
            ...
            <tr>        
                <td colspan="5" align="right">
                    <button id="save" onclick="javascript:simpan_transout();" class="button-biru"><i class="fa fa-simpan"></i> Simpan</button>
                    <button id="del" onclick="javascript:hapus();" class="button-merah"><i class="fa fa-hapus"></i> Hapus</button>
                    <button id="save" onclick="javascript:section1();" class="button-abu"><i class="fa fa-kiri"></i> Kembali</button>
            </td>
            </tr>
        </table>          
        <table id="dg1" title="Rekening Belanja" style="width:1024px;height:200px;" >  
        </table>  
        <div id="toolbar" align="right">
            <button id="tambah" onclick="javascript:tambah();" class="button"><i class="fa fa-tambah"></i> Tambah Kegiatan</button>
            <button id="hapus" onclick="javascript:hapus_giat();" class="button-merah"><i class="fa fa-hapus"></i> Hapus Kegiatan</button>
        ...
        <table id="dg5" title="Daftar Rekening Tujuan" style="width:1024px;height:200px;" >  
        </table>  
        <div id="toolbar2" align="right">
            <button id="tambah" onclick="javascript:tambah_rekening_bnk();" class="button"><i class="fa fa-tambah"></i> Tambah</button>
            <button id="hapus" onclick="javascript:hapus_rekening_bnk();" class="button-merah"><i class="fa fa-hapus"></i> Hapus</button>	
        </div>
        <table align="center" style="width:100%;" border="0">
        <tr>            
            <td width="60%">&nbsp;</td>
...
<div id="dialog-modal" title="Input Kegiatan *)Semua Inputan Harus Di Isi.">
    ...
    <table align="center">
        <tr>
            <td>
            <button onclick="javascript:append_save();" class="button"><i class="fa fa-tambah"></i> Simpan</button>
            <button onclick="javascript:keluar();" class="button-abu"><i class="fa fa-kiri"></i> keluar</button>                          
            </td>
        </tr>
    </table>   
    </fieldset>
...
<div id="dialog-modal-rekening" title="Input Rekening Tujuan *)Semua Inputan Harus Di Isi.">    
    ...
    <table>
        <tr bgcolor="#FFE4E1">
            ...
            <td>:</td>
            <td ><input id="nilpotongan" class="input"    name="nilpotongan" style="text-align: right; width: 200px;" onkeypress="return(currencyFormat(this,',','.',event))" /></td>            
            <td width="30%">&nbsp;*) Harus diisi jika ada potongan</td>
        </tr>        
        <tr>
            <td>Rekening Tujuan</td>
            <td>:</td>
            <td><input type="text" id="rekening_tujuan" style="border:0;width: 210px;" />
            <td width="30%">&nbsp;</td>
            </td>            
        </tr>  
        <tr>
        ...
        <tr>
            <td>Bank</td>
            <td>:</td>
            <td><input type="text" id="kd_bank_tujuan" style="border:0;width: 210px;" onkeyup="javascript:cek_huruf(this);"/>
            <td width="30%">&nbsp;</td>
            </td>            
        </tr>          
        <tr>
            ...
            <td>:</td>
            <td><input type="text" class="input"    id="nilai_trf" style="text-align: right; width: 200px;" onkeypress="return(currencyFormat(this,',','.',event))"/></td>            
            <td width="30%">&nbsp;</td>
        </tr>
    </table>  
    </fieldset>
    ...
    <table align="center">
        <tr>
            <td>
            <button onclick="javascript:append_save_rekening();" class="button"><i class="fa fa-tambah"></i> Simpan</button>
            <button onclick="javascript:tutup_rekening_bnk();" class="button-abu"><i class="fa fa-kiri"></i> keluar</button>                                  
            </td>
        </tr>
    </table>
	</fieldset>
