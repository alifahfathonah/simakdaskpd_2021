...
<head>
    ...
    var lcstatus = '';
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_panjar',
         idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onDblClickRow:function(rowIndex,rowData){
          ...
          lcpay = rowData.pay;
          lcrekening_awal = rowData.rekening_awal;
          status = rowData.status;
          lcidx = rowIndex;
          get(nokas,tglkas,nomor,tgl,kode,lcket,lcnilai,lcpay,kd_kegiatan,status,lcrekening_awal);   
...
//       });
    ...
    function load_detail_rekbank(nokas,tglkas,kode){
        ...
        var cskpd = kode;             
           ...
           $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_dtrpanjar_transfercms',
 ...
 function get_tahun() {
    ...
    function get(nokas,tglkas,nomor,tgl,kode,lcket,lcnilai,lcpay,kd_kegiatan,status,lcrekening_awal){
    ...
    $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_panjar_tgl',
       ...
       function simpan_tetap(){
        ...
        var sisa_bnk = angka(document.getElementById('sisa_bnk').value);
        var total_transf = angka(document.getElementById('total_dtransfer').value);
        
            //lctotal = number_format(lntotal,0,'.',',');
        //alert(jaka);
		var cckeg = ckd_giat.substr(0,21);
        var cakhirkeg = ckd_giat.substr(5,10);
        ...
        if (total_transf!=lntotal){
			alert('Nilai Transfer Tidak Sama Dengan Nilai Panjar');
            exit();
		}
		...
		if (sisa_bnk<lntotal && sisa_anggaran<lntotal){
			alert('Tidak boleh melebihi sisa Kas dan Anggaran');
            exit();
		}

		if (sisa_bnk<lntotal || sisa_anggaran<lntotal){
			alert('Tidak boleh melebihi sisa Kas atau Anggaran');
            exit();
		}
        ...
        var cket_tjuan = "PNJR.KEG."+ckd_giat;
               ...
               // alert(csql);
                $.ajax({
                 ...
                 //-------   
                    ...
                    lcvalues = "('"+cno_kas+"','"+ctgl_kas+"','"+cno+"','"+ctgl+"','"+cskpd+"','','"+lntotal+"','"+lcket+"','"+lctunai+"','','"+ckd_giat+"','0','1','"+cno+"','"+crekawal+"','"+cket_tjuan+"','0','0')";
                    ...
                    $(document).ready(function(){
                        $.ajax({
                            type: "POST",
                            url: '<?php echo base_url(); ?>/index.php/tukd_cms/simpan_master_panjar',
...
//alert(z);
		...
		//---------
                    ...
                    lcquery = "UPDATE tr_panjar_cmsbank SET no_panjar ='"+cno+"',no_kas='"+cno_kas+"',tgl_kas='"+ctgl_kas+"',tgl_panjar='"+ctgl+"',keterangan='"+lcket+"',nilai='"+lntotal+"',pay='"+lctunai+"',no_panjar_lalu='"+cno+"',kd_sub_kegiatan='"+ckd_giat+"',rekening_awal='"+crekawal+"',nm_rekening_tujuan='"+cnmrekawal+"',rekening_tujuan='"+crektujuan+"',bank_tujuan='"+cbanktujuan+"',ket_tujuan='"+ketcms+"' where no_panjar='"+no_simpan+"' AND kd_skpd='"+cskpd+"'";
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<?php echo base_url(); ?>/index.php/tukd_cms/update_master2',
     ...
     function hapus(){
      //  var cnomor = document.getElementById('nomor').value;
        ...
        var urll = '<?php echo base_url(); ?>index.php/tukd_cms/hapus_panjar_cmsbank';
        $(document).ready(function(){
    ...
    var url = '<?php echo site_url(); ?>/tukd_cms/cetak_list_panjarcms';
...
<h3 align="center"><u><b><a href="#" id="section1">INPUTAN PANJAR</a></b></u></h3>
    ...
    <p align="right">         
        ...
        <a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak_list();">Cetak</a>       
    ...
    <fieldset>
     <table align="center" style="width:100%;">
			...
			<tr>
                <td>Sisa Kas Bank</td>
                <td></td>
                <td><input type="text" id="sisa_bnk" style="border:0;width: 160px; text-align: right;"/></td> 
            </tr>
			
            <tr>
                <td>Nilai</td>
                <td></td>
                <td><input type="text" id="nilai" style="width: 160px; text-align: right;" onkeypress="return(currencyFormat(this,',','.',event))"/></td> 
            </tr>
            ...
            <tr>
                <td>Keterangan</td>
                <td colspan="2"><textarea rows="2" cols="50" id="ket" style="width: 500px;"></textarea>
                </td> 
            </tr>
