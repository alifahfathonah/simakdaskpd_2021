  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>easyui/jquery.edatagrid.js"></script>
    ...
    $(function(){                
      $('#dg').edatagrid({
		...
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_list_belum_validasi_perbidang',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        autoRowHeight:"false",
...
function cari(){
    ...
    if(kriteria=='' || kriteria==null){
        ...
        $(function(){ 
        $('#dg').edatagrid({
		    url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_list_validasi_perbidang',
        ...
        var j=1;
            ...
            $(document).ready(function(){               
                $.ajax({
                    ...
                    url: '<?php echo base_url(); ?>/index.php/tukd_cms/simpan_validasicms_bidang',
                    success:function(data){                        
                        status = data.pesan;   
                         if (status=='1'){               
