...
<head>
    ...
    $(document).ready(function() {
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_terima_bank_perbidang',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
		...
		$('#ketdrop').combogrid({  
           ...
           mode:'remote',
		   url:'<?php echo base_url(); ?>index.php/tukd_cms/loadketdrop_bp_bnk',
           columns:[[  
    ...
    function load_sisa(){           
        $(function(){      
         $.ajax({
            type: 'POST',
            url:"<?php echo base_url(); ?>index.php/tukd_cms/load_sisa_dana_kembali_bidang_bnk",
            dataType:"json",
            success:function(data){ 
    ...
    $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/cari_ambilsimpanan',
     ...
     function simpan_ambilsmp(){
        ...
        if (lcstatus=='tambah'){ 
                    ...
                    $(document).ready(function(){
                        $.ajax({
                            type: "POST",
                            url: '<?php echo base_url(); ?>index.php/tukd_cms/simpan_ambil_simpanan_bp_bnk',
    ...
    function tambah(){
     ...
     function hapus(){
		...
		alert(nomor)
        var urll = '<?php echo base_url(); ?>index.php/tukd_cms/hapus_ambilsimpanan_bp_bnk';
        $(document).ready(function(){
