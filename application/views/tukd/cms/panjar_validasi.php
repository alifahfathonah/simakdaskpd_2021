  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>easyui/jquery.edatagrid.js"></script>
    ...
    $(function(){                
      $('#dg').edatagrid({
		...
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_listbelum_validasi_panjar',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        autoRowHeight:"false",
...
function cari(){
    ...
    if(kriteria=='' || kriteria==null){
        ...
        $(function(){ 
        $('#dg').edatagrid({
		    url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_list_validasi_panjar',
        ...
        var j=1;
            ...
            $(document).ready(function(){               
                $.ajax({
                    type: "POST",   
                    dataType : 'json',                 
                    data: ({tabel:'trvalidasi_cmsbank_panjar',no:n_validasi,sql:csql,skpd:dskpd}),
                    url: '<?php echo base_url(); ?>/index.php/tukd_cms/simpan_validasicms_panjar',
                    success:function(data){                        
                        status = data.pesan;   
                         if (status=='1'){               
...
<div id="content">    
<div id="accordion">
<h3><a href="#" id="section1" >VALIDASI - DAFTAR PANJAR NON TUNAI</a></h3>
    <div>
    <p align="center">         
    <table width="100%">
        <tr>
