...
<head>
    ...
    $(document).ready(function() {
     ...
     $('#dg').edatagrid({
		...
		url: '<?php echo base_url(); ?>/index.php/tukd_cms/load_setorbidang_bnk',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        $('#skpd').combogrid({  
           ...
           textField:'kd_skpd',  
           mode:'remote',
           url:'<?php echo base_url(); ?>index.php/tukd/skpd_5',  
           columns:[[  
       ...
       $('#beban').combogrid({  
           ...
           textField:'jns',  
           mode:'remote',
           url:'<?php echo base_url(); ?>index.php/tukd_cms/load_jns_spp_drop',  
           columns:[[  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               var ketcms = 'SETOR.SISA.'+init+'.'+kode;
    ...
    function load_sisa(){           
        $(function(){      
         $.ajax({
            type: 'POST',
            url:"<?php echo base_url(); ?>index.php/tukd_cms/load_sisa_bank_cms",
            dataType:"json",
            success:function(data){ 
     ...
     function simpan_ambilsmp(){
        ...
        if (lcstatus=='tambah'){ 
                    ...
                    $(document).ready(function(){
                        $.ajax({
                            type: "POST",
                            url: '<?php echo base_url(); ?>index.php/tukd_cms/simpan_ambil_simpanan_bidang_bnk',
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<?php echo base_url(); ?>/index.php/tukd_cms/update_ambilsimpanan_bnk',
    ...
    function tambah(){
     ...
     function hapus(){
        ...
        var urll = '<?php echo base_url(); ?>index.php/tukd_cms/hapus_ambilsimpanan_bidang_bnk';
        $(document).ready(function(){
    ...
    var url = '<?php echo site_url(); ?>tukd_cms/cetak_listsimpanan_bank';
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">INPUTAN SETOR SISA KAS BPP - NON TUNAI (CMS)</a></b></u></h3>
    <div>
    <p align="right"> 
        Tanggal
        ...
        <table id="dg" title="Listing data Setor Perbidang" style="width:1024px;height:450px;" >  
        </table>
     ...
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
			 ...
			 <tr>
                ...
                <td></td>
                <td>
                <input type="text" id="jns_setor" style="width: 100px;" />&nbsp;<input type="text" id="ketcms" style="width: 200px; border:0;"/>
                </td>                                             
            </tr>	
			 <tr>
                <td>Sisa Kas Bank</td>
