...
<head>
    ...
    var rekening='';
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/pendapatan/setor_cms/load_belum_sts',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        $('#rekening_awal').combogrid({            
            url:"<?php echo base_url(); ?>index.php/pendapatan/setor_cms/cari_rekening_pend",
            panelWidth:150,
            idField:'rek_bend',
            textField:'rek_bend',
            columns:[[
        ...
        $('#rekening_tujuan').combogrid({            
            url:"<?php echo base_url(); ?>index.php/pendapatan/setor_cms/cari_rekening_tujuan_kasda/4",
            panelWidth:370,
            idField:'rekening',
            textField:'rekening',
            columns:[[
        ...
        $('#kd_bank_tujuan').combogrid({            
            url:"<?php echo base_url(); ?>index.php/pendapatan/setor_cms/cari_bank",
            panelWidth:150,
            idField:'nama',
            textField:'nama',
            columns:[[
	   ...
	   $('#noterima').combogrid({
        ...
        $('#cmb_rek').combogrid({  
           ...
           textField:'kd_rek5',  
           mode:'remote',
           url:'<?php echo base_url(); ?>index.php/pendapatan/setor/ambil_rek/'+kode+'/'+giat,             
           columns:[[
    ...
    function load_detail(kk){        
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/pendapatan/setor_cms/load_dsts',
                data: ({no:kk}),
                dataType:"json",
                success:function(data){                                   
    ...
    $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/pendapatan/setor_cms/load_sts_tgl',
        queryParams:({cari:kriteria})
        });        
     });
    }
    ...
    var kriteria = $('#tglvoucher').datebox('getValue'); 
    if(kriteria==''){alert('Tanggal Tidak Boleh Kosong'); exit();}else{  
        var url = '<?php echo site_url(); ?>pendapatan/cetak/cetak_sts_cms';
    ...
    function hapus(){
        ...
        var urll   = '<?php echo base_url(); ?>index.php/pendapatan/setor_cms/hapus_sts';
    ...
    function simpan_sts(){
		...
		$(document).ready(function(){
            ...
            for(var i=0;i<rows.length;i++){
                ...
                if(i>0){
    				lcval_det = lcval_det+",('"+cskpd+"','"+xno_sts+"','"+ckdrek+"','"+cnilai+"','"+cgiat+"','"+cnoterima+"','"+ckdrek+"')";
    			}else{
    				lcval_det = lcval_det+"('"+cskpd+"','"+xno_sts+"','"+ckdrek+"','"+cnilai+"','"+cgiat+"','"+cnoterima+"','"+ckdrek+"')";
    			}              
    		}
            ...
            $(document).ready(function(){
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url(); ?>/index.php/pendapatan/setor_cms/simpan_sts_pendapatan',
		...
		$(document).ready(function(){
            ...
            $('#dg1').datagrid('unselectAll');    
              $(document).ready(function(){
                    $.ajax({
                        type     : "POST",
                        url      : '<?php echo base_url(); ?>/index.php/pendapatan/setor_cms/update_sts_pendapatan_ag',
...
<div id="dialog-modal_cetak" title="Cetak STS">
    ...
    <table border="0">
        <tr align="center">
            <td></td>
            <td width="100%" align="center"><a  href="<?php echo site_url(); ?>pendapatan/cetak/setor_cms" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
