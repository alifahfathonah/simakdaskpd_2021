...
//		}); 
	   ...
	   $(function(){  
		...
		function cetak(jns)
        {
            ...
            var jnskep = document.getElementById('jnskep').value;
			...
			window.open(url+'/'+dcetak+'/'+dcetak2+'/'+skpd+'/'+jns+'/'+jnsctk+'/'+urut+'/'+spasi+'/'+jnskep+lc, '_blank');
			window.focus();
        }
...
<h3>CETAK BUKU PENERIMAAN DAN PENYETORAN</h3>
    ...
    <p align="right">         
        ...
        <tr >
			<td width="20%" height="40" ><B>Jenis Keperluan</B></td>
			<td width="80%"><select name="jnskep" id="jnskep" style="height: 27px; width: 300px;">
             <option value="1" >Semua Keperluan</option>
             <option value="2" >Penerimaan dan Penyetoran Tahun Berjalan</option>
             <option value="3" >Penerimaan Atas Piutang Tahun Lalu</option>
             <option value="4" >Penyetoran Atas Penerimaan Tahun Lalu</option>
            </td>
		</tr>
		<tr >
        ...
        <tr >
			...
			<td width="80%"><select name="urut" id="urut" style="height: 27px; width: 190px;">
             <option value="1" >Tanggal Terima</option>
             <option value="2" >Tanggal Setor</option>
            </td>
		</tr>
