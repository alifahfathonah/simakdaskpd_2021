...
<head>
    ...
    $(document).ready(function() {
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/simpanan/load_ambilsimpanan',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        $('#bank').combogrid({  
           ...
           columns:[[  
               ...
               {field:'nama_bank',title:'Nama Bank',width:700}    
           ]],  
           onSelect:function(rowIndex,rowData){
               kode = rowData.kd_bank;               
               $("#nmbank").attr("value",rowData.nama_bank.toUpperCase());
           }  
        });
    ...
    function load_sisa(){           
        $(function(){      
         $.ajax({
            type: 'POST',
            url:"<?php echo base_url(); ?>index.php/simpanan/load_sisa_bank",
            dataType:"json",
            success:function(data){ 
    ...
    $(function(){ 
     ...
     function simpan_ambilsmp(){
        ...
        if (lcstatus=='tambah'){ 
                    ...
                    lcinsert = "(no_kas,tgl_kas,no_bukti,tgl_bukti,kd_skpd,nilai,bank,nm_rekening,keterangan,status_drop)";
                    lcvalues = "('"+cno+"','"+ctgl+"','"+cno_bukti+"','"+ctgl_bukti+"','"+cskpd+"','"+lnnilai+"','"+cbank+"','"+cnmrek+"','"+lcket+"','0')";
        
                    $(document).ready(function(){
                        $.ajax({
                            type: "POST",
                            url: '<?php echo base_url(); ?>index.php/simpanan/simpan_ambil_simpanan',
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<?php echo base_url(); ?>/index.php/simpanan/update_ambilsimpanan',
    ...
    function tambah(){
     ...
     function hapus(){
		...
		alert(nomor)
        var urll = '<?php echo base_url(); ?>index.php/simpanan/hapus_ambilsimpanan';
        $(document).ready(function(){
    ...
    function get_nourut()
        {
        	$.ajax({
        		url:'<?php echo base_url(); ?>index.php/simpanan/no_urut',
        		type: "POST",
        		dataType:"json",                         
        		success:function(data){
...
<h3 align="center"><u><b><a href="#" id="section1">INPUTAN AMBIL SIMPANAN</a></b></u></h3>
    ...
    <p align="right">         
        ...
        <button class="button-merah" onclick="javascript:hapus();"><i class="fa fa-hapus"> hapus</i></button>  
        <button class="button-abu" onclick="javascript:cari();"><i class="fa fa-cari"> cari</i></button>              
        <input type="text" value="" onkeyup="javascript:cari();" id="txtcari"/>
        <table id="dg" title="Listing data ambil simpanan" style="width:1024px;height:450px;" >  
        </table>
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                <td>S K P D</td>
                <td></td>
                <td><input id="skpd" name="skpd" style="width: 210px; display: inline;" />  <input type="text" id="nmskpd" style="border:0;width: 600px;" readonly="true"/></td>                            
            </tr>

            <tr>
                <td>No. Kas</td>
                <td></td>
                <td><input disabled  class="input" type="text" id="nomor" style="width: 200px;"/></td>  
            </tr>            
            <tr>
                <td>Tgl Kas </td>
                <td></td>
             ...
             <tr>
                <td>No. Bukti</td>
                <td></td>
                <td><input class="input" type="text" id="no_bukti" style="width: 200px;"/></td>  
            </tr>            
            <tr>
                <td>Tgl Bukti </td>
                <td></td>
                <td><input  disabled type="text" id="tgl_bukti" style="width: 210px;" /></td>
            </tr>
			
			 <tr>
                <td>Sisa Bank</td>
                <td></td>
                <td><input type="text" class="input" id="sisa_uang" style="width: 200px; text-align: right;" /></td> 
            </tr>
			
            <tr>
                <td>Nilai</td>
                <td></td>
                <td><input type="text" class="input" id="nilai" style="width: 200px; text-align: right;" onkeypress="return(currencyFormat(this,',','.',event))"/></td> 
            </tr>
            <!---onkeypress="return(currencyFormat(this,',','.',event))--->
            <tr>
                <td>Bank</td>
                <td></td>
                <td><input type="text" id="bank" style="width: 210px;" /> <input type="text" id="nmbank" style="border:0;width: 600px;" readonly="true"/> </td>                
            </tr> 
            
            
            <tr>
                <td>Nama Rekening</td>
                <td colspan="2"><textarea class="textarea" rows="1" cols="50" id="nmrek" style="width: 740px;"></textarea>
                </td> 
            </tr>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="button-biru" onclick="javascript:simpan_ambilsmp();"> <i class="fa fa-save"> Simpan</i> </button>
                    <button class="button-abu" onclick="javascript:keluar();"> <i class="fa fa-kiri"> Kembali</i> </button>
                </td>                
            </tr>
        </table>       
    </fieldset>
