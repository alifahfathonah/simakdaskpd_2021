  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>easyui/jquery.edatagrid.js"></script>
    ...
    $('#dg2').edatagrid({		                
        ...
        $('#giat').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               $("#sp2d").combogrid({url:'<?php echo base_url(); ?>index.php/cmsc/load_sp2d_transout',queryParams:({jenis:jnsbeban,giat:giat,kd:kode,bukti:nomor})});
       ...
       $('#sumber_dn').combogrid({  
        ...
        $('#rek').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
                ...
                $('#sumber_dn').combogrid({url:'<?php echo base_url(); ?>index.php/cmsc/load_reksumber_dana',
	...
	function cek_status_ang(){
        var tgl_cek = $('#tanggal').datebox('getValue');
          $.ajax({
            url:'<?php echo base_url(); ?>index.php/cmsc/cek_status_ang',
...
<h3><a href="#" id="section1" >Daftar Transaksi Tunai</a></h3>
    ...
    <p align="right">
      ...
      <button class="button-abu" onclick="javascript:cari();"><i class="fa fa-cari"></i> Cari</button>                      
        <input type="text" value="" class="input" style="display: inline;" id="txtcari"/>
        <table id="dg" title="List Transaksi" style="width:1024px;height:590px;" >  
        </table>                          
    </p>        
    </div>   
...
<h3><a href="#" id="section2">TRANSAKSI TUNAI</a></h3>
   ...
   <div id="demo"></div>
        <table align="center" style="width:100%;">
            ...
            <tr>
                <td>Nomor </td>
                <td><input type="text" class="input" id="nomor" style="width: 200px;" readonly="true"/>
            ...
            <tr>
                <td>USER BPP</td>
                <td><input id="kdbidang" name="kdbidang" class="input" style="width: 200px;" /></td>
                <td></td>
                <td>Nama :</td> 
            ...
            <tr>
                <td>Jenis Beban</td>
                <td colspan="4"><?php echo $this->tukd_model->combo_beban('beban',"class='select' style='width:200px'"); ?>  </td>                                             
            </tr>              
        ...
        <table id="dg1" title="Rekening" style="width:1024px;height:200px;" >  
        </table>  
        <div id="toolbar" align="right">
                  <button id="tambah" class="button" onclick="javascript:tambah();"><i class="fa fa-tambah"></i> Tambah Kegiatan</button>
                  <button id="hapus" class="button-merah" onclick="javascript:hapus_giat();"><i class="fa fa-hapus"></i> Hapus</button>       		
        </div>
    ...
    <table align="center">
        <tr>
            <td>
                  ...
                  <button  class="button-abu" onclick="javascript:keluar();"><i class="fa fa-kiri"></i> Keluar</button>                                 
            </td>
        </tr>
    </table>   
    </fieldset>
