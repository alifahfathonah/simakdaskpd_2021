...
<head>
  ...
  <script type="text/javascript"> 
    ...
    $(function(){
     ...
     $('#cspp').combogrid({  
      panelWidth:500,  
      url: '<?php echo base_url(); ?>/index.php/sppc/load_spp_tu',  
      idField:'no_spp',                    
      textField:'no_spp',
      mode:'remote',  
      fitColumns:true,  
     ...
     $('#ttd3').combogrid({  
      ...
      textField:'nip',  
      mode:'remote',
      url:'<?php echo base_url(); ?>index.php/sppc/load_ttd_cek/PA',  
      columns:[[  
      {field:'nip',title:'NIP',width:200},  
      {field:'nama',title:'Nama',width:400}    
      ]],
     ...
     $('#spp').edatagrid({
      ...
      onSelect:function(rowIndex,rowData){
        ...
        get(urut,no_spp,kode,sp,tg,bl,jn,kep,bk,ning,status,kegi,nm,kprog,nprog,tot_spp);
     ...
     $('#sp').combogrid({  
      panelWidth:500,  
      url: '<?php echo base_url(); ?>/index.php/sppc/spd1',  
      idField:'no_spd',  
      textField:'no_spd',
      mode:'remote',  
      fitColumns:true,                    
     ...
     $('#dgsppls').edatagrid({
      ...
      {field:'nmkegiatan',title:'Kegiatan',width:150,align:'left'},
      ...
      {field:'sumber',title:'sumber',width:140,align:'right'},
  ...
  function validate_kegiatan(){ 
    ...
    $(function(){
      $('#rek_kegi').combogrid({  
        ...
        textField :'kd_kegiatan',  
        mode      :'remote',
        url       :'<?php echo base_url(); ?>index.php/sppc/load_trskpd_ar_2',  
                  ...
                  $('#rek_reke').combogrid({  
                    ...
                    onSelect:function(rowIndex,rowData){      
                     ...
                     $.ajax({
                      type     : "POST",
                      dataType : "json",   
                      data     : ({kegiatan:kegiatan,kdrek5:koderek,kd_sub_skpd:kode_s,kd_skpd:kode_s,no_spp:nospp}), 
                      url      : '<?php echo base_url(); ?>index.php/sppc/jumlah_ang_spp_tu',
                      success  : function(data){
                        $.each(data, function(i,n){
                          ...
                          $.ajax({
                            type     : "POST",
                            dataType : "json",   
                            data     : ({kegiatan:kegiatan,kd_skpd:kode_s,tglspd:tgl_spd,kdrek5:koderek,beban:beban}), 
                          ...
                          $.ajax({
                            type     : "POST",
                            dataType : "json",   
                            data: ({giat:kegiatan,kode:kode_s}), 
      ...
      $('#dg1').edatagrid({
        ...
        onLoadSuccess:function(data){                      
                    ...
                    onAfterEdit:function(rowIndex, rowData, changes){                
                      skegiatan=rowData.kdkegiatan;
                      nskegiatan=rowData.nmkegiatan;
  ...
  function kosong(){
    ...
    lcvalues = "('"+a+"', '"+kdskpd+"', '"+e+"',   '"+d+"', '"+spd+"', '"+c+"', '1', '"+g+"', '',  '"+i+"', '', '"+j+"',  '"+b+"', '0',    '',           '',            '"+k+"',  '',           '"+l+"',         '"+m+"',     '"+n+"',     '',  '',     '',    '',    '',       '',        '',        '',        '',      '',      '',      '', '','','','','"+y+"','"+kd_sub_skpd+"' )";
            ...
            $(document).ready(function(){
              $.ajax({
                type     : "POST",
                url      : '<?php echo base_url(); ?>/index.php/sppc/simpan_tukd_tu',
                ...
                success  : function(data){
                  ...
                  $(document).ready(function(){
                        ...
                        $.ajax({
                          ...
                          dataType : 'json',                 
                          data: ({no:a,sql:csql}),
                          url: '<?php echo base_url(); ?>/index.php/sppc/dsimpan_ag',
                          success:function(data){                        
                            status = data.pesan;   
                            if (status=='1'){
                              $("#loading").hide();
     ...
     if ( status=='1' ){
            ...
            $(document).ready(function(){
                        ...
                        $.ajax({
                          ...
                          url: '<?php echo base_url(); ?>/index.php/sppc/dsimpan_ag_edit',
                          success:function(data){                        
                            status = data.pesan;   
                            if (status=='1'){
                              $("#loading").hide();
    ...
    $(function(){
      $('#dgsppls').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){
          ...
          idx         =  rowData.idx ;
          tkdkegiatan = rowData.kdkegiatan ;
          tnmkegiatan = rowData.nmkegiatan ;
          tkdrek5     = rowData.kdrek5 ;
          tnmrek5     = rowData.nmrek5 ;
          tnilai1     = rowData.nilai1 ;
...
formatter:function(value,rec){ 
  ...
  function tambah(){
      ...
      /*     if ( (status_ang=='Penyusunan')&&(cnil_input > cnil_sisa_semp_dana)){
          ...
          $('#dgsppls').edatagrid('appendRow',{kdkegiatan:vrek_kegi,nmkegiatan:nmkg,kdrek5:vrek_reke,nmrek5:vnm_rek_reke,nilai1:cnilai,sumber:vsumber_dn,idx:pidx});
          $("#dialog-modal-rek").dialog('close'); 
           ...
           <table border='1' style="font-size:11px">
            ...
            <tr>
             ...
             <tr style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;" >   
               ...
               <td style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">&nbsp;<input type="text" name="no_spp" id="no_spp" class="input"  style="width:250px" onkeyup="this.value=this.value.toUpperCase()"/><input type="hidden" name="no_spp_hide" id="no_spp_hide" style="width:140px"/></td>
             ...
             <tr style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">
               ...
               <td style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><select name="jns_beban" id="jns_beban" class="select" style="height: 27px; width:190px;">
                 <option value=""></option>
              ...
              <table id="dgsppls" title="Input Detail SPP" style="width:1024px;height:300%;" >  
              </table>
