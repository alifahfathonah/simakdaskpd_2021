    ...
    <script type="text/javascript">
       ...
       $('#tgl1').datebox({  
    	...
    	$('#ttd1').combogrid({  
			...
			$('#ttd2').combogrid({  
					...
					textField:'nip',  
					mode:'remote',
					url:'<?php echo base_url(); ?>index.php/tukd/load_ttd/BPP',  
					columns:[[  
						{field:'nip',title:'NIP',width:200},  
						{field:'nama',title:'Nama',width:400}    
					]],
     ...
     function openWindow( url ){
		...
		lc = '?tgl1='+ctgl1+'&tgl_ttd='+ctglttd+'&ttd1='+ttd_1+'&ttd2='+ttd_2+'&spasi='+spasi+'&jns_bp=bpp';
...
<div id="content1" align="center"> 
    ...
    <fieldset style="border-radius: 10px; border: 3px solid green"> <legend><b>BUKU KAS TUNAI</b></legend>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <a href="<?php echo site_url(); ?>cetak_kas/cetak_kas_tunai/0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
                <a href="<?php echo site_url(); ?>cetak_kas/cetak_kas_tunai/1" class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
                </td>                
            </tr>
        </table>  
