...
//       });
	...
	url="<?php echo site_url(); ?>cetak_tukd/cetak_bku_global/"+$cetak+"/"+atas+"/"+bawah+"/"+kiri+"/"+kanan;
	if(ctk==''){
...
<div id="content1" align="center" style="background-color: white"> 
    <h3 align="center"><b>CETAK LAPORAN BUKU KAS UMUM GLOBAL<br>
    (BKU)</b></h3>
