...
<head>
    ...
    function get_skpd()
        ...
        function cetak(ctk){
			...
			window.open(url+'/'+skpd+'/'+bulan+'/'+ttd_1+'/'+ctglttd+'/'+ttd_2+'/'+ctk+'/'+atas+'/'+bawah+'/'+kiri+'/'+kanan+'/1'+'/bpp/'+jns_ang, '_blank');
			window.focus();
            }else{
            var url    = "<?php echo site_url(); ?>/tukd/cetak_spj_priode";  
			window.open(url+'/'+skpd+'/'+ctgl_1+'/'+ctgl_2+'/'+ttd_1+'/'+ctglttd+'/'+ttd_2+'/'+ctk+'/'+atas+'/'+bawah+'/'+kiri+'/'+kanan+'/1'+'/bpp/'+jns_ang, '_blank');
			window.focus();    
            }
		...
		function cetak1(ctk){
            ...
            if(pil_ctk=='2'){
			var url    = "<?php echo site_url(); ?>/tukd/cetak_spj";  
			window.open(url+'/'+skpd+'/'+bulan+'/'+ttd_1+'/'+ctglttd+'/'+ttd_2+'/'+ctk+'/'+atas+'/'+bawah+'/'+kiri+'/'+kanan+'/2'+'/bpp/'+jns_ang, '_blank');
			window.focus();
            }else{
            var url    = "<?php echo site_url(); ?>/tukd/cetak_spj_priode";  
			window.open(url+'/'+skpd+'/'+ctgl_1+'/'+ctgl_2+'/'+ttd_1+'/'+ctglttd+'/'+ttd_2+'/'+ctk+'/'+atas+'/'+bawah+'/'+kiri+'/'+kanan+'/2'+'/bpp/'+jns_ang, '_blank');
			window.focus();    
            }
