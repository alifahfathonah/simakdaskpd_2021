...
<head>
    ...
    var cid   = 0;
     ...
     $('#dg').edatagrid({
        ...
        onDblClickRow:function(rowIndex,rowData){
          ...
          getpot(bukti,tgl,ket,npwp,kd_giat,no_sp2d,nm_giat,kd_rek,nm_rek,rekanan,dir,alamat,jns_spp,st);  
          detail_potongan();
          load_sum_pot();
       }
    });
    ...
    function  getpot(bukti,tgl,ket,npwp,kd_giat,no_sp2d,nm_giat,kd_rek,nm_rek,rekanan,dir,alamat,jns_spp,st){
    ...
    //awal tambah potongan   
       ...
       $(document).ready(function(){
            $.ajax({
                type: "POST",       
                dataType : 'json',         
                data: ({tabel:'trhtrmpot',no:cnokas,tgl:ctglkas,skpd:cskpd,nmskpd:cnmskpd,ket:ckete,total:ctotal,beban:cbeban,npwp:cnpwp,kd_giat:ckd_giat,no_sp2d:cno_sp2d,nm_giat:cnm_giat,kd_rek:ckd_rek,nm_rek:cnm_rek,rekanan:crekanan,alamat:calamat,dir:cdir}),
        ...
        if (status !='0'){            
            ...
            for(var q=0;q<rows.length;q++){
                ...
                csqljur = "values('"+cnobukti+"','"+crek+"','"+cnmrek+"','0','"+cnilai+"','K','2','1')"+","+"('"+cnobukti+"','110103010001','Kas di Bendahara Pengeluaran','"+ctotal+"','0','D','1','1')";                                            
                }                                             
            }                     
            $(document).ready(function(){
                //alert(csql);
    ...
    $(document).ready(function(){
            $.ajax({
                type: "POST",       
                dataType : 'json',         
                data: ({tabel:'trhtrmpot',no:cnokas,tgl:ctglkas,skpd:cskpd,nmskpd:cnmskpd,ket:ckete,total:ctotal,beban:cbeban,npwp:cnpwp,kd_giat:ckd_giat,no_sp2d:cno_sp2d,nm_giat:cnm_giat,kd_rek:ckd_rek,nm_rek:cnm_rek,rekanan:crekanan,alamat:calamat,dir:cdir,no_bku:no_bku}),
...
<h3><a href="#" id="section1" >List Terima Potongan</a></h3>
    <div>
    <p align="right">                   
        <button class="button" onclick="javascript:section3();kosong();datagrid_kosong();"><i class="fa fa-tambah"> Tambah </i></button>
        <input type="text" style="width: 200px" onkeyup="javascript:cari();" placeholder="Pencarian: ketik dan enter" value="" id="txtcari"/>
   ...
   <h3><a href="#" id="section3" >Potongan</a></h3>
    ...
    <fieldset>
       ...
       <tr>
           ...
           <tr>
             <td colspan="4" align="center" > 
                 <button class="button" onclick="javascript:append_save_pot();" ><i class="fa fa-tambah"></i> Tambahkan Potongan</button>
      ...
      &nbsp;&nbsp; 
       <table border='0' style="font-size:11px;width:100%;height:30px;"> 
           <tr>
                <td colspan="3" align="center">
                  <button id="tambah" class="button button-biru" onclick="javascript:simpan_potongan();">
                    <i class="fa fa-save"></i> Simpan
                  </button>
                  <button id="tambah" class="button button-abu" onclick="javascript:section1();">
                    <i class="fa fa-kiri"></i> Kembali
                  </button>
                  <button id="hapus" class="button button-merah" onclick="javascript:hapus();kosong();datagrid_kosong();section1();">
                    <i class="fa fa-hapus"></i> Kembali
                  </button>          
       ...
       <table id="dgpajak" title="List Potongan" style="width:1024px;height:200px;">  
       </table>   
