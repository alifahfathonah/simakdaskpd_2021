...
<head>
    ...
    function get_skpd(){
		...
		function cetak(ctk)
        {
			...
			var url    = "<?php echo site_url(); ?>cetak_pajak/pajak1";  
			var url2    = "<?php echo site_url(); ?>cetak_pajak/pajak2";  
			var url3    = "<?php echo site_url(); ?>cetak_pajak/pajak3";  
			var url4    = "<?php echo site_url(); ?>cetak_pajak/pajak4";  
			var url5    = "<?php echo site_url(); ?>cetak_pajak/pajak5";  
			var jns_bp = "bp";
			
			if(((jns==1)||(jns==4)||(jns==5)) && (rinci==0) || (rinci==1)){
			window.open(url2+'/'+skpd+'/'+bulan+'/'+ctk+'/'+ttd_1+'/'+ctglttd+'/'+ttd_2+'/'+jns+'/'+rinci+'/'+spasi+'/'+jns_bp, '_blank');
			window.focus();
			}
			else if(((jns==2)||(jns==3)) && (rinci1==4)){
			window.open(url3+'/'+skpd+'/'+bulan+'/'+ctk+'/'+ttd_1+'/'+ctglttd+'/'+ttd_2+'/'+jns+'/'+rinci+'/'+spasi+'/'+jns_bp, '_blank');
			window.focus();
			}
			else if(((jns==0)||(jns==2)||(jns==3)) && (rinci1==5)){
			window.open(url4+'/'+skpd+'/'+bulan+'/'+ctk+'/'+ttd_1+'/'+ctglttd+'/'+ttd_2+'/'+jns+'/'+rinci+'/'+spasi+'/'+jns_bp, '_blank');
			window.focus();
			}
			else if(((jns==0)||(jns==2)||(jns==3)) && (rinci1==6)){
			window.open(url5+'/'+skpd+'/'+bulan+'/'+ctk+'/'+ttd_1+'/'+ctglttd+'/'+ttd_2+'/'+jns+'/'+rinci+'/'+pasal+'/'+spasi+'/'+jns_bp, '_blank');
			window.focus();
			} else{
			window.open(url+'/'+skpd+'/'+bulan+'/'+ctk+'/'+ttd_1+'/'+ctglttd+'/'+ttd_2+'/'+jns+'/'+spasi+'/'+jns_bp, '_blank');
			window.focus();
			}
        }
        
	function cetak_global(ctk)
        {
			var spasi  = document.getElementById('spasi').value; 
			var skpd   = kdskpd; 
			var bulan   =  document.getElementById('bulan1').value;
			...
			var ttd_1 = ttd1.split(" ").join("123456789");
			var ttd_2 = ttd2.split(" ").join("123456789");
			var url   = "<?php echo site_url(); ?>cetak_pajak/pajak_global1";  
			var url2  = "<?php echo site_url(); ?>cetak_pajak/pajak_global2";  
			var url3  = "<?php echo site_url(); ?>cetak_pajak/cetak_pajak3_global";  
			var url4  = "<?php echo site_url(); ?>cetak_pajak/cetak_pajak4_global";  
			var url5  = "<?php echo site_url(); ?>cetak_pajak/cetak_pajak5_global";  
			var jns_bp = "bp";
...
<div id="accordion" width="100%" >
    ...
    <p align="right" width="100%" >         
		...
		<tr >
			...
			<td width="80%"><input id="sskpd" name="sskpd" style="width: 150px;" /><input id="nmskpd" name="nmskpd" disabled style="width: 500px; border:0;" /></td>
		</tr>
        <tr >
		...
		<!--<tr >
		 <td width="20%" height="40" ><B>JENIS CETAKKAN</B></td><td>
  	     <select name="jns_ctk" id="jns_ctk" >
		 <option value="0">Per SKPD</option> 
		 <option value="1">SKPD GLOBAL</option>
		</td>
		</tr>-->
        <tr >
		...
		<tr >
			<td colspan="2">
			<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak(0);">Cetak SKPD</a>
			<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak(1);">Cetak SKPD</a>
			</td>
		</tr>
        <tr >
			<td colspan="2">
			<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak_global(0);">Cetak GLOBAL</a>
			<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak_global(1);">Cetak GLOBAL</a>
			</td>
		</tr>
        </table>                      
    </p> 
