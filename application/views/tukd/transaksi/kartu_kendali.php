...
<head>
    ...
    function get_skpd(){
        ...
        function cetak(ctk)
        {
			...
			var url    = "<?php echo site_url(); ?>cetak_tukd/cetak_kartu_kendali";  
			if(giat==''){
			...
			window.open(url+'/'+skpd+'/'+giat+'/'+ctk+'/'+ttd+'/'+ttd2+'/'+ctglttd+'/'+spasi+'/'+cbulan, '_blank');
			window.focus();
        }
    ...
    <p align="right">         
       ...
       <tr>
         ...
         <tr>
                ...
                <div id="div_tgl1">
                        <table style="width:100%;" border="0">
                            <td colspan="2" width="20%">BULAN</td>
