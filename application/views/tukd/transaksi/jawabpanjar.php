...
<h3 align="center"><u><b><a href="#" id="section1">INPUTAN PERTANGGUNGJAWABAN PANJAR</a></b></u></h3>
    <div>
    <p align="right"> 
        <button class="button" onclick="javascript:tambah()"><i class="fa fa-tambah"></i> Tambah</button>
        <button class="button button-merah" onclick="javascript:hapus()"><i class="fa fa-hapus"></i> Hapus</button>      
        <input type="text" value="" class="input" style="display: inline; width: 200px" onkeyup="javascript:cari();" id="txtcari" placeholder="Pencarian: ketik dan enter" />
        <table id="dg" title="Listing Pertanggungjawaban panjar" style="width:1024px;height:450px;" >  
        </table>
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
			...
			<tr>
                <td>No. Kas</td>
                <td></td>
                <td><input class="input" type="text" id="no_kas" style="width: 200px;"/></td>  
            </tr>
            <tr>
                <td>Tanggal Kas </td>
                <td></td>
                <td><input class="input" type="text" id="tanggal_kas" style="width: 140px;" /></td>
            </tr>
             <tr>
                <td>No. panjar</td>
                <td></td>
                <td><input class="input" type="text" id="nomor" style="width: 200px;"/></td>  
            </tr>             
            <tr>
                <td>Tanggal </td>
                <td></td>
                <td><input class="input" type="text" id="tanggal" style="width: 140px;" /></td>
            </tr>
            <tr>
                <td>S K P D</td>
                <td></td>
                <td><input class="input" id="skpd" name="skpd" style="width: 140px;" />  <input type="text" id="nmskpd" style="border:0;width: 600px;" readonly="true"/></td>                            
            </tr>            
            <tr>
                <td>Nilai</td>
                <td></td>
                <td><input class="input" type="text" id="nilai" style="width: 200px; text-align: right;" readonly="true"/></td> 
            </tr>
            <tr>
                <td>Keterangan</td>
            ...
            <tr>
                <td colspan="3" align="center">
                    <button class="button button-biru" onclick="javascript:simpan_tetap();"><i class="fa fa-simpan"></i> Simpan</button>
                    <button class="button button-abu" onclick="javascript:keluar();"><i class="fa fa-kiri"> Kembali</i></button>
                </td>                
            </tr>
        </table>       
    </fieldset>
