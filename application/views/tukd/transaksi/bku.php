...
//       });
    ...
    url="<?php echo site_url(); ?>cetak_tukd/cetak_bku_skpd/"+$cetak+"/"+atas+"/"+bawah+"/"+kiri+"/"+kanan;
    //url="<?php echo site_url(); ?>/tukd/cetak_bku/"+$cetak+"/"+atas+"/"+bawah+"/"+kiri+"/"+kanan;
    if(ctk==''){
...
<div id="content1" align="center" style="background: white"> 
        ...
        <td colspan="4">
                <div id="div_bend">
                        <table style="width:100%;" border="0">
                            ...
                            <td width="1%">:</td>
                            <td><input type="text" disabled="true" id="ttd3" style="width: 100px;" /> 
                            </td>
                            </tr>   
                        </table>
                </div>
