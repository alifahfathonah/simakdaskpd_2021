...
//		}); 
    ...
    function get_skpd()
        ...
        function cetak(ctk)
        {
			...
			var angx = document.getElementById('angx').value;
			...
			var url    = "<?php echo site_url(); ?>cetak_tukd/cetak_real_fisik";  
			if(bulan==0){
			...
			window.open(url+'/'+skpd+'/'+bulan+'/'+ctk+'/'+ttd+'/'+ttd2+'/'+ctglttd+'/'+spasi+'/'+angx, '_blank');
			window.focus();
        }
        ...
        function cetak_global(ctk){
			...
			var  ttd2 = $('#ttd2').combogrid('getValue');
		    ttd2 = ttd2.split(" ").join("123456789");
			var url    = "<?php echo site_url(); ?>cetak_tukd/cetak_real_fisik_global";  
			if(bulan==0){
			alert('Pilih Bulan dulu')
			exit()
			}
...
<h3>CETAK LAPORAN REALISASI FISIK</h3>
    ...
    <p align="right">         
        ...
        <tr >
			...
			<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak_global(1);">Cetak Global Pdf</a>
			</td>
		</tr>
