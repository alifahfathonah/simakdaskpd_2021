...
//		}); 
    ...
    function get_skpd()
        ...
        function cetak(ctk)
        {
			...
			var url    = "<?php echo site_url(); ?>cetak_tukd/cetak_dth_global";  
			if(bulan==0){
...
<h3>CETAK DAFTAR TRANSAKSI HARIAN GLOBAL</h3>
    ...
    <p align="right">         
		...
		<tr >
			...
			<td width="80%"><input id="sskpd" readonly name="sskpd" style="width: 150px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="nmskpd" name="nmskpd" style="width: 500px; border:0;" /></td>
		</tr>
        <tr >
