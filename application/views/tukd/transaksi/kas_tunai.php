    ...
    <script type="text/javascript">
     ...
     function openWindow( url ){
		...
		lc = '?tgl1='+ctgl1+'&tgl_ttd='+ctglttd+'&ttd1='+ttd_1+'&ttd2='+ttd_2+'&spasi='+spasi+'&jns_bp=bp';
...
<div id="content1" align="center"> 
    ...
    <fieldset style="border-radius: 10px; border: 3px solid green"> <legend><b>BUKU KAS TUNAI GLOBAL</b></legend>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <a href="<?php echo site_url(); ?>cetak_kas/cetak_kas_tunai_global/0" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
                <a href="<?php echo site_url(); ?>cetak_kas/cetak_kas_tunai_global/1" class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
                </td>                
            </tr>
        </table>  
