...
//		}); 
    ...
    function get_skpd()
        ...
        function cetak(ctk)
        {
			...
			var url    = "<?php echo site_url(); ?>cetak_tukd/cetak_dth";  
			if(bulan==0){
...
<h3>CETAK DAFTAR TRANSAKSI HARIAN</h3>
    ...
    <p align="right">         
		...
		<tr >
			...
			<td width="80%"><input readonly id="sskpd" class="input" name="sskpd" style="width: 150px; display: inline;" /><input id="nmskpd" name="nmskpd" style="width: 500px; border:0;" /></td>
		</tr>
        <tr >
			<td width="20%" height="40" ><B>BULAN</B></td>
			<td><?php echo $this->rka_model->combo_bulan('bulan1','style="width: 150px" onchange="javascript:validate1();"'); ?> </td onclick="return confirm('hapus data yang telah diinput?')">
		</tr>
		 <tr>
                <td colspan="4">
                <div id="div_tgl">
                        <table style="width:100%;" border="0">
                            ...
                            <td><input type="text" id="tgl_ttd" style="width: 150px;" /> 
                            </td> 
                        </table>
                </div>
                </td> 
		...
		<tr >
			<td colspan="2" align="center">
                <button class="button-abu" onclick="javascript:cetak(0);"><i class="fa fa-print"></i> Cetak</button>
