 ...
 function validate_ttd(){
   $(function(){
		...
		function cetak(ctk)
        {
            ...
            var jns = document.getElementById("jens").value;  
			...
			if(jns=='1'){ 
				...
				var url    = "<?php echo site_url(); ?>/perda/cetak_perda_lampI_3_global"; 
			}else{
				var url    = "<?php echo site_url(); ?>/perda/cetak_belanja_urusan"; 
			}
...
<div id="accordion">
   ...
   <td> Anggaran</td> 
	...
	<tr>
   <td> Jenis</td> 
	<td style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><select  name="jens" id="jens" >
     <option value="1">Rinci</option>
     <option value="2">Global</option>
	 <option value="3">Rinci 2</option>
   </select></td>
	</tr>
