...
*/	
    ...
    function cetak($pilih){
			...
			if(ctk==1){
				...
				urll ='<?php echo base_url(); ?>index.php/akuntansi/ctk_lra_lo_pemda_unit/'+cbulan+'/'+kdskpd;
				if (kdskpd==''){
				...
				urll ='<?php echo base_url(); ?>index.php/akuntansi_rekon/ctk_lra_lo_pemda_org/'+cbulan+'/'+kd_org;
				if (kd_org==''){
...
<div id="accordion">
    ...
    <p align="right">         
		...
		<tr >
			...
			<a class="easyui-linkbutton" iconCls="icon-pdf" plain="true" onclick="javascript:cetak(0);">Cetak pdf</a></td>
		</tr>
